...
/**   
 * @Title: ProductUsageCount.java 
 * @Package com.nork.product.model
 * @Description:产品模块-使用次数记录表
 * @createAuthor pandajun 
 * @CreateDate 2016-07-26 16:18:44
 * @version V1.0   
 */
public class ProductUsageCount  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        ProductUsageCount other = (ProductUsageCount) that;
...
;
    ...
    /**获取对象的copy**/
    public ProductUsageCount copy(){
       ProductUsageCount obj =  new ProductUsageCount();
