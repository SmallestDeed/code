 ...
 * 修复在内容高度小于预设高度时的BUG
 * 2014�?3�?19�?22:57:27
 * 修复无法触摸滚动的BUG，不过还有些不顺�?
 * 2014�?3�?20�?22:48:25
 * 修正了触摸滚�?
 * 增加了判断是否为占位滚动条，
 * 如果是不占位滚动条则由浏览器原生驱动滚动�?
 * 2014�?4�?7�?14:44:51
 * 再次修正了触摸滚动条，增加了 -webkit-overflow-scrolling:touch 属�?
 * 2014�?5�?30�?23:24:40
 * 增加了对超过滚动条到达容器边缘的检�?
 *
 * v1.2
...
(function(win, udf) {
    ...
    var datakey = 'jquery-scrollbar',
        ...
        defaults = {
            ...
            minHeight: 100,
            // 是否可以越过边界
            // true: 在容器内滚动条到达边界后，将把鼠标滚轮事件交给外部容�?
            // false: 在容器内滚动鼠标事件一直紧抓不�?
            canCrossBoundary: !0,
            // x轴滚动回�?
            // this：element
            // 参数1：x轴方向滚动区域占�?
    ...
    Constructor.prototype = {
        ...
        /**
         * x轴定点滚动并执行回调
         * @param  {Number/String}   target 位置或元素位�?
