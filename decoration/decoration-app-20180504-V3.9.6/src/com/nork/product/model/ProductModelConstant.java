...
public class ProductModelConstant {
	...
	public static final String SERIESCONFIG = Utils.getValueByFileKey(AppProperties.APP, AppProperties.DESIGN_PRODUCT_SERIES_CONFIG_FILEKEY, 
			"[{\"smallTypeValuekeyInfo\":[{\"seriesProductType\":\"basic_cmki,basic_ccki,basic_cski,basic_cxki,basic_czki,basic_cqki\",\"seriesSign\":\"1\"},{\"seriesProductType\":\"basic_ctki,basic_ctzki,basic_ctyki,basic_ctjki,basic_ctski\",\"seriesSign\":\"2\"},{\"seriesProductType\":\"basic_dmki,basic_dfki,basic_dyki,basic_dzki,basic_dqki\",\"seriesSign\":\"3\"}],\"key\":\"S\"}]");
	 ...
	 * 产品默认天花截面数据value
	 */
	public static final String PRODUCT_DEFAULT_CEILING_CROSS_SECTION_DATA = Utils.getValueByFileKey(AppProperties.APP, AppProperties.PRODUCT_DEFAULT_CEILING_CROSS_SECTION_DATA,
			"{\"Vertices\":[{\"x\":0,\"y\":0},{\"x\":0,\"y\":300},{\"x\":600,\"y\":300},{\"x\":600,\"y\":220},{\"x\":200,\"y\":50},{\"x\":380,\"y\":50},{\"x\":380,\"y\":70},{\"x\":350,\"y\":70},{\"x\":350,\"y\":90},{\"x\":400,\"y\":90},{\"x\":400,\"y\":0}]}");

	/**
	 * 默认天花截面天花数据Id
	 */
	public static final String DEFAULT_JIEM_TIANH_PRODUCT_CODE = Utils.getValueByFileKey(AppProperties.APP, AppProperties.DEFAULT_JIEM_TIANH_PRODUCT_ID,"wu_jiem_0001");
}
