...
public class SystemCommonConstant {
	...
	//更新成功
	public static final String UPDATE_DATA_SUCCESS = "更新成功!";

	public static final String MEDIA_TYPE_OF_MOBILE = "MOBILE";
	public static final String MEDIA_TYPE_OF_APP = "APP";
	public static final String MEDIA_TYPE_OF_BRAND="BRAND";
	 ...
	 * add by chenm 20171114
	 */
	public static final String LOGIN_FROM_MOBILE = "mobile_2b_user_token:";
	
	/**
	 * 登录来源：PC客户端 做为PC客户端用户登录信息缓存标识
	 * add by chenm 20171114
	 */
	public static final String LOGIN_FROM_PC = "pc_2b_user_token:";

	/**
	 * 登录来源：运营网站客户端 做为运营网站端用户登录信息缓存标识
	 * */
	public static final String LOGIN_FROM_BUSINESS="user_brandToken";
