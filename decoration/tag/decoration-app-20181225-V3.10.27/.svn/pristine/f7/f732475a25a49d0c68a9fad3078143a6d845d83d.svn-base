...
public class DrawImage {
    ...
    public DrawImage(String fileName,String smallFilePath) throws IOException {
        File _file = new File(fileName); // 读入文件
        _file.getName();
        this.destFile = smallFilePath;// this.srcFile.substring(0,
    ...
    public static void main(String[] args) {
        ...
        String smallFilePath = "f:/2.jpg";
        DrawImage ccc = new DrawImage(filePath,smallFilePath);
        ccc.resizeFix(300, 100);
    } catch (IOException e) {
        e.printStackTrace();
    }
}
