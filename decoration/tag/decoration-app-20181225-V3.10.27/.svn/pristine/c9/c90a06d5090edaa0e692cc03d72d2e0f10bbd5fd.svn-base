...
public interface DesignPlanService {
	...
	* @throws
	 ...
	 * creat_date: 2017-08-23
	 **/
	public ResponseEnvelope<DesignPlan> unityUpdate(DesignPlan designPlan,Integer designPlanId,String planProductIds,String materialPicId,String context,String splitTexturesChoose,HttpServletRequest request,String msgId);
	 ...
	 * @return
	 */
	public Object spellingFlower(SpellingFlowerModel model,String isRenderServer,String opType);
	...
	/**
	 * 通过json获取/转换为水刀配置信息bean
	 * 
	 * @author huangsongbo
	 * @param waterjetInfo
	 * @return
	 */
	List<WaterjetInfoReturnDTO> getWaterjetInfoReturnDTOListByJson(String waterjetInfo);

	public String spellingFlowerFileTo();

	/**
	 * describe: 更新方案定制产品配置文件
	 * creat_user: xiaoxc
	 * creat_date: 2018-08-28
	 **/
	MessageUtil updatePlanCustomizedProductConfig(Integer planId, String context, LoginUser loginUser);

	/**
	 * describe: 更新方案定制产品订单编码
	 * creat_user: xiaoxc
	 * creat_date: 2018-08-28
	 **/
	MessageUtil updatePlanCustomizedProductOrderCode(Integer planId, String orderCode, LoginUser loginUser);
