...
//	private String uploadDir;
	...
	private String customizedProductConfigPath;
	...
	public String getCustomizedProductConfigPath() {
		return customizedProductConfigPath;
	}

	public void setCustomizedProductConfigPath(String customizedProductConfigPath) {
		this.customizedProductConfigPath = customizedProductConfigPath;
	}
...
/*	public String getNightFilePath() {
	...
	// 地面结构
	private List<SearchStructureProductResult> groundStructure = new ArrayList<>();

	public List<SearchStructureProductResult> getGroundStructure() {
		return groundStructure;
	}

	public void setGroundStructure(List<SearchStructureProductResult> groundStructure) {
		this.groundStructure = groundStructure;
	}
	
	/**
	 * 数据类型 1、老数据；2、绘制工具的数据
	 */
