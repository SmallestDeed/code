...
//				designPlanProduct.setIsHide(1);
	 ...
	 * @return
	 */
	@RequestMapping("/updatePlanStructureProduct")
	@ResponseBody
	public Object updatePlanStructureProduct(
			Integer designPlanId,String structureProductJson,
			String msgId,HttpServletRequest request) {

		if (!ParamCommonVerification.checkTheParamIsValid(structureProductJson,designPlanId)) {
		...
		List<PlanProductResult> list = designPlanProductService.updatePlanStructureProduct(designPlanId,structureProductJson,loginUser);
