...
import com.nork.design.model.ProductDefaultUV;
...
public class LoginUser extends Mapper implements Serializable {
	 ...
	 * 产品model默认区域UV
	 */
	private Map<Integer,ProductDefaultUV> productDefaultUVMap;

	public Map<Integer, ProductDefaultUV> getProductDefaultUVMap() {
		return productDefaultUVMap;
	}

	public void setProductDefaultUVMap(Map<Integer, ProductDefaultUV> productDefaultUVMap) {
		this.productDefaultUVMap = productDefaultUVMap;
	}
