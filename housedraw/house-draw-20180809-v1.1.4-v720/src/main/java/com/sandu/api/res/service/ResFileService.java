...
public interface ResFileService {
	...
	Long createByDrawResFile(DrawResFile drawResFileConfig, String fileKey, boolean needEncrypt);
	ResFile createByDrawResFile(DrawResFile drawResFile, String fileKey, boolean isEncrypt, boolean isAADir);
