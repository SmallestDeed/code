...
public interface DrawSpaceCommonService {
    ...
    DrawSpaceCommon getSpaceCommon2(Long id);
    ...
    void handlerSpacePic(DrawSpaceCommon drawSpaceCommon, List<String> bakeFiles);

    List<Long> getDealDrawSpaceCommon(Integer isDeleted, Long houseId);
