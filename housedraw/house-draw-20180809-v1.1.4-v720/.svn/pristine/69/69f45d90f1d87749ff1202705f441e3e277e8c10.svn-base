 ...
 */
@Data
public class DrawBaseProduct implements Serializable{
    /**
	 * 
	 */
    ...
    /**
     * 转换数据后对应base_product表的id
     */
    private Long baseProductId;
    
    /**
     * 建议售价价格<p>
     * base_product.sale_price_advice
     */
    private BigDecimal salePriceAdvice;
    
    /**
     * 是否是复杂拼花 0否1是<p>
     * base_product.is_complex_parquet
     */
    private Integer isComplexParquet;
    
    /**
     * 拼花材质ids<p>
     * base_product.parquet_texture_ids
     */
    private String parquetTextureIds;
    
    /**
     * 关联的draw_base_product=>id<p>
     * base_product.rel_draw_id
     */
    ...
    /**
     * 户型绘制时,该产品是不是软装白膜(系统中已经存在该产品,无需再新建该产品,0:不需要新建,1:需要新建)
     */
    ...
    private String proAttrKey;

    private String proAttrValKey;
}
