...
//    @Test
    public void testQueue() {
        ...
        // listOperations.leftPushAllByQueue(RedisKeyConstant.HOUSE_DRAW_FIX_CUPBOARD_QUEUE.toString(), Lists.newArrayList("1", "2", "3", "4", "5"));


         String rightPop = listOperations.rightPop(RedisKeyConstant.HOUSE_DRAW_FIX_CUPBOARD_QUEUE.toString());
         log.info("rightPop {}", rightPop);
        // ListOperations listOperations = redisTemplate.opsForList();
        // listOperations.leftPushAllByQueue(RedisKeyConstant.HOUSE_DRAW_FIX_CUPBOARD_QUEUE.toString(), Lists.newArrayList(1L));
    }
