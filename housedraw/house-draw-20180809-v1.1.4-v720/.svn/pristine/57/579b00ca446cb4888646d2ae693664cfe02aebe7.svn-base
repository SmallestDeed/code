 ...
 */
@Data
public class DrawSpaceCommon implements Serializable {
     ...
     * 烘培之前的空间文件(还原文件)
     */
    private Long bakeBeforeFileId;
    
    /**
     * 关联的户型id
     */
    private Long drawBaseHouseId;
    
    /**
     * 转换数据后对应space_common表的id
     */
    private Long spaceCommonId;
    
    /**
     * draw_space_common.daylight_ios_u3d_model_id
     */
    private Integer daylightIosU3dModelId;

    /**
     * draw_space_common.dusklight_ios_u3d_model_id
     */
    private Integer dusklightIosU3dModelId;

    /**
     * draw_space_common.nightlight_ios_u3d_model_id
     */
    private Integer nightlightIosU3dModelId;
    
    /**
     * draw_space_common.daylight_android_u3d_model_id
     */
    private Integer daylightAndroidU3dModelId;

    /**
     * draw_space_common.dusklight_android_u3d_model_id
     */
    private Integer dusklightAndroidU3dModelId;

    /**
     * draw_space_common.nightlight_android_u3d_model_id
     */
    private Integer nightlightAndroidU3dModelId;
    
    /**
     * 关联的draw_space_common=>id<p>
     * space_common.rel_draw_id
     */
