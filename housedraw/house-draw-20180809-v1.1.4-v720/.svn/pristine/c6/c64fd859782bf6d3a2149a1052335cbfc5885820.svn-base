...
public interface DrawBaseHouseService {
     ...
     */
    Map<String, Object> saveDrawBaseHouse(String data, String userId);

    Map<String, Object> saveDrawHouseV2(String data, String userId);
    ...
    String callbackV2(DrawBaseHouseCallbackDTO dtoNew);
    ...
    void resetDrawHouse(List<Integer> taskIds);
}
