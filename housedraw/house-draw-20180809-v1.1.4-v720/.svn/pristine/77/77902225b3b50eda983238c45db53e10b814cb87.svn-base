...
public class BaseProduct implements Serializable {
    ...
    /**
     * 移动端材质替换图片列表<p>
     * base_product.app_pic_texture_ids
     */
    private String appPicTextureIds;

    /**
     * 布局标识<p>
     * base_product.product_smallpox_identify_str
     */
