...
public interface DrawBaseHouseMapper {
	...
	DrawHouseResouceBO getHouseFileResource(Long baseHouseId);
	DrawHouseResouceBO getDrawHouseFileResource(Long houseId);
	...
	Map<String, Integer> getDataType(Long houseId);
    ...
    Integer resetDrawHouse(@Param("houseStatus") Integer houseStatus, @Param("houseIds") List<Integer> houseIds);

    Integer batchResetFixHouse(@Param("bugfixStatus") Integer bugfixStatus, @Param("houseIds") List<String> houseIds);
}
