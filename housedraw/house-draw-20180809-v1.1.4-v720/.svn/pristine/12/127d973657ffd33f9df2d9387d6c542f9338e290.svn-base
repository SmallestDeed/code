...
public interface DrawDesignTempletService {
    ...
    List<DrawDesignTemplet> findAllBySpaceCommonId2(Long drawSpaceCommonId);
    ...
    void handlerDesigmTempletPic(DrawDesignTemplet designTemplet, List<String> bakeFiles);
