...
public interface SystemDictionaryService {
    ...
    List<SystemDictionary> listSoftBiamoGroupType(SystemDictionarySearch search, boolean useCache);
    ...
    List<SystemDictionaryBO> listSoftBiamoType(SystemDictionarySearch search, boolean useCache);
