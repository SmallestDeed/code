...
public class UtilTests {
    @Test
    public void test1() {
       // log.debug("{}", Utils.getFileName(UploadUtils.getFileSuffix("sdljf.jpg")));
       // log.debug("{}", "jpg".matches(Regex.FILE_SUFFIX.getValue()));
        ...
        log.info("{}", Arrays.toString(list.stream().filter(prefix -> !prefix.startsWith("ee")).toArray()));
    }
