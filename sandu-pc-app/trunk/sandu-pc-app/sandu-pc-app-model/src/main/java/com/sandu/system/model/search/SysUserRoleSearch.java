...
import com.sandu.system.model.SysUserRole;

/**   
 * @Title: SysUserRoleSearch.java 
 * @Package com.nork.system.model
 * @Description:系统模块-用户角色表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-06-02 17:26:50
 * @version V1.0   
 */
public class SysUserRoleSearch extends  SysUserRole implements Serializable{
