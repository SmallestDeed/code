...
private static final long serialVersionUID = 1L;
	...
	List<SysDictionary>typeAndValueKeyList=new ArrayList<SysDictionary>();
	...
	public List<SysDictionary> getTypeAndValueKeyList() {
		return typeAndValueKeyList;
	}
	public void setTypeAndValueKeyList(List<SysDictionary> typeAndValueKeyList) {
		this.typeAndValueKeyList = typeAndValueKeyList;
	}
	...
	public  String getSch_Valuekey_() {
		return sch_Valuekey_;
	}
	public void setSch_Valuekey_(String sch_Valuekey_){
		this.sch_Valuekey_ = sch_Valuekey_;
	}
	public  String getSch_Valuekey() {
		return sch_Valuekey;
	}
	public void setSch_Valuekey(String sch_Valuekey){
		this.sch_Valuekey = sch_Valuekey;
	}
	public  String getSchValuekey_() {
		return schValuekey_;
	}
	public void setSchValuekey_(String schValuekey_){
		this.schValuekey_ = schValuekey_;
	}
	public  String getValuekeyStart() {
		return valuekeyStart;
	}
	public void setValuekeyStart(String valuekeyStart){
		this.valuekeyStart = valuekeyStart;
	}
	public  String getValuekeyEnd() {
		return valuekeyEnd;
	}
	public void setValuekeyEnd(String valuekeyEnd){
		this.valuekeyEnd = valuekeyEnd;
	}
