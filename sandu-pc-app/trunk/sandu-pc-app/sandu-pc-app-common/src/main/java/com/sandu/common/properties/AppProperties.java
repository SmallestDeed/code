...
public class AppProperties {
	...
	public static final ResourceBundle APP=ResourceBundle.getBundle("config/app");
	 ...
	 * 墙体方位优先级信息
	 */
	public static final String DESIGN_PRODUCT_BEIJINGTYPE_PRIORITY_FILEKEY = "design.product.beijingType.priority";
