...
/**   
 * @Title: UnionDesignPlanStoreCatorySearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟设计方案库类别查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:25:06
 * @version V1.0   
 */
public class UnionDesignPlanStoreCatorySearch extends  UnionDesignPlanStoreCatory implements Serializable{
private static final long serialVersionUID = 1L;
	/**  类别名称-模糊查询  **/
	private String sch_CatoryName_;
	/**  类别名称-左模糊查询  **/
	private String sch_CatoryName;
	/**  类别名称-右模糊查询  **/
	private String schCatoryName_;
	/**  类别名称-区间查询-开始字符串  **/
	private String catoryNameStart;
	/**  类别名称-区间查询-结束字符串  **/
	private String catoryNameEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_CatoryName_() {
		return sch_CatoryName_;
	}
	public void setSch_CatoryName_(String sch_CatoryName_){
		this.sch_CatoryName_ = sch_CatoryName_;
	}
	public  String getSch_CatoryName() {
		return sch_CatoryName;
	}
	public void setSch_CatoryName(String sch_CatoryName){
		this.sch_CatoryName = sch_CatoryName;
	}
	public  String getSchCatoryName_() {
		return schCatoryName_;
	}
	public void setSchCatoryName_(String schCatoryName_){
		this.schCatoryName_ = schCatoryName_;
	}
	public  String getCatoryNameStart() {
		return catoryNameStart;
	}
	public void setCatoryNameStart(String catoryNameStart){
		this.catoryNameStart = catoryNameStart;
	}
	public  String getCatoryNameEnd() {
		return catoryNameEnd;
	}
	public void setCatoryNameEnd(String catoryNameEnd){
		this.catoryNameEnd = catoryNameEnd;
	}
