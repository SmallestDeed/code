 ...
 */
@XmlRootElement(name="ResEntity")
@XmlAccessorType(XmlAccessType.FIELD)
public class ResHousePicEntity {
	private Integer id;
	...
	public String getResWeight() {
		return resWeight;
	}
	public void setResWeight(String resWeight) {
		this.resWeight = resWeight;
	}
	public String getResHigh() {
		return resHigh;
	}
	public void setResHigh(String resHigh) {
	...
	public String getResOrdering() {
		return resOrdering;
	}
	public void setResOrdering(String resOrdering) {
		this.resOrdering = resOrdering;
	}
