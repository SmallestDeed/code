...
/**   
 * @Title: PrepProductPropsInfoSearch.java 
 * @Package com.nork.product.model
 * @Description:产品模块-预处理表(属性匹配)查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-02-25 14:55:01
 * @version V1.0   
 */
public class PrepProductPropsInfoSearch extends  PrepProductPropsInfo implements Serializable{
