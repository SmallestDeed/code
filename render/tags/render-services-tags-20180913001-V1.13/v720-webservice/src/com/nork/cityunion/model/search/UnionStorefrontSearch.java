...
/**   
 * @Title: UnionStorefrontSearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟店面信息表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:22:46
 * @version V1.0   
 */
public class UnionStorefrontSearch extends  UnionStorefront implements Serializable{
private static final long serialVersionUID = 1L;
	...
	/**  联系人-模糊查询  **/
	private String sch_Contact_;
	/**  联系人-左模糊查询  **/
	private String sch_Contact;
	/**  联系人-右模糊查询  **/
	private String schContact_;
	/**  联系人-区间查询-开始字符串  **/
	private String contactStart;
	/**  联系人-区间查询-结束字符串  **/
	private String contactEnd;
	/**  电话-模糊查询  **/
	private String sch_Phone_;
	/**  电话-左模糊查询  **/
	private String sch_Phone;
	/**  电话-右模糊查询  **/
	private String schPhone_;
	/**  电话-区间查询-开始字符串  **/
	private String phoneStart;
	/**  电话-区间查询-结束字符串  **/
	private String phoneEnd;
	/**  地址-模糊查询  **/
	private String sch_Address_;
	/**  地址-左模糊查询  **/
	private String sch_Address;
	/**  地址-右模糊查询  **/
	private String schAddress_;
	/**  地址-区间查询-开始字符串  **/
	...
	public  String getSch_Contact_() {
		return sch_Contact_;
	}
	public void setSch_Contact_(String sch_Contact_){
		this.sch_Contact_ = sch_Contact_;
	}
	public  String getSch_Contact() {
		return sch_Contact;
	}
	public void setSch_Contact(String sch_Contact){
		this.sch_Contact = sch_Contact;
	}
	public  String getSchContact_() {
		return schContact_;
	}
	public void setSchContact_(String schContact_){
		this.schContact_ = schContact_;
	}
	...
	public  String getSch_Phone_() {
		return sch_Phone_;
	}
	public void setSch_Phone_(String sch_Phone_){
		this.sch_Phone_ = sch_Phone_;
	}
	...
	public  String getSchPhone_() {
		return schPhone_;
	}
	public void setSchPhone_(String schPhone_){
		this.schPhone_ = schPhone_;
	}
	...
	public  String getSch_Address_() {
		return sch_Address_;
	}
	public void setSch_Address_(String sch_Address_){
		this.sch_Address_ = sch_Address_;
	}
	...
	public  String getSchAddress_() {
		return schAddress_;
	}
	public void setSchAddress_(String schAddress_){
		this.schAddress_ = schAddress_;
	}
