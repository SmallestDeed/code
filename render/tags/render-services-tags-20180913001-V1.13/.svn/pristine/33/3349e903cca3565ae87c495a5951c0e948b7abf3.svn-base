...
public class SysDictionaryInterceptor  implements ThrowsAdvice{
	public static final Logger log = Logger
			.getLogger(SysDictionaryInterceptor.class);
...
/*	@Around("aPointcut()")
	public Integer aroundAdd(ProceedingJoinPoint call) {
		...
		//前置通知
		@Before(value="execution(* com.nork.system.service.impl.SysDictionaryServiceImpl.update*(..))")
	    public void before() {
			log.info("已经记录下操作日志@Before 方法执行前");
	    }

		//环绕通知
	    @Around(value="execution(* com.nork.system.service.impl.SysDictionaryServiceImpl.update*(..))")
	    ...
	    //后置通知
	    @After(value="execution(* com.nork.system.service.impl.SysDictionaryServiceImpl.update*(..))")
	    public void after(JoinPoint joinPoint) {
	    	log.info("已经记录下操作日志@After 方法执行后");
	    }
	    
	    //获取返回后通知
	    @AfterReturning(value="execution(* com.nork.system.service.impl.SysDictionaryServiceImpl.update*(..))",returning="retVal")
	    public void doAfterReturning(JoinPoint jp,String retVal){
	        //////System.out.println("后置返回值通知，获得参数："+retVal);
	    }
	    
	    //异常通知
	    @AfterThrowing(value="execution(* com.nork.system.service.impl.SysDictionaryServiceImpl.update*(..))",throwing="ex")
