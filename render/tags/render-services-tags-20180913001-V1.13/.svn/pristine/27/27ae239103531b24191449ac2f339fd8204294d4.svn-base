...
<head>
	...
	<script src="${pageContext.request.contextPath}/pages/vr720/custom/js/vr720MobileForAuto.js"></script>
...
<body>
	...
	<div id="pano" style="${vo.panoramaVo.windowsPercent}">
		...
		<div>
			...
			<!-- <div id="VR-button" class="VR-button" onclick="enterVR()"></div> -->
			<!-- 三度logo转到插件里了 -->
			<!-- <div class="sanduLogo"></div>		 --> 
			<div class="productList" style="display:none;"></div>
			<div class="musicOff" style="display:none;"></div>
			<div class="infoPlane">
			...
			<div class="productPlane" style="display:none;">
				...
				<div class="bz_info" style="display:none;">
					<div class="wrap">
						<i class="fa_icon"></i>
	...
	$(document).ready(function() {
		...
		window.addEventListener('message',function(e){
            ...
            var config = {xml:"tourOfMobile.xml", target:"pano", html5:"only", mobilescale:1.0, passQueryParameters:true, onready:krpanoReady};
            embedpano(config);
		</script>
