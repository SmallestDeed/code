package com.nork.designplan.model;
...
//	         obj.setDesignPlanRenderPicIds(this.designPlanRenderPicIds);
    ...
    public Integer getSpaceShape() {
        return spaceShape;
    }

    public void setSpaceShape(Integer spaceShape) {
    ...
    public String toString() {
        return "DesignPlanRecommended{" +
                ...
                ", isDeleted=" + isDeleted +
                ", remark='" + remark + '\'' +
                ", designPlanRenderPicIds='" + designPlanRenderPicIds + '\'' +
                ", renderMap=" + renderMap +
                ...
                ", render720MultipointPicId=" + render720MultipointPicId +
                ", render720PanoramaPicId=" + render720PanoramaPicId +
                ", render720VideoId=" + render720VideoId +
                ", displayType='" + displayType + '\'' +
                ", spaceShape=" + spaceShape +
                ", BrandIds=" + BrandIds +
                ", SpaceFunctionId=" + SpaceFunctionId +
                ", spaceFunctionIds=" + spaceFunctionIds +
                ", areaValue='" + areaValue + '\'' +
                ...
                ", picType=" + picType +
                ", picList=" + picList +
                ", planRecommendedUserName='" + planRecommendedUserName + '\'' +
                ", spaceCode='" + spaceCode + '\'' +
                ", spaceName='" + spaceName + '\'' +
                ", spaceAreas='" + spaceAreas + '\'' +
                ", planRecommendedProductCount=" + planRecommendedProductCount +
                ", recommendedDecorateState=" + recommendedDecorateState +
                ", designPlanId=" + designPlanId +
                ", favoriteBid='" + favoriteBid + '\'' +
                ", applySpaceAreas='" + applySpaceAreas + '\'' +
                '}';
    }
}
