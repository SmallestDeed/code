...
public class WebResPicController {
	...
	private static final String LOGPREFIX = "[图片模块]:";
	...
	public Object getQRCodePicUrl(
		...
		// 参数dateDueStr处理 ->start
		Date dateDue;
		try {
			dateDue = Utils.dealWithParamDateDueStr(dateDueStr, 1);
...
//		LoginUser loginUser = SystemCommonUtil.getLoginUserInfoByAuthData(request);
		...
		String picPath =  resRenderPicService.getQRpicPath(resPic, dateDue);
