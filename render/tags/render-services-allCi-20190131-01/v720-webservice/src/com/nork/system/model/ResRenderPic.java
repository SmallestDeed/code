...
private static final long serialVersionUID = 1L;
	...
	//移动端我的替换列表需要这个值作为参数
    //现在全屋方案制作需要这个值，作为全屋方案主任务id，逻辑分开处理，可以共用 add by gaoj 2018.09.21
	...
	/**方案空间类型（1：单空间方案，2：全屋方案,3:全屋方案新逻辑）**/
	...
	/**全屋方案操作(1:创建全屋方案,2:修改全屋方案,3:修改全屋方案生成新的全屋方案,4:处理复制过来的全屋方案【有全屋方案，没有主子任务】)**/
	private Integer fullHousePlanAction;
	/**空间类型**/
	private Integer spaceFunctionId;
	/*全屋户型坐标信息ID*/
	private Integer houseGuidePicInfoId;

	private Integer designTempletId;
	/*业务类型,1是单空间装进我家,2是全屋替换*/
	private Integer bizType;
	/*全屋户型坐标信息ID集合*/
	private List<Integer> houseGuidePicInfoIdList;
	/**供求信息id**/
	private Integer supplyDemandId;
	/** 渲染方式:(0:本地渲染;1:渲染机渲染;2:专业渲染机渲染) **/
	private Integer taskRenderType;

	public Integer getTaskRenderType() {
		return taskRenderType;
	}

	public void setTaskRenderType(Integer taskRenderType) {
		this.taskRenderType = taskRenderType;
	}
	...
	public List<Integer> getHouseGuidePicInfoIdList() {
		return houseGuidePicInfoIdList;
	}

	public void setHouseGuidePicInfoIdList(List<Integer> houseGuidePicInfoIdList) {
		this.houseGuidePicInfoIdList = houseGuidePicInfoIdList;
	}
	...
	public Integer getHouseGuidePicInfoId() {
		return houseGuidePicInfoId;
	}

	public void setHouseGuidePicInfoId(Integer houseGuidePicInfoId) {
	...
	public Integer getPreRenderSceneId() {
		return preRenderSceneId;
	}

	public void setPreRenderSceneId(Integer preRenderSceneId) {
		this.preRenderSceneId = preRenderSceneId;
	}

	public Integer getFullHousePlanAction() {
		return fullHousePlanAction;
	}

	public void setFullHousePlanAction(Integer fullHousePlanAction) {
		this.fullHousePlanAction = fullHousePlanAction;
	}
...
;
    ...
    public String toString() {
        return "ResRenderPic{" +
                ...
                ", productReplaceList=" + productReplaceList +
                ", productDeleteList=" + productDeleteList +
                ", productGroupReplaceList=" + productGroupReplaceList +
                ", textureReplaceList=" + textureReplaceList +
                ", orderNo='" + orderNo + '\'' +
