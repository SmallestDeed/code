...
//    	String url=payPath+"/web/pay/payOrder/addIntegralPayRenderTask?userId="+userId+"&renderType="+renderType+"&planId="+planId+"&houseId="+houseId+"&companyDomainName="+companyDomainName;
    ...
    @RequestMapping("/addRenderTaskStateList")
    @ResponseBody
    public ResponseEnvelope addRenderTaskStateList(@RequestBody List<Integer> taskIdList) {
        if (CollectionUtils.isEmpty(taskIdList)) {
            return new ResponseEnvelope(false, "参数为空");
        }

        boolean flag = autoRenderTaskApi.addRenderTaskStateList(taskIdList);
    }
}