...
private static final long serialVersionUID = 1L;
	...
	/** 全屋的obj文件,对应res_full_house_file表 **/
	private Integer fullHouseObjId;
	/** 户型绘制截图 **/
	private Integer snapPicId;

	public Integer getSnapPicId() {
		return snapPicId;
	}

	public void setSnapPicId(Integer snapPicId) {
		this.snapPicId = snapPicId;
	}

	public Integer getFullHouseObjId() {
		return fullHouseObjId;
	}

	public void setFullHouseObjId(Integer fullHouseObjId) {
		this.fullHouseObjId = fullHouseObjId;
	}
...
;
	...
	public BaseHouse toObj(Map map){
    	 BaseHouse obj =  new BaseHouse();
