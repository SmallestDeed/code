...
public class FullHouseDesignPlan implements Serializable {
    ...
    /**
     * 方案售卖价格是否收费:0,不收费,1收费
     */
    private Integer salePriceChargeType;

    /**
     * 不查询的方案来源(1:内部制作,3:交付,4:分享)
     * 用于查询的冗余字段
     */
    private List<Integer> uselessSourceTypeList;

    /**
     *  复制过来的方案是否已修改（0:未修改，1已修改）
     */
    ...
    public Integer getSalePriceChargeType() {
        return salePriceChargeType;
    }

    public void setSalePriceChargeType(Integer salePriceChargeType) {
        this.salePriceChargeType = salePriceChargeType;
    }

    public List<Integer> getUselessSourceTypeList() {
        return uselessSourceTypeList;
    }

    public void setUselessSourceTypeList(List<Integer> uselessSourceTypeList) {
        this.uselessSourceTypeList = uselessSourceTypeList;
    }
    ...
    public Integer getPlanStyleId() {
        return planStyleId;
    }

    public void setPlanStyleId(Integer planStyleId) {
    ...
    public Integer getPlanPicId() {
        return planPicId;
    }

    public void setPlanPicId(Integer planPicId) {
        this.planPicId = planPicId;
    }
    ...
    public String getVrResourceUuid() {
        return vrResourceUuid;
    }

    public void setVrResourceUuid(String vrResourceUuid) {
        this.vrResourceUuid = vrResourceUuid;
    }
