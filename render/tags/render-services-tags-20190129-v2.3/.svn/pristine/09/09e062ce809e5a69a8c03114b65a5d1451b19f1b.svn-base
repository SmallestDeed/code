...
/**   
 * @Title: UnionDesignPlanStoreCatory.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟设计方案库类别
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:25:06
 * @version V1.0   
 */
public class UnionDesignPlanStoreCatory  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        UnionDesignPlanStoreCatory other = (UnionDesignPlanStoreCatory) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getCatoryName() == null ? other.getCatoryName() == null : this.getCatoryName().equals(other.getCatoryName()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCatoryName() == null) ? 0 : getCatoryName().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public UnionDesignPlanStoreCatory copy(){
       UnionDesignPlanStoreCatory obj =  new UnionDesignPlanStoreCatory();
       obj.setUserId(this.userId);
       obj.setCatoryName(this.catoryName);
    ...
    public Map toMap(){
       ...
       map.put("catoryName",this.catoryName);
