...
public interface ResRenderPicService {
	...
	*/
	 ...
	 * @return
	 */
	HeadMessage getSceneHeadMessage(PanoramaVo panoramaVo,HeadMessage headMessage,Integer userId,String platformType) throws BizException;

	/**
	 * 获取一张方案的缩略图做为封面图(方案没有封面图时)
	 * @param planId 方案id
	 * @param planSourceType 方案类型(草图/效果图/推荐)
	 * @return
	 */
	Integer getSmallRenderPicByPlan(Integer planId,Integer planSourceType);
}
