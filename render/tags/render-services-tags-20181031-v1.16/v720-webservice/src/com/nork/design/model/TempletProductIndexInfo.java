...
/**   
 * @Title: TempletProductIndexInfo.java 
 * @Package com.nork.design.model
 * @Description:设计模块-同分类产品序号表
 * @createAuthor pandajun 
 * @CreateDate 2017-06-13 16:19:25
 * @version V1.0   
 */
public class TempletProductIndexInfo  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
	...
	/**  方案产品序号信息  **/
	private String productIndexInfo;
	/**  系统编码  **/
	...
	public List<Integer> getIndexInfoIds() {
		return indexInfoIds;
	}

	public void setIndexInfoIds(List<Integer> indexInfoIds) {
		this.indexInfoIds = indexInfoIds;
	}
	...
	public  String getProductIndexInfo() {
		return productIndexInfo;
	}
	public void setProductIndexInfo(String productIndexInfo){
		this.productIndexInfo = productIndexInfo;
	}
   ...
   @Override
    public boolean equals(Object that) {
        ...
        TempletProductIndexInfo other = (TempletProductIndexInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getProductIndexInfo() == null ? other.getProductIndexInfo() == null : this.getProductIndexInfo().equals(other.getProductIndexInfo()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProductIndexInfo() == null) ? 0 : getProductIndexInfo().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public TempletProductIndexInfo copy(){
       TempletProductIndexInfo obj =  new TempletProductIndexInfo();
       obj.setDesignTempletId(this.designTempletId);
       obj.setProductIndexInfo(this.productIndexInfo);
    ...
    public Map toMap(){
       ...
       map.put("productIndexInfo",this.productIndexInfo);
