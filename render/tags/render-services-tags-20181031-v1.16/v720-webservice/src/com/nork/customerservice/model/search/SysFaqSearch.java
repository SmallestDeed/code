package com.nork.customerservice.model.search;
...
/**   
 * @Title: SysFaqSearch.java 
 * @Package com.nork.customerservice.model
 * @Description:客服中心-常见问题查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-04-27 14:35:55
 * @version V1.0   
 */
public class SysFaqSearch extends  SysFaq implements Serializable{
private static final long serialVersionUID = 1L;
	/**  问题-模糊查询  **/
	private String sch_Question_;
	/**  问题-左模糊查询  **/
	private String sch_Question;
	/**  问题-右模糊查询  **/
	private String schQuestion_;
	/**  问题-区间查询-开始字符串  **/
	private String questionStart;
	/**  问题-区间查询-结束字符串  **/
	private String questionEnd;
	/**  解答-模糊查询  **/
	private String sch_Answer_;
	/**  解答-左模糊查询  **/
	private String sch_Answer;
	/**  解答-右模糊查询  **/
	private String schAnswer_;
	/**  解答-区间查询-开始字符串  **/
	...
	public  String getSch_Question_() {
		return sch_Question_;
	}
	public void setSch_Question_(String sch_Question_){
		this.sch_Question_ = sch_Question_;
	}
	public  String getSch_Question() {
		return sch_Question;
	}
	public void setSch_Question(String sch_Question){
		this.sch_Question = sch_Question;
	}
	public  String getSchQuestion_() {
		return schQuestion_;
	}
	public void setSchQuestion_(String schQuestion_){
		this.schQuestion_ = schQuestion_;
	}
	...
	public void setQuestionEnd(String questionEnd){
		this.questionEnd = questionEnd;
	}
	public  String getSch_Answer_() {
		return sch_Answer_;
	}
	public void setSch_Answer_(String sch_Answer_){
		this.sch_Answer_ = sch_Answer_;
	}
	public  String getSch_Answer() {
		return sch_Answer;
	}
	public void setSch_Answer(String sch_Answer){
		this.sch_Answer = sch_Answer;
	}
	public  String getSchAnswer_() {
		return schAnswer_;
	}
	public void setSchAnswer_(String schAnswer_){
		this.schAnswer_ = schAnswer_;
	}
