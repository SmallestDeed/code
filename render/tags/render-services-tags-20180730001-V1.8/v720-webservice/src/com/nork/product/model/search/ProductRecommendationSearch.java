...
/**   
 * @Title: ProductRecommendationSearch.java 
 * @Package com.nork.product.model
 * @Description:产品-产品推荐查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-09-01 14:02:16
 * @version V1.0   
 */
public class ProductRecommendationSearch extends  ProductRecommendation implements Serializable{
private static final long serialVersionUID = 1L;
	/**  数据来源-模糊查询  **/
	private String sch_DataSources_;
	/**  数据来源-左模糊查询  **/
	private String sch_DataSources;
	/**  数据来源-右模糊查询  **/
	private String schDataSources_;
	/**  数据来源-区间查询-开始字符串  **/
	private String dataSourcesStart;
	/**  数据来源-区间查询-结束字符串  **/
	private String dataSourcesEnd;
	/**  匹配度-模糊查询  **/
	private String sch_MatchingDegree_;
	/**  匹配度-左模糊查询  **/
	private String sch_MatchingDegree;
	/**  匹配度-右模糊查询  **/
	private String schMatchingDegree_;
	/**  匹配度-区间查询-开始字符串  **/
	private String matchingDegreeStart;
	/**  匹配度-区间查询-结束字符串  **/
	private String matchingDegreeEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_DataSources_() {
		return sch_DataSources_;
	}
	public void setSch_DataSources_(String sch_DataSources_){
		this.sch_DataSources_ = sch_DataSources_;
	}
	public  String getSch_DataSources() {
		return sch_DataSources;
	}
	public void setSch_DataSources(String sch_DataSources){
		this.sch_DataSources = sch_DataSources;
	}
	public  String getSchDataSources_() {
		return schDataSources_;
	}
	public void setSchDataSources_(String schDataSources_){
		this.schDataSources_ = schDataSources_;
	}
	public  String getDataSourcesStart() {
		return dataSourcesStart;
	}
	public void setDataSourcesStart(String dataSourcesStart){
		this.dataSourcesStart = dataSourcesStart;
	}
	public  String getDataSourcesEnd() {
		return dataSourcesEnd;
	}
	public void setDataSourcesEnd(String dataSourcesEnd){
		this.dataSourcesEnd = dataSourcesEnd;
	}
	public  String getSch_MatchingDegree_() {
		return sch_MatchingDegree_;
	}
	public void setSch_MatchingDegree_(String sch_MatchingDegree_){
		this.sch_MatchingDegree_ = sch_MatchingDegree_;
	}
	public  String getSch_MatchingDegree() {
		return sch_MatchingDegree;
	}
	public void setSch_MatchingDegree(String sch_MatchingDegree){
		this.sch_MatchingDegree = sch_MatchingDegree;
	}
	public  String getSchMatchingDegree_() {
		return schMatchingDegree_;
	}
	public void setSchMatchingDegree_(String schMatchingDegree_){
		this.schMatchingDegree_ = schMatchingDegree_;
	}
	public  String getMatchingDegreeStart() {
		return matchingDegreeStart;
	}
	public void setMatchingDegreeStart(String matchingDegreeStart){
		this.matchingDegreeStart = matchingDegreeStart;
	}
	public  String getMatchingDegreeEnd() {
		return matchingDegreeEnd;
	}
	public void setMatchingDegreeEnd(String matchingDegreeEnd){
		this.matchingDegreeEnd = matchingDegreeEnd;
	}
