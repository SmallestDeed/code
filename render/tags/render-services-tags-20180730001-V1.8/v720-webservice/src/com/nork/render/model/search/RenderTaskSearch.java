package com.nork.render.model.search;
...
/**   
 * @Title: RenderTaskSearch.java 
 * @Package com.nork.render.model
 * @Description:渲染-渲染任务查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-01-17 20:31:06
 * @version V1.0   
 */
public class RenderTaskSearch extends  RenderTask implements Serializable{
private static final long serialVersionUID = 1L;
	/**  任务开始时间-区间查询-开始时间  **/
	private Date gmtTaskStartStart;
	/**  任务开始时间-区间查询-结束时间  **/
	private Date gmtTaskStartEnd;
	/**  任务结束时间-区间查询-开始时间  **/
	private Date gmtTaskEndStart;
	/**  任务结束时间-区间查询-结束时间  **/
	private Date gmtTaskEndEnd;
	/**  渲染开始时间-区间查询-开始时间  **/
	private Date gmtRenderStartStart;
	/**  渲染开始时间-区间查询-结束时间  **/
	private Date gmtRenderStartEnd;
	/**  渲染结束时间-区间查询-开始时间  **/
	private Date gmtRenderEndStart;
	/**  渲染结束时间-区间查询-结束时间  **/
	private Date gmtRenderEndEnd;
	/**  系统编码-模糊查询  **/
	...
	public  Date getGmtTaskStartStart() {
		return gmtTaskStartStart;
	}
	public void setGmtTaskStartStart(Date gmtTaskStartStart){
		this.gmtTaskStartStart = gmtTaskStartStart;
	}
	public  Date getGmtTaskStartEnd() {
		return gmtTaskStartEnd;
	}
	public void setGmtTaskStartEnd(Date gmtTaskStartEnd){
		this.gmtTaskStartEnd = gmtTaskStartEnd;
	}
	public  Date getGmtTaskEndStart() {
		return gmtTaskEndStart;
	}
	public void setGmtTaskEndStart(Date gmtTaskEndStart){
		this.gmtTaskEndStart = gmtTaskEndStart;
	}
	public  Date getGmtTaskEndEnd() {
		return gmtTaskEndEnd;
	}
	public void setGmtTaskEndEnd(Date gmtTaskEndEnd){
		this.gmtTaskEndEnd = gmtTaskEndEnd;
	}
	public  Date getGmtRenderStartStart() {
		return gmtRenderStartStart;
	}
	public void setGmtRenderStartStart(Date gmtRenderStartStart){
		this.gmtRenderStartStart = gmtRenderStartStart;
	}
	public  Date getGmtRenderStartEnd() {
		return gmtRenderStartEnd;
	}
	public void setGmtRenderStartEnd(Date gmtRenderStartEnd){
		this.gmtRenderStartEnd = gmtRenderStartEnd;
	}
	public  Date getGmtRenderEndStart() {
		return gmtRenderEndStart;
	}
	public void setGmtRenderEndStart(Date gmtRenderEndStart){
		this.gmtRenderEndStart = gmtRenderEndStart;
	}
	public  Date getGmtRenderEndEnd() {
		return gmtRenderEndEnd;
	}
	public void setGmtRenderEndEnd(Date gmtRenderEndEnd){
		this.gmtRenderEndEnd = gmtRenderEndEnd;
	}
