...
//		 panoramaVo.setTitle("3D全景漫游|混搭");
    ...
    public SceneUserInfoDto getSceneUserInfo2(ResRenderPic resRenderPic){
        ...
        if(planRecommendedId != null && planRecommendedId > 0){
            ...
            if(shop != null) {
                contactName = shop.getShopName();
                contactPhone = shop.getContactPhone();
                if(shop.getLogoPicId() != null){
                    logoPic = resPicService.get(shop.getLogoPicId());
                }
            }else{
                if (company != null) {
                    if (company.getCompanyLogo() != null) {
    ...
    @Override
    public SceneUserInfoDto getSceneUserInfo(ResRenderPic resRenderPic){
        SceneUserInfoDto infoDto = new SceneUserInfoDto();
        SysUser sysUser = new SysUser();
        ...
        if(otherTypeFlag){
            ...
            if(planRecommended.getIsRelease() != RecommendedDecorateState.IS_RELEASEING){
                ...
                if(Objects.equals(planRecommended.getRecommendedType(),Constants.RECOMMENDED_TYPE_SHARE)){
                    ...
                    panoramaDataVo.setGroupPrimaryId(planRecommended.getGroupPrimaryId());
                }else{
    ...
    public UnionStoreSingleDataVo vr720UnionStoreSingleData(SceneDataSearch search) {
        ...
        //TODO:再整理一遍，代码太乱了,不使用UnionStoreVo了，把代码抽出来 --2018/11/30
