...
/**   
 * @Title: UnionDesignPlanStoreReleaseSearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟素材发布表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:25:43
 * @version V1.0   
 */
public class UnionDesignPlanStoreReleaseSearch extends  UnionDesignPlanStoreRelease implements Serializable{
private static final long serialVersionUID = 1L;
	/**  发布名称-模糊查询  **/
	private String sch_ReleaseName_;
	/**  发布名称-左模糊查询  **/
	private String sch_ReleaseName;
	/**  发布名称-右模糊查询  **/
	private String schReleaseName_;
	/**  发布名称-区间查询-开始字符串  **/
	private String releaseNameStart;
	/**  发布名称-区间查询-结束字符串  **/
	private String releaseNameEnd;
	/**  发布类型(打包发布:1 单独发布：0)-模糊查询  **/
	private String sch_ReleaseType_;
	/**  发布类型(打包发布:1 单独发布：0)-左模糊查询  **/
	private String sch_ReleaseType;
	/**  发布类型(打包发布:1 单独发布：0)-右模糊查询  **/
	private String schReleaseType_;
	/**  发布类型(打包发布:1 单独发布：0)-区间查询-开始字符串  **/
	private String releaseTypeStart;
	/**  发布类型(打包发布:1 单独发布：0)-区间查询-结束字符串  **/
	private String releaseTypeEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_ReleaseName_() {
		return sch_ReleaseName_;
	}
	public void setSch_ReleaseName_(String sch_ReleaseName_){
		this.sch_ReleaseName_ = sch_ReleaseName_;
	}
	public  String getSch_ReleaseName() {
		return sch_ReleaseName;
	}
	public void setSch_ReleaseName(String sch_ReleaseName){
		this.sch_ReleaseName = sch_ReleaseName;
	}
	public  String getSchReleaseName_() {
		return schReleaseName_;
	}
	public void setSchReleaseName_(String schReleaseName_){
		this.schReleaseName_ = schReleaseName_;
	}
	public  String getReleaseNameStart() {
		return releaseNameStart;
	}
	public void setReleaseNameStart(String releaseNameStart){
		this.releaseNameStart = releaseNameStart;
	}
	public  String getReleaseNameEnd() {
		return releaseNameEnd;
	}
	public void setReleaseNameEnd(String releaseNameEnd){
		this.releaseNameEnd = releaseNameEnd;
	}
	public  String getSch_ReleaseType_() {
		return sch_ReleaseType_;
	}
	public void setSch_ReleaseType_(String sch_ReleaseType_){
		this.sch_ReleaseType_ = sch_ReleaseType_;
	}
	public  String getSch_ReleaseType() {
		return sch_ReleaseType;
	}
	public void setSch_ReleaseType(String sch_ReleaseType){
		this.sch_ReleaseType = sch_ReleaseType;
	}
	public  String getSchReleaseType_() {
		return schReleaseType_;
	}
	public void setSchReleaseType_(String schReleaseType_){
		this.schReleaseType_ = schReleaseType_;
	}
	public  String getReleaseTypeStart() {
		return releaseTypeStart;
	}
	public void setReleaseTypeStart(String releaseTypeStart){
		this.releaseTypeStart = releaseTypeStart;
	}
	public  String getReleaseTypeEnd() {
		return releaseTypeEnd;
	}
	public void setReleaseTypeEnd(String releaseTypeEnd){
		this.releaseTypeEnd = releaseTypeEnd;
	}
