...
/**   
 * @Title: UserProductCombinationCollectSearch.java 
 * @Package com.nork.porduct.model
 * @Description:产品组合收藏-产品组合收藏查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-03-23 11:13:32
 * @version V1.0   
 */
public class UserProductCombinationCollectSearch extends  UserProductCombinationCollect implements Serializable{
private static final long serialVersionUID = 1L;
	/**  组合产品配置文本-模糊查询  **/
	private String sch_ConfigContent_;
	/**  组合产品配置文本-左模糊查询  **/
	private String sch_ConfigContent;
	/**  组合产品配置文本-右模糊查询  **/
	private String schConfigContent_;
	/**  组合产品配置文本-区间查询-开始字符串  **/
	private String configContentStart;
	/**  组合产品配置文本-区间查询-结束字符串  **/
	private String configContentEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_ConfigContent_() {
		return sch_ConfigContent_;
	}
	public void setSch_ConfigContent_(String sch_ConfigContent_){
		this.sch_ConfigContent_ = sch_ConfigContent_;
	}
	public  String getSch_ConfigContent() {
		return sch_ConfigContent;
	}
	public void setSch_ConfigContent(String sch_ConfigContent){
		this.sch_ConfigContent = sch_ConfigContent;
	}
	public  String getSchConfigContent_() {
		return schConfigContent_;
	}
	public void setSchConfigContent_(String schConfigContent_){
		this.schConfigContent_ = schConfigContent_;
	}
	public  String getConfigContentStart() {
		return configContentStart;
	}
	public void setConfigContentStart(String configContentStart){
		this.configContentStart = configContentStart;
	}
	public  String getConfigContentEnd() {
		return configContentEnd;
	}
	public void setConfigContentEnd(String configContentEnd){
		this.configContentEnd = configContentEnd;
	}
