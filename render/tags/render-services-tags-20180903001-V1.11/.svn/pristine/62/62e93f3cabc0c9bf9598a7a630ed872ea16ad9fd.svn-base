...
@Service("optimizeDesignPlanService")
@Transactional
@ClientEndpoint
public class OptimizePlanServiceImpl implements OptimizePlanService {
	...
	@Override
	public Integer saveAsRenderBakScene(DesignPlanRes designPlanRes, LoginUser loginUser, Integer platformId) {
...
//				}
				...
				if (resPic.getRenderingType().intValue() == 4 || resPic.getRenderingType().intValue() == 1) {
					// 获取自动渲染的720的缩略图id
