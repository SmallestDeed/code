...
/**   
 * @Title: StructureProductDetails.java 
 * @Package com.nork.product.model
 * @Description:产品模块-结构明细表
 * @createAuthor pandajun 
 * @CreateDate 2016-12-02 15:42:46
 * @version V1.0   
 */
public class StructureProductDetails  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        StructureProductDetails other = (StructureProductDetails) that;
...
;
    ...
    /**获取对象的copy**/
    public StructureProductDetails copy(){
       StructureProductDetails obj =  new StructureProductDetails();
       obj.setStructureId(this.structureId);
    ...
    public Map toMap(){
       Map map =  new HashMap();
       map.put("structureId",this.structureId);
