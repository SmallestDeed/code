...
public class SystemCommonConstant {
	...
	// 将“1”：开启redis缓存 设置为静态常量OPEN_REDIS_CACHE_ENABLE
	public static final String OPEN_REDIS_CACHE_ENABLE = "1";
	// 将“0”：关闭redis缓存 设置为静态常量CLOSE_REDIS_CACHE_ENABLE
	public static final String CLOSE_REDIS_CACHE_ENABLE = "0";
	...
	// 用户为空
	public static final String LOGIN_USER_IS_EMPTY = "The user is empty!";
	...
	public static int USER_TIME_OUT_HOUR = 12;
	
	public static String AUTO_RENDER_USER_ACCOUNTS = "18888888888"; //自动渲染任务user ex: 18888888888,19999999999
	...
	//数据字典-价格单位
	public static final String SYS_DICTIONARY_TYPE_PRODUCTUNITPRICE = "productUnitPrice";
	
	/**
	 * 已开通移动端   
	 * add by chenm  20171114
	 */
	public static final Integer HAS_EXISTS_MOBILE = 1;
	
	/**
	 * 登录来源:移动端     做为移动端用户登录信息缓存标识
	 * add by chenm 20171114
	 */
	public static final String LOGIN_FROM_MOBILE = "user_H5Token:";
	
	/**
	 * 登录来源：PC客户端 做为PC客户端用户登录信息缓存标识
	 * add by chenm 20171114
	 */
	public static final String LOGIN_FROM_PC = "user_appToken:";
	
	 /**
     * 登录来源:运营网站     做为运营网站用户登录信息缓存标识
     */
	public static final String LOGIN_FROM_BRAND = "user_brandToken";
	/**
	 * 是否校验同一账号不能同时登录多台设备 （1为开启校验，0为关闭校验）
	 * by chenm 2017/12/12
	 */
    public static final String CHECK_ONELOGIN_ENABLE = "checkOneLoginEnable";
    //开启校验同一账号不能同时登录多台设备
    public static final String OPEN_CHECK_ONELOGIN_ENABLE = "1";
    //关闭校验同一账号不能同时登录多台设备
    public static final String CLOSE_CHECK_ONELOGIN_ENABLE = "0";
