            ...
            if (activityId != null) {
                ...
                if (resRenderPic.getTaskType() != null) {
                    if ((resRenderPic.getTaskType() == 0 && "1".equals(stateMap.get("2"))) ||
                        ...
                        client.sendHttpPost(doneTask, request.getHeader("Authorization"), "activityId=" + activityId.longValue());
                    }
                }
                ...
                client.sendHttpPost(increase, request.getHeader("Authorization"), "activityId=" + activityId.longValue());
            }
        }catch (Exception e) {
