...
public interface DesignPlanAutoRenderMapper {
    ...
    Integer updateSubTaskStateByBusinessId(@Param("preRenderSceneId") Integer preRenderSceneId);

    int updateFullHouseDesignPlan(@Param("fullHouseDesignPlanId") Integer fullHouseDesignPlanId);
}
