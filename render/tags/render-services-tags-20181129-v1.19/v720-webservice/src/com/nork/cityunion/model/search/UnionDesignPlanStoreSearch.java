...
/**   
 * @Title: UnionDesignPlanStoreSearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟设计方案素材库表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:21:19
 * @version V1.0   
 */
public class UnionDesignPlanStoreSearch extends  UnionDesignPlanStore implements Serializable{
private static final long serialVersionUID = 1L;
	/**  方案名称-模糊查询  **/
	private String sch_DesignPlanName_;
	/**  方案名称-左模糊查询  **/
	private String sch_DesignPlanName;
	/**  方案名称-右模糊查询  **/
	private String schDesignPlanName_;
	/**  方案名称-区间查询-开始字符串  **/
	private String designPlanNameStart;
	/**  方案名称-区间查询-结束字符串  **/
	private String designPlanNameEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_DesignPlanName_() {
		return sch_DesignPlanName_;
	}
	public void setSch_DesignPlanName_(String sch_DesignPlanName_){
		this.sch_DesignPlanName_ = sch_DesignPlanName_;
	}
	public  String getSch_DesignPlanName() {
		return sch_DesignPlanName;
	}
	public void setSch_DesignPlanName(String sch_DesignPlanName){
		this.sch_DesignPlanName = sch_DesignPlanName;
	}
	public  String getSchDesignPlanName_() {
		return schDesignPlanName_;
	}
	public void setSchDesignPlanName_(String schDesignPlanName_){
		this.schDesignPlanName_ = schDesignPlanName_;
	}
	public  String getDesignPlanNameStart() {
		return designPlanNameStart;
	}
	public void setDesignPlanNameStart(String designPlanNameStart){
		this.designPlanNameStart = designPlanNameStart;
	}
	public  String getDesignPlanNameEnd() {
		return designPlanNameEnd;
	}
	public void setDesignPlanNameEnd(String designPlanNameEnd){
		this.designPlanNameEnd = designPlanNameEnd;
	}
