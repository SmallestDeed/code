...
;
    ...
    public ResDesign resDesignCopy(){
       ...
       obj.setAtt6(this.att6);
       obj.setBusinessId(this.businessId);
       obj.setNuma2(this.numAtt2);
       if(this.numAtt3!=null){
		   obj.setNuma3(this.numAtt3.intValue());
       }
       if(this.numAtt4!=null){
    	   String str = this.numAtt4.toString();
    	   str = str.substring(0, str.indexOf("."));
    	   obj.setNuma4(Integer.parseInt(str));
       }
       obj.setRemark(this.remark);
