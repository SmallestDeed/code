...
/**   
 * @Title: SysVersionSearch.java 
 * @Package com.nork.system.model
 * @Description:系统模块-版本管理查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-05-05 14:18:01
 * @version V1.0   
 */
public class SysVersionSearch extends  SysVersion implements Serializable{
private static final long serialVersionUID = 1L;
	/**  平台类型-模糊查询  **/
	private String sch_SystemType_;
	/**  平台类型-左模糊查询  **/
	private String sch_SystemType;
	/**  平台类型-右模糊查询  **/
	private String schSystemType_;
	/**  平台类型-区间查询-开始字符串  **/
	private String systemTypeStart;
	/**  平台类型-区间查询-结束字符串  **/
	private String systemTypeEnd;
	/**  版本号-模糊查询  **/
	private String sch_Version_;
	/**  版本号-左模糊查询  **/
	private String sch_Version;
	/**  版本号-右模糊查询  **/
	private String schVersion_;
	/**  版本号-区间查询-开始字符串  **/
	private String versionStart;
	/**  版本号-区间查询-结束字符串  **/
	private String versionEnd;
	/**  标题-模糊查询  **/
	private String sch_Title_;
	/**  标题-左模糊查询  **/
	private String sch_Title;
	/**  标题-右模糊查询  **/
	private String schTitle_;
	/**  标题-区间查询-开始字符串  **/
	...
	/**  app地址-模糊查询  **/
	private String sch_AppPath_;
	/**  app地址-左模糊查询  **/
	private String sch_AppPath;
	/**  app地址-右模糊查询  **/
	private String schAppPath_;
	/**  app地址-区间查询-开始字符串  **/
	private String appPathStart;
	/**  app地址-区间查询-结束字符串  **/
	private String appPathEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_SystemType_() {
		return sch_SystemType_;
	}
	public void setSch_SystemType_(String sch_SystemType_){
		this.sch_SystemType_ = sch_SystemType_;
	}
	public  String getSch_SystemType() {
		return sch_SystemType;
	}
	public void setSch_SystemType(String sch_SystemType){
		this.sch_SystemType = sch_SystemType;
	}
	public  String getSchSystemType_() {
		return schSystemType_;
	}
	public void setSchSystemType_(String schSystemType_){
		this.schSystemType_ = schSystemType_;
	}
	public  String getSystemTypeStart() {
		return systemTypeStart;
	}
	public void setSystemTypeStart(String systemTypeStart){
		this.systemTypeStart = systemTypeStart;
	}
	public  String getSystemTypeEnd() {
		return systemTypeEnd;
	}
	public void setSystemTypeEnd(String systemTypeEnd){
		this.systemTypeEnd = systemTypeEnd;
	}
	public  String getSch_Version_() {
		return sch_Version_;
	}
	public void setSch_Version_(String sch_Version_){
		this.sch_Version_ = sch_Version_;
	}
	...
	public  String getSchVersion_() {
		return schVersion_;
	}
	public void setSchVersion_(String schVersion_){
		this.schVersion_ = schVersion_;
	}
	...
	public  String getSch_Title_() {
		return sch_Title_;
	}
	public void setSch_Title_(String sch_Title_){
		this.sch_Title_ = sch_Title_;
	}
	...
	public  String getSchTitle_() {
		return schTitle_;
	}
	public void setSchTitle_(String schTitle_){
		this.schTitle_ = schTitle_;
	}
	...
	public  String getSch_AppPath_() {
		return sch_AppPath_;
	}
	public void setSch_AppPath_(String sch_AppPath_){
		this.sch_AppPath_ = sch_AppPath_;
	}
	public  String getSch_AppPath() {
		return sch_AppPath;
	}
	public void setSch_AppPath(String sch_AppPath){
		this.sch_AppPath = sch_AppPath;
	}
	public  String getSchAppPath_() {
		return schAppPath_;
	}
	public void setSchAppPath_(String schAppPath_){
		this.schAppPath_ = schAppPath_;
	}
	public  String getAppPathStart() {
		return appPathStart;
	}
	public void setAppPathStart(String appPathStart){
		this.appPathStart = appPathStart;
	}
	public  String getAppPathEnd() {
		return appPathEnd;
	}
	public void setAppPathEnd(String appPathEnd){
		this.appPathEnd = appPathEnd;
	}
