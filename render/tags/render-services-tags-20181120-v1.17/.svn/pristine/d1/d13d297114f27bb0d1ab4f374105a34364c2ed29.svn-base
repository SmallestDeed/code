...
/**   
 * @Title: RenderHostSearch.java 
 * @Package com.nork.render.model
 * @Description:渲染-渲染主机查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-01-15 17:45:34
 * @version V1.0   
 */
public class RenderHostSearch extends  RenderHost implements Serializable{
private static final long serialVersionUID = 1L;
	/**  主机IP-模糊查询  **/
	private String sch_Ip_;
	/**  主机IP-左模糊查询  **/
	private String sch_Ip;
	/**  主机IP-右模糊查询  **/
	private String schIp_;
	/**  主机IP-区间查询-开始字符串  **/
	...
	public  String getSch_Ip_() {
		return sch_Ip_;
	}
	public void setSch_Ip_(String sch_Ip_){
		this.sch_Ip_ = sch_Ip_;
	}
	public  String getSch_Ip() {
		return sch_Ip;
	}
	public void setSch_Ip(String sch_Ip){
		this.sch_Ip = sch_Ip;
	}
	public  String getSchIp_() {
		return schIp_;
	}
	public void setSchIp_(String schIp_){
		this.schIp_ = schIp_;
	}
