package com.nork.mgr.model.search;
...
/**   
 * @Title: MgrRechargeLogSearch.java 
 * @Package com.nork.mgr.model
 * @Description:日常工作-充值记录查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-03-26 05:15:26
 * @version V1.0   
 */
public class MgrRechargeLogSearch extends  MgrRechargeLog implements Serializable{
