...
public interface DesignPlanAutoRenderService {
	 ...
	 * @return
	 */
	Long addListToRedisLists(List<AutoRenderTask> subtaskList);
    ...
    Integer updateAutoRenderTaskStateByTaskId(Integer mainTaskId, Integer state, Integer taskType);
	 ...
	 * @return: int
	 */
	int addRedisHDRenderTaskList(AutoRenderTask autoRenderTask) ;
