...
public class AppProperties {
    ...
    public static final String APP_ONEKEY_URL = "app.onekey.url";

	public static final String APP_CORE_URL = "app.core.url";

	/**
	 * 渲染告警处理组邮箱地址
	 */
	public static final String RENDER_WARNING_EMAIL = "render.warning.email";
}
