...
public interface HighDefinitionRenderService {
    ...
    RenderPayVo getHDRenderPayInfo(RenderPayInput paySearch, LoginUser loginUser) throws BizException;
     ...
     */
    RenderPayVo getRenderPayPriceInfo(RenderPayInput paySearch, LoginUser loginUser) throws BizException;
     ...
     */
    String getOrderNoByRenderOrder(RenderPayInput renderPaySearch, RenderPayVo renderPayVo, LoginUser loginUser) throws BizException;
     ...
     * @return: boolean
     */
    boolean saveRenderOrderWithDuBi(RenderPayInput renderPaySearch, LoginUser loginUser) throws BizException;
     ...
     * @return: void
     */
    void sendMessageForFailingHDRenderTask(String intenalTradeNo)throws BizException;
}
