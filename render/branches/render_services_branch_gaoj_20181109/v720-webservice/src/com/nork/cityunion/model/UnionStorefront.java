 ...
 * @version V1.0   
 */
public class UnionStorefront  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        UnionStorefront other = (UnionStorefront) that;
...
;
    ...
    /**获取对象的copy**/
    public UnionStorefront copy(){
       UnionStorefront obj =  new UnionStorefront();
