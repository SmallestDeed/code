...
/**   
 * @Title: UnionGroup.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟分组表
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:23:22
 * @version V1.0   
 */
public class UnionGroup  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        UnionGroup other = (UnionGroup) that;
...
;
    ...
    /**获取对象的copy**/
    public UnionGroup copy(){
       UnionGroup obj =  new UnionGroup();
