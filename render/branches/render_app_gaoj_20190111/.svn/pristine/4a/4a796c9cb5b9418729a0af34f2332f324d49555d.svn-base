...
public interface UserDesignPlanPurchaseRecordService {
    ...
    String payDesignPlanCopyRight(PayDesignPlanFree resRenderPic);
    ...
    Map<String,Object> checkReplaceDesignPlanPay(int i, Integer recommendedPlanId, String platformCode);

    Integer checkReplaceByDesignPlanRenderSceneId(Integer designPlanRenderSceneId);
}
