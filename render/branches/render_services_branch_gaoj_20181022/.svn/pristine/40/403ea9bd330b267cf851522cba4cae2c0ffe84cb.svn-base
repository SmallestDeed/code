package com.nork.pay.wexin.common;
...
public class Signature {
    ...
    public static String getSign(Map<String,Object> map){
        ...
        for(Map.Entry<String,Object> entry:map.entrySet()){
            if(entry.getValue()!=null && entry.getValue()!="" && entry.getValue().toString().length()>0){
            	if(entry.getKey().toString().equalsIgnoreCase("packageName")){
