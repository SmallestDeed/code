...
public interface DesignPlanProductService {
	 ...
	 * @param loginUser
	 * @param designPlanProduct
	 * @param baseBrandLs 同城联盟同组员选择的品牌列表
	 */
	List<ProductsCostType> costList(LoginUser loginUser, DesignPlanProduct designPlanProduct, costListEnum type,List<BaseBrand> baseBrandLs);
	 ...
	 * @return
	 */
	DesignPlanProduct getByPlanIdAndProductId(Integer planId, Integer productId);
}
