...
/**   
 * @Title: UserProductCombinationCollect.java 
 * @Package com.nork.porduct.model
 * @Description:产品组合收藏-产品组合收藏
 * @createAuthor pandajun 
 * @CreateDate 2016-03-23 11:13:32
 * @version V1.0   
 */
public class UserProductCombinationCollect  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        UserProductCombinationCollect other = (UserProductCombinationCollect) that;
...
;
    ...
    /**获取对象的copy**/
    public UserProductCombinationCollect copy(){
       UserProductCombinationCollect obj =  new UserProductCombinationCollect();
       obj.setUserId(this.userId);
       obj.setConfigContent(this.configContent);
    ...
    public Map toMap(){
       ...
       map.put("configContent",this.configContent);
