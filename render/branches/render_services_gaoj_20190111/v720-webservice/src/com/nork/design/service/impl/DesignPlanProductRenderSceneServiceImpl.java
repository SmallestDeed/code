...
public class DesignPlanProductRenderSceneServiceImpl implements DesignPlanProductRenderSceneService {
	...
	@Override
	public List<DesignPlanProductResult> getScenePlanProductList(DesignPlanProductRenderScene designPlanProductRenderScene) {
		return designPlanProductRenderSceneMapper.scenePlanProductList(designPlanProductRenderScene);
	}
