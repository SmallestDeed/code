...
/**   
 * @Title: SysUserLoginLog.java 
 * @Package com.nork.system.model
 * @Description:系统模块-用户信息采集
 * @createAuthor pandajun 
 * @CreateDate 2017-06-28 16:14:59
 * @version V1.0   
 */
public class SysUserLoginLog  extends Mapper implements Serializable{
...
;
    ...
    /**获取对象的copy**/
    public SysUserLoginLog copy(){
       SysUserLoginLog obj =  new SysUserLoginLog();
       obj.setUserId(this.userId);
       obj.setLoginTime(this.loginTime);
       obj.setLoginType(this.loginType);
