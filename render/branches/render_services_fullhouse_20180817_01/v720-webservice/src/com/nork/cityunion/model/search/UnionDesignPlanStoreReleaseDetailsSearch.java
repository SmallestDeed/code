...
/**   
 * @Title: UnionDesignPlanStoreReleaseDetailsSearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟素材发布明细表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:26:23
 * @version V1.0   
 */
public class UnionDesignPlanStoreReleaseDetailsSearch extends  UnionDesignPlanStoreReleaseDetails implements Serializable{
