...
public class WebDesignPlanControllerV2 {
	...
	@Autowired
	private MobileRenderRecordService mobileRenderRecordService;
...
//		final LoginUser loginUser = com.nork.common.constant.util.SystemCommonUtil.getCurrentLoginUserInfo(request);
		...
		loginUser.setId(new Long(uid).intValue());
	...
	public Object transformBydesigPlanRecommended(DesignPlanRecommended designPlanRecommended, String houseId,
		...
		if (newPlanId != null) {
			...
			if (taskId != null) {
				...
				replaceProductList = mobileRenderRecordService.selectListByTaskId(taskId);
				// 材质替换
				replaceTextureList = mobileRenderRecordService.selectTextureListByTaskId(taskId);
			}
