...
import com.sandu.custom.interceptor.ETLInterceptor;
...
public class IPSeeker {
    ...
    public static void main(String[] args) {
    	...
    	String jarf = "/usr/local/apache-flume-1.9.0-bin/lib/aa.jar";
    	
    	System.out.println(  jarf.substring(0, jarf.lastIndexOf("/")+1));
    	System.out.println(IPSeeker.class.getResource("/qqwry.dat").getPath());
    	System.out.println(IPSeeker.class.getProtectionDomain().getCodeSource().getLocation().getPath());
	}
    /** */
    /**
     * 私有构造函数
    ...
    protected IPSeeker() {
        ...
        try {
        	/*
        	logger.error("path1:"+IPSeeker.class.getProtectionDomain().getCodeSource().getLocation().getPath());
        	logger.error("path2:"+this.getClass().getResource("/qqwry.dat").getPath());
        	logger.error("path3:"+IPSeeker.class.getResource("/qqwry.dat").getPath());
        	logger.error("path4:"+this.getClass().getClassLoader().getResource("qqwry.dat").getPath());*/
        	
           // String ipFilePath = IPSeeker.class.getResource("/usr/local/apache-flume-1.9.0-bin/lib/qqwry.dat").getFile();
        	String jarFilePath = IPSeeker.class.getProtectionDomain().getCodeSource().getLocation().getPath();
        	String ipLibFilePath = jarFilePath.substring(0, jarFilePath.lastIndexOf("/")+1);
            ipFile = new RandomAccessFile(ipLibFilePath+"qqwry.dat", "r");
