...
private static final long serialVersionUID = 1L;
	 ...
	 * 产品小分类value集合
	 */
	private List<Integer> productSmallValueList;
	...
	public List<Integer> getProductSmallValueList() {
		return productSmallValueList;
	}
	
	public void setProductSmallValueList(List<Integer> productSmallValueList) {
	 ...
	 * 是否查询截面类台面产品：有值：是
	 */
	private Integer ctqkiBool;

	public Integer getCtqkiBool() {
		return ctqkiBool;
	}

	public void setCtqkiBool(Integer ctqkiBool) {
		this.ctqkiBool = ctqkiBool;
	}
