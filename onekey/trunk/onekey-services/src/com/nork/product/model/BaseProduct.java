...
private static final long serialVersionUID = 1L;
	...
	public Integer getBedsideDimensions() {
		return bedsideDimensions;
	}

	public void setBedsideDimensions(Integer bedsideDimensions) {
		this.bedsideDimensions = bedsideDimensions;
	}

	public Integer getIsComplexParquet() {
		return isComplexParquet;
	}

	public void setIsComplexParquet(Integer isComplexParquet) {
		this.isComplexParquet = isComplexParquet;
	}
