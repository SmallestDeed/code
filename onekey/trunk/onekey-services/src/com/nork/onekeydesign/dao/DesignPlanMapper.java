...
import com.nork.onekeydesign.model.DesigPlanWithResult;
import com.nork.onekeydesign.model.DesignPlan;
import com.nork.onekeydesign.model.DesignPlanModel;
import com.nork.onekeydesign.model.DesignPlanResult;
...
public interface DesignPlanMapper {
    ...
    Integer selectPlanId(@Param("id") Integer designProductId);

    int updatePlanById(@Param("id")Integer id);
}
