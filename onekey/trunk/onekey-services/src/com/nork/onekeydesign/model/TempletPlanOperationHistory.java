 ...
 *	推荐方案使用历史表  
 */
public class TempletPlanOperationHistory  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        TempletPlanOperationHistory other = (TempletPlanOperationHistory) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getDesignPlanRecommendedId() == null ? other.getDesignPlanRecommendedId() == null : this.getDesignPlanRecommendedId().equals(other.getDesignPlanRecommendedId()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDesignPlanRecommendedId() == null) ? 0 : getDesignPlanRecommendedId().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public TempletPlanOperationHistory copy(){
       TempletPlanOperationHistory obj =  new TempletPlanOperationHistory();
       obj.setDesignTempletId(this.designTempletId);
       obj.setDesignPlanRecommendedId(this.designPlanRecommendedId);
    ...
    public Map toMap(){
       ...
       map.put("designPlanRecommendedId",this.designPlanRecommendedId);
