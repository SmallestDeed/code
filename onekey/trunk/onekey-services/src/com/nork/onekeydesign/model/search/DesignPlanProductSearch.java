...
/**   
 * @Title: DesignPlanProductSearch.java 
 * @Package com.nork.onekeydesign.model
 * @Description:设计方案-设计方案产品库查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-06-26 11:26:11
 * @version V1.0   
 */
public class DesignPlanProductSearch extends  DesignPlanProduct implements Serializable{
private static final long serialVersionUID = 1L;
	...
	/**  字符备用1-模糊查询  **/
	private String sch_MaterialPicId_;
	/**  字符备用1-左模糊查询  **/
	private String sch_MaterialPicId;
	/**  字符备用1-右模糊查询  **/
	private String schMaterialPicId_;
	/**  字符备用1-区间查询-开始字符串  **/
	private String materialPicIdStart;
	/**  字符备用1-区间查询-结束字符串  **/
	private String materialPicIdEnd;
	/**  字符备用2-模糊查询  **/
	...
	public String getSch_MaterialPicId_() {
		return sch_MaterialPicId_;
	}
	public void setSch_MaterialPicId_(String sch_MaterialPicId_) {
		this.sch_MaterialPicId_ = sch_MaterialPicId_;
	}
	public String getSch_MaterialPicId() {
		return sch_MaterialPicId;
	}
	public void setSch_MaterialPicId(String sch_MaterialPicId) {
		this.sch_MaterialPicId = sch_MaterialPicId;
	}
	public String getSchMaterialPicId_() {
		return schMaterialPicId_;
	}
	public void setSchMaterialPicId_(String schMaterialPicId_) {
		this.schMaterialPicId_ = schMaterialPicId_;
	}
	public String getMaterialPicIdStart() {
		return materialPicIdStart;
	}
	public void setMaterialPicIdStart(String materialPicIdStart) {
		this.materialPicIdStart = materialPicIdStart;
	}
	public String getMaterialPicIdEnd() {
		return materialPicIdEnd;
	}
	public void setMaterialPicIdEnd(String materialPicIdEnd) {
		this.materialPicIdEnd = materialPicIdEnd;
	}
