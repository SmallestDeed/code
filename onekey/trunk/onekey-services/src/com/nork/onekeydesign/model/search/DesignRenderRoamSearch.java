...
/**   
 * @Title: DesignRenderRoamSearch.java 
 * @Package com.nork.render.model
 * @Description:720漫游-渲染漫游查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-07-14 10:45:53
 * @version V1.0   
 */
public class DesignRenderRoamSearch extends DesignRenderRoam implements Serializable{
private static final long serialVersionUID = 1L;
	/**  唯一标识-模糊查询  **/
	private String sch_Uuid_;
	/**  唯一标识-左模糊查询  **/
	private String sch_Uuid;
	/**  唯一标识-右模糊查询  **/
	private String schUuid_;
	/**  唯一标识-区间查询-开始字符串  **/
	...
	public  String getSch_Uuid_() {
		return sch_Uuid_;
	}
	public void setSch_Uuid_(String sch_Uuid_){
		this.sch_Uuid_ = sch_Uuid_;
	}
	...
	public  String getSchUuid_() {
		return schUuid_;
	}
	public void setSchUuid_(String schUuid_){
		this.schUuid_ = schUuid_;
	}
	public  String getUuidStart() {
		return uuidStart;
	}
	public void setUuidStart(String uuidStart){
		this.uuidStart = uuidStart;
	}
	public  String getUuidEnd() {
		return uuidEnd;
	}
	public void setUuidEnd(String uuidEnd){
