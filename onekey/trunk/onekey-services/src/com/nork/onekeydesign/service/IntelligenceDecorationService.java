...
import com.nork.onekeydesign.model.vo.MatchItenCodeVO;
...
public interface IntelligenceDecorationService {
	...
	public ResponseEnvelope<UnityDesignPlan> findGeneratePlanInfo(Integer planId, Integer designTempletId,DesignPlanRecommended designPlanRecommended,String context,String msgId, LoginUser loginUser, String mediaType);
	...
	public MatchItenCodeVO findByItemCodeInfoV2(String posNames, DesignTemplet designTemplet,
												DesignPlanRecommended designPlanRecommended,
										 LoginUser loginUser, Integer opType, String planSource) throws IntelligenceDecorationException;
	...
	public Map<String, Object> structureListMatch(
			...
			String spaceCode, DesignTemplet designTemplet, UnityDesignPlanRecommended unityDesignPlanRecommended) throws IntelligenceDecorationException;
	...
	public Map<String, Object> groupListMatch(
			...
			Integer opType,UnityDesignPlanRecommended unityDesignPlanRecommended
	);
	...
	PlanProductInfo selectOneProduct(PlanProductInfo planProductInfo) throws ElasticSearchException;

	PlanProductInfo selectOneProductFromDB(PlanProductInfo planProductInfo);
	
	/**
	 * 检查是否启用/禁用副本功能
	 * return true:启用了副本功能
	 * return false:禁用了副本功能
	 * 
	 * @author huangsongbo
	 * @return
	 */
