...
public interface ResDesignService {
	...
	/**
	 * ResDesignOnekeyTemplate ->ResDesign
	 * 
	 * @author huangsongbo
	 * @param configFileId
	 * @param designPlanId 
	 ...
	 */
	public Integer copyFromResDesignOnekeyTemplate(Integer configFileId, Integer designPlanId, Integer opType) throws IntelligenceDecorationException;

	Integer add(ResDesign resDesign, Integer opType) throws IntelligenceDecorationException;
}
