	...
	public Map<String, ResHousePic> createThumbnail(ResHousePic resHousePic,HttpServletRequest request) throws IOException{
			/**生成缩略图*/
				...
				if(fileKeyInfo==1){
					...
					fileKeyWeb="onekeydesign.designTemplet.pic.small.web.upload.path";
					fileKeyIpad="onekeydesign.designTemplet.pic.small.ipad.upload.path";
				}else if(fileKeyInfo==5){
					fileKeyWeb="onekeydesign.designTemplet.piclist.small.web.upload.path";
					fileKeyIpad="onekeydesign.designTemplet.piclist.small.ipad.upload.path";
				}
				/*
				 ...
				 * else if(fileKeyInfo==6){
					...
					fileKeyWeb="onekeydesign.designTemplet.effectPlan.small.web.upload.path";
					fileKeyIpad="onekeydesign.designTemplet.effectPlan.small.ipad.upload.path";
				 ...
				 * else if(fileKeyInfo==6){
					...
					/*resPicWeb.setPicPath(app.getString("onekeydesign.designTemplet.effectPlan.upload.path")+"small/web_"+name);
