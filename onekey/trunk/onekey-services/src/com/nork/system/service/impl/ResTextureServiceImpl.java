...
public class ResTextureServiceImpl implements ResTextureService {
	...
	/*private Logger logger = Logger.getLogger(ResTextureServiceImpl.class);*/
...
//			ResFile resFile=resFileService.get(textureBallFileId);
	...
	@Override
	public List<UnityPlanProductresTexture> getProductResTextureList(List<Integer> resTextureIdList){
		return resTextureMapper.selectProductResTextureList(resTextureIdList);
	}
}
