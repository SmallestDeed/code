...
public class ResDesignRenderSceneServiceImpl implements ResDesignRenderSceneService{
	...
	public long copySpellingFlowerFile(Integer spellingFlowerFileId,DesignPlanRenderScene designPlanRenderScene) {
		...
		String fileKey = "onekeydesign.designPlanRenderScene.spellingFlowerFile";
		...
		if (StringUtils.isNotEmpty(resFilePath)) {
			...
			String newPath = Utils.getPropertyName("config/res", "onekeydesign.designPlanRenderScene.spellingFlowerFile","/AA/d_userdesign/[yyyy]/[MM]/[dd]/[HH]/onekeydesign/designPlanRenderScene/spellingFlowerFile/");
