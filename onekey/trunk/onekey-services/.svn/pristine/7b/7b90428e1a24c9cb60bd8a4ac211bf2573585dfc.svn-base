...
public interface BaseProductService {
	 ...
	 * @return
	 */
	BaseProduct findContainDeleteProductByCode (String productCode);
	 ...
	 * 产品搜索(简单)
	 * 
	 * 优化(select by ElaticSearch) by huangsongbo 2018.6.28
	 * 
	 * @author huangsongbo
	 * @param baseProductSearch
	 * @return
	...
	List<BaseProduct> selectProductEasy(ProductSearchForOneKeyDTO productSearchForOneKeyDTO) throws ElasticSearchException;

	/**
	 * PlanProductInfo -> ProductSearchForOneKeyDTO
	 * 
	 * @author huangsongbo
	 * @param planProductInfo
	 * @return
	...
	List<BaseProduct> selectProductEasyFromDB(BaseProductSearch baseProductSearch);
	 ...
	 */
	int getProductStyleCountById(Integer id);
