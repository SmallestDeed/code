...
/**   
 * @Title: TempletProductIndexInfoSearch.java 
 * @Package com.nork.onekeydesign.model
 * @Description:设计模块-同分类产品序号表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-06-13 16:19:25
 * @version V1.0   
 */
public class TempletProductIndexInfoSearch extends  TempletProductIndexInfo implements Serializable{
private static final long serialVersionUID = 1L;
	/**  方案产品序号信息-模糊查询  **/
	private String sch_ProductIndexInfo_;
	/**  方案产品序号信息-左模糊查询  **/
	private String sch_ProductIndexInfo;
	/**  方案产品序号信息-右模糊查询  **/
	private String schProductIndexInfo_;
	/**  方案产品序号信息-区间查询-开始字符串  **/
	private String productIndexInfoStart;
	/**  方案产品序号信息-区间查询-结束字符串  **/
	private String productIndexInfoEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_ProductIndexInfo_() {
		return sch_ProductIndexInfo_;
	}
	public void setSch_ProductIndexInfo_(String sch_ProductIndexInfo_){
		this.sch_ProductIndexInfo_ = sch_ProductIndexInfo_;
	}
	public  String getSch_ProductIndexInfo() {
		return sch_ProductIndexInfo;
	}
	public void setSch_ProductIndexInfo(String sch_ProductIndexInfo){
		this.sch_ProductIndexInfo = sch_ProductIndexInfo;
	}
	public  String getSchProductIndexInfo_() {
		return schProductIndexInfo_;
	}
	public void setSchProductIndexInfo_(String schProductIndexInfo_){
		this.schProductIndexInfo_ = schProductIndexInfo_;
	}
	public  String getProductIndexInfoStart() {
		return productIndexInfoStart;
	}
	public void setProductIndexInfoStart(String productIndexInfoStart){
		this.productIndexInfoStart = productIndexInfoStart;
	}
	public  String getProductIndexInfoEnd() {
		return productIndexInfoEnd;
	}
	public void setProductIndexInfoEnd(String productIndexInfoEnd){
		this.productIndexInfoEnd = productIndexInfoEnd;
	}
