...
public class UpdateDesignPlanCacheTask implements Callable<Result> {
    ...
    public Result call() throws Exception {
        ...
        ResponseEnvelope responseEnvelopeInfo = (ResponseEnvelope)designPlanService.getDesignPlanInfoForOneKey(designPlanId,newFlag,houseId,livingId,residentialUnitsName,false,loginUser,mediaType, null);
