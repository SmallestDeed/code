 ...
 */
public class DesignProductResult  implements Serializable{
    ...
    //同小分类序号
    private String sameProductTypeIndex;
    //组合产品标识
    ...
    public String getSameProductTypeIndex() {
        return sameProductTypeIndex;
    }

    public void setSameProductTypeIndex(String sameProductTypeIndex) {
