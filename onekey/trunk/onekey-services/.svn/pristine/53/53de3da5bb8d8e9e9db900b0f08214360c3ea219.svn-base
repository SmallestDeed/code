...
/**   
 * @Title: DesignPlanOperationLogSearch.java 
 * @Package com.nork.onekeydesign.model
 * @Description:设计方案-设计方案操作日志查询对象
 * @createAuthor pandajun 
 * @CreateDate 2017-06-27 14:41:51
 * @version V1.0   
 */
public class DesignPlanOperationLogSearch extends  DesignPlanOperationLog implements Serializable{
private static final long serialVersionUID = 1L;
	/**  设计方案日志保存key-模糊查询  **/
	private String sch_BusinessKey_;
	/**  设计方案日志保存key-左模糊查询  **/
	private String sch_BusinessKey;
	/**  设计方案日志保存key-右模糊查询  **/
	private String schBusinessKey_;
	/**  设计方案日志保存key-区间查询-开始字符串  **/
	private String businessKeyStart;
	/**  设计方案日志保存key-区间查询-结束字符串  **/
	private String businessKeyEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_BusinessKey_() {
		return sch_BusinessKey_;
	}
	public void setSch_BusinessKey_(String sch_BusinessKey_){
		this.sch_BusinessKey_ = sch_BusinessKey_;
	}
	public  String getSch_BusinessKey() {
		return sch_BusinessKey;
	}
	public void setSch_BusinessKey(String sch_BusinessKey){
		this.sch_BusinessKey = sch_BusinessKey;
	}
	public  String getSchBusinessKey_() {
		return schBusinessKey_;
	}
	public void setSchBusinessKey_(String schBusinessKey_){
		this.schBusinessKey_ = schBusinessKey_;
	}
	public  String getBusinessKeyStart() {
		return businessKeyStart;
	}
	public void setBusinessKeyStart(String businessKeyStart){
		this.businessKeyStart = businessKeyStart;
	}
	public  String getBusinessKeyEnd() {
		return businessKeyEnd;
	}
	public void setBusinessKeyEnd(String businessKeyEnd){
		this.businessKeyEnd = businessKeyEnd;
	}
