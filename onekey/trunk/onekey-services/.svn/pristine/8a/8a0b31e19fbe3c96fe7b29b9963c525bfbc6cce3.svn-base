...
import com.nork.intelligence.constant.MatchFunctionEnum;
...
public class ProductListByTypeInfo implements Serializable{
	...
	public static class PlanProductInfo implements Cloneable, Serializable{
		...
		/**
		 * 多小类搜索条件(应对与initProduct)
		 */
		private List<String> smallTypeValueKeyInitList;
		 ...
		 * 记录背景墙是否要被匹配
		 */
		private boolean needBeMatched = true;
		
		/**
		 * 特殊匹配逻辑方式,具体见enum的注释
		 */
		/*private MatchFunctionEnum matchFunctionEnum;*/
		...
		/*public MatchFunctionEnum getMatchFunctionEnum() {
			return matchFunctionEnum;
		}

		public void setMatchFunctionEnum(MatchFunctionEnum matchFunctionEnum) {
			this.matchFunctionEnum = matchFunctionEnum;
		}*/
		...
		public boolean isNeedBeMatched() {
			return needBeMatched;
		}

		public void setNeedBeMatched(boolean needBeMatched) {
			this.needBeMatched = needBeMatched;
		}
		...
		public List<String> getSmallTypeValueKeyInitList() {
			return smallTypeValueKeyInitList;
		}

		public void setSmallTypeValueKeyInitList(List<String> smallTypeValueKeyInitList) {
			this.smallTypeValueKeyInitList = smallTypeValueKeyInitList;
		}
