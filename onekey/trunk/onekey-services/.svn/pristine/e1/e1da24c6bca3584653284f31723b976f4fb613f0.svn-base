...
public class DesignPlanRenderServiceImpl implements DesignPlanRenderService {
    ...
    /* (non-Javadoc)
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#getDesignPlanRes(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#saveAsRenderBakScene(com.nork.onekeydesign.model.DesignPlanRes)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#getRenderBakScene(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#saveAsTempDesignPaln4RenderBakScene(com.nork.onekeydesign.model.DesignPlanRes)
     */
    @Override
    ...
    public long saveAsRender(DesignPlanRes designPlanRes) {
		...
		if(designPlan.getSpellingFlowerFileId()!=null) {
			Integer resFileId = this.designPlanRecommendedCopyFile(designPlan.getSpellingFlowerFileId().toString(), 
					"onekeydesign.designPlan.spellingFlowerFile.upload.path",
					"/AA/d_userdesign/[yyyy]/[MM]/[dd]/[HH]/onekeydesign/designPlan/spellingFlowerFile/",
...
//						+ resourcesName.substring(resourcesName.indexOf("."));
    ...
    /* (non-Javadoc)
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#deleteTempDesignPaln4RenderBakScene(long)
     */
    @Override
    ...
    public void deleteTempDesignPaln4RenderBakSceneTask() {
        ...
        if (dpList != null && dpList.size() > 0) {
            ...
            for (DesignPlan tmp : dpList) {
                ...
                /*String usedConfigPath = Utils.getValue("onekeydesign.designPlan.usedConfig.upload.path",
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#changeTempDesignPalnVisible(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#associatedRenderResWithBakScene(long, long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#checkModify4DesignPlan(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#checkModify4BakScene(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#checkExistBakScene4DesignPlan(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#getTempDesignPalnId4BakScene(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#getLatestRenderBakScene(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#getLatestThumbId(long)
     */
    @Override
...
//        renderPic.setFileKey(ResProperties.DESIGNPLAN_RENDER_PIC_SMALL_FILEKEY);
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#allownFreeRender(long)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#processAfterRender(com.nork.onekeydesign.model.RenderPicVO)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPalnRenderService#verifyDesignPlanRes(long, com.nork.onekeydesign.model.DesignPlanRes)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPlanRenderService#updataBakSceneName(com.nork.onekeydesign.model.DesignPlanRenderScene)
     */
    @Override
    ...
    /* (non-Javadoc)    
     * @see com.nork.onekeydesign.service.DesignPlanRenderService#existTempDesignPaln(long, long)
     */
    @Override
