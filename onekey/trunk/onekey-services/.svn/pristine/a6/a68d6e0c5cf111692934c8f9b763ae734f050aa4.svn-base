...
public interface DesignPlanService {
	...
	* @throws
	...
	/**
	 * 批量新增一键生成样板房产品未匹配到的产品
	 * @param planId 方案Id
	 * @param unmatchProductList 未匹配到的样板房产品
	 * @param loginUser 用户信息
	 * @param isDeleted 删除状态（0,1）
	 * @return
	 */
	Boolean batchAddPlanProduct(Integer planId, List<DesignProductResult> unmatchProductList, LoginUser loginUser, Integer isDeleted, Integer opType);
	 ...
	 */
	void getProductCeilingVO(UnityPlanProduct unityPlanProduct, DesignPlanProduct planProduct,
							 BaseProduct baseProduct, List<Integer> putawayStateList);

	/**
	 * 从一键装修生成方案副本相关信息(DesignPlanTemplate/ResDesignOnekeyTemplate/DesignPlanTemplateProduct)中
	 * copy数据到设计方案模块(designPlan/ResDesign/DesignPlanProduct)
	 * 
	 * @author huangsongbo
	 ...
	 * @param opType 渲染机:0/通用版:1
	 * @param loginUser 用户信息
	 * @param designTempletId 设计方案对应的样板房id
	 * @return
	 * @throws IntelligenceDecorationException 
	 */
	...
	Integer add(DesignPlan designPlan, Integer opType) throws IntelligenceDecorationException;

	/**
	 * generate a new DesignPlan code(field: plan_code)
	 * 
	 * @author huangsongbo
	 * @param planCode
	 * @return
	 ...
	 * @date 2018/10/31 0031 16:42
	 */
	Object getDesignRecommendedInfoByMath(UnityDesignPlanRecommended unityDesignPlanRecommended,LoginUser loginUser, String msgId);
