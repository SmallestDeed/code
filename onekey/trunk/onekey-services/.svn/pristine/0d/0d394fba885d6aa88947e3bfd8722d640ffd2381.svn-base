...
import com.nork.onekeydesign.model.RenderConfig;
...
//        String path = Utils.getValue("app.render.root","D:\\MaxRender").trim()+"/3Dmax";
    ...
    public static boolean replaceFile(String context,RenderConfig renderConfig){
        ...
        String fileName = Utils.getValue("onekeydesign.designPlan.maxrender.config.name","Data.txt").trim();
...
//        String uploadDic = Utils.getValue("onekeydesign.designPlan.maxrender.designPlan.upload.path", "/MaxRender/").trim();
