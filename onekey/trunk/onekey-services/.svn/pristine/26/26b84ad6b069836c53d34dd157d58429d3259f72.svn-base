...
import com.nork.onekeydesign.dao.DesignPlanAutoRenderMapper;
...
import com.nork.onekeydesign.model.DesignPlanModel;
...
import com.nork.onekeydesign.model.ProductDTO;
...
import com.nork.onekeydesign.model.UnitySpaceCommon;
...
public class OptimizePlanServiceImpl implements OptimizePlanService {
	...
	public DesignPlan createDesignPlan(DesignPlan designPlan, DesignPlanRecommended designPlanRecommended,DesignTemplet designTemplet, String mediaType,
			LoginUser loginUser, Integer isDeleted) {
		...
		designPlan.setIsDeleted(isDeleted == null ? 0 :isDeleted);
...
//			String fileContext = FileUploadUtils.getFileContext(filePath);
		...
		if (designPlan != null && designPlan.getId() != null && isAllreplace == 1) {
			if (opType.intValue() == DesignPlanConstants.AUTO_RENDER.intValue()) {
				...
				ResponseEnvelope<UnityDesignPlan> responseEnvelopeInfo = (ResponseEnvelope) this
						.getDesignPlanInfoForOneKey(designPlan.getId(), null, null, null, null, false, loginUser, mediaType);
				...
				if (flagPlan) {
					...
					ResponseEnvelope<UnityDesignPlan> responseEnvelopeInfo = (ResponseEnvelope) designPlanService
							.getDesignPlanInfoForOneKey(newDesignPlanId, null, null, null, null, false, loginUser, mediaType, null);
	...
	public long copyFromAutoResDesign(ResDesign resDesign, long businessId) {
		...
		String uploadUrl = Utils.getPropertyName("config/res", fileKeyNew + ".upload.path",
				"/AA/d_userdesign_auto/[YYYY]/[MM]/[dd]/[HH]/onekeydesign/designPlan/u3dconfig/");
	 ...
	 * 
	 * @see
	 * com.nork.onekeydesign.service.DesignPalnRenderService#changeTempDesignPalnVisible(
	 * long)
	 */
	@Override
	...
	public boolean updateDesignPlan(DesignPlan desPlan, Integer designPlanId, Integer planProductId, Integer productId,
		...
		try {
			...
			if (newProduct.getProductCode() != null && !newProduct.getProductCode().startsWith("baimo_")) {
				...
				// Utils.getValue("onekeydesign.designPlan.usedConfig.upload.path","/onekeydesign/designPlan/[code]/usedConfig/");
				...
				String usedConfigPath = Utils.getValue("design.designPlan.usedConfig.upload.path",
						"/AA/e_userlogs/[yyyy]/[MM]/[dd]/[HH]/onekeydesign/designPlan/usedConfig/");
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.nork.onekeydesign.service.DesignPalnRenderService#isInvisible4Render(long)
	 */
	@Override
	 ...
	 */
	@Override
	public ResponseEnvelope<UnityDesignPlan> findOnekeyAutoRenderPlanInfo(Integer planId, Integer designTempletId,
		...
		DesignPlan designPlan = this.getPlan(planId);
		...
		// 配置内容存储路径
		// String configKey =
		// Utils.getValue("onekeydesign.designPlan.u3dconfig.upload.path","/AA/d_userdesign/[yyyy]/[MM]/[dd]/[HH]/onekeydesign/designPlan/u3dconfig/");
		...
		String configKey = Utils.getPropertyName("config/res", "auto.design.designPlan.u3dconfig.upload.path",
				"/AA/d_userdesign_auto/[yyyy]/[MM]/[dd]/[HH]/onekeydesign/designPlan/u3dconfig/").trim();
	...
	public Map<String, String> get720SysCode(Integer planRecommendedId, Integer templateId, Integer renderingType,Integer taskId) {
		...
		if (templateId.intValue() == -1 || templateId.intValue() == 0) {// 替换渲染
			...
			if (arts != null && arts.getBusinessId() != null) {
				...
				fileKeyList.add("onekeydesign.designPlan.render.pic");
				fileKeyList.add("onekeydesign.designPlan.render.video.cover");
				// fileKeyList.add("auto.onekeydesign.designPlan.render.pic");
				// fileKeyList.add("auto.onekeydesign.designPlan.render.video.cover");
	...
	public Integer saveAsRenderBakScene(DesignPlanRes designPlanRes, LoginUser loginUser) {
		...
		if (designPlan.getConfigFileId() != null) {
			Integer resFileId = this.planCopyFile(designPlan.getConfigFileId().toString(), "file",
					"onekeydesign.designPlan.u3dconfig", null, loginUser, designPlan.getPlanCode());
...
//				}
				...
				if (resPic.getRenderingType().intValue() == RenderTypeCode.COMMON_VIDEO) {
					...
					if (video != null) {
						...
						video.setSysCode(
								Utils.getCurrentDateTime(Utils.DATETIMESSS) + "_" + Utils.generateRandomDigitString(6));
						// video.setFileKey("onekeydesign.designPlan.render.video");
