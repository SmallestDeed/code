...
Page({
  ...
  /*添加方案*/
  addProject() {
    $App.sellingPoint(API, 'HuiFuTieziaddProject', this.data.nowPath, this.data.previousPath, '回复评论');
  ...
  /*添加户型*/
  addHouse() {
    $App.sellingPoint(API, 'HuiFuTieziaddHouse', this.data.nowPath, this.data.previousPath, '回复评论');
    if (this.data.addPlanId != '' || this.data.addHouseId != '') {
      wx.showToast({
        icon: 'none',
        title: '户型、方案只能上传一个',
  ...
  /*添加图片*/
  addImg() {
    $App.sellingPoint(API, 'HuiFuTieziaddImg', this.data.nowPath, this.data.previousPath, '回复评论');
    let num = 10
  ...
  /*发布*/
  goPublish() {
    $App.sellingPoint(API, 'HuiFuTiezigoPublish', this.data.nowPath, this.data.previousPath, '回复评论');
