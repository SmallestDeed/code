...
Page({
    ...
    data: {
        ...
        decorationCate: [{
                ...
                imgPath: "/static/image/brandList4.png"
            },
            {
                name: "设计公司",
                href: "../brandList/brandList?tab=4",
                imgPath: "/static/image/brandList3.png"
            },
            {
                name: "装修公司",
                href: "../brandList/brandList?tab=5",
                imgPath: "/static/image/brandList5.png"
            },
            {
                name: "工长",
                href: "../brandList/brandList?tab=6",
                imgPath: "/static/image/brandList1.png"
            },
            {
                name: "建材家居",
                href: "../brandList/brandList?tab=2",
                imgPath: "/static/image/brandList2.png"
            }
        ],
        classifyList: [{
                name: "设计师",
        ...
        fitmentList: [],
        fitmentIconList: [
          '/static/image/renovation.png', '/static/image/service_icon_07.png',
          '/static/image/supply_gz.png', '/static/image/service_icon_09.png',
          '/static/image/service_icon_04.png', '/static/image/brandList5.png'
        ],
        buildingList: [],
        buildingIconList: [
          '/static/image/jiancai.png', '/static/image/jiaju.png',
          '/static/image/service_icon_12.png'
        ],
        manpowerList: [],
      manpowerIconList: ['/static/image/service_icon_01.png', '/static/image/service_icon_13.png']
    },
     ...
     */
    onPageScroll(e) {
        if (this.data.praiseRecommended != 0 && e.scrollTop >= this.data.praiseRecommended) {
            this.setData({
        ...
        if (e.scrollTop > 200 && this.data.scrollY <= 200) {
            this.setData({
                ifShowToTopLogo: true
            })
            this.data.scrollY = 201
        } else if (e.scrollTop <= 200 && this.data.scrollY > 200) {
            this.setData({
                ifShowToTopLogo: false
            })
            // console.log(this.data.ifShowToTopLogo, 'wq' + new Date())
            this.data.scrollY = 200
        }
    },
    goSeek() {
      wx.navigateTo({
    ...
    getsupplyinfo() {
      console.log(wx.getStorageSync('nowCity').areaCode);
        let obj = null
        this.data.cityCode == '' ? obj = {
            isSortByGmtModified: 'desc'
        } : (this.data.supType == 'new' ? obj = {
            isSortByGmtModified: 'desc'
        } : obj = {
        ...
        API.getallsupplydemandinfo(Object.assign({
          ...
          city: wx.getStorageSync('nowCity').areaCode ? wx.getStorageSync('nowCity').areaCode: undefined,
            }, obj))
            .then(res => {
                let arr = [];
                if (res.obj != null) {
