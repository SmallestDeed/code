...
Page({
  ...
  onReachBottom() {
    ...
    this.data.type == 'myPlan' ? this.getRecommendCaseList(this.data.getCaseParams) : this.getPlanList()
  },
  switchCheck(e) {
    let index = e.currentTarget.dataset.index
  ...
  confirmBtn() {
    ...
    if (this.data.type == 'myPlan') {
      ...
      prevPage.setData({
        addPlanId: this.data.planList[this.data.isCheck].newFullHousePlanId,
