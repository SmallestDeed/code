...
Page({
  ...
  getBannerList() {
    ...
    let obj = [
      {
        //skipPath: 'http://www.ci.suixuanwang.com/landingpage/meetinghome.html ',
        skipPath: getApp().sxwLangingPage +  '/sxw/landingpage/meetinghome.html ',
        bannerName: '遇见未来',
        picPath: this.data.staticImage + 'home_banner_05.png',
        type:'webView'
      },
      {
      skipPath: '/pages/landing/landing?userId=' + this.data.userid,
        bannerName: '免费报价',
        picPath: this.data.staticImage + 'home_banner_02.png'
      },
      {
        skipPath: '/pages/zerodesign/zerodesign',
        bannerName: '0元设计',
        picPath: this.data.staticImage + 'home_banner_03.png'
      },
      {
        skipPath: '/pages/course/course',
        bannerName: '操作指南',
        picPath: this.data.staticImage + 'home_banner_04.png'
      }
      // {
      //   skipPath: '/pages/course/course',
      //   bannerName: '操作指南',
