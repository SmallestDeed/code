...
Page({
  ...
  data: {
    ...
    navList: [{ name: '需求' , type:2}, { name: '供应',type:1 }],
    navIconIndex: 2,
    limit: 10,
    totalCount: 0,
    newsList: [],
  ...
  switchover(e) {
    this.setData({
      navIconIndex: e.currentTarget.dataset.type,
      limit: 10
    });
    this.getInvitationList();
  },
  ...
  /*跳转详情页面*/
  goSupplyDetail(e) {
    let id = e.currentTarget.dataset.item.supplyDemandId;
    wx.navigateTo({
      url: '/pages/decoration/supplyDetail/supplyDetail?id=' + id,
    })
  },
