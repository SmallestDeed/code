...
Page({
  ...
  /**
   * 生命周期函数--监听页面加载   $App.sellingPoint(API, 'huDonggoSeek', this.data.nowPath, this.data.previousPath, '互动区');
   */
  ...
  bottomFocus(e) {
    $App.sellingPoint(API, 'TieZibottomFocus', this.data.nowPath, this.data.previousPath, '信息详情');
  ...
  houseTodetail(e) {
    $App.sellingPoint(API, 'TieZihouseTodetail', this.data.nowPath, this.data.previousPath, '信息详情');
    let item = e.currentTarget.dataset.item
    wx.navigateTo({
