...
//        companyshopoffline.setCoverPicPath(coverPicPaths);
        ...
        Map<String, String> areaMap = baseAreaService.codeAndNameMap();
        String provinceName = areaMap.get(companyshopoffline.getProvinceCode() == null ? "" : companyshopoffline.getProvinceCode());
        String cityName = areaMap.get(companyshopoffline.getCityCode() == null ? "" : companyshopoffline.getCityCode());
        String areaName = areaMap.get(companyshopoffline.getAreaCode() == null ? "" : companyshopoffline.getAreaCode());
        String streetName = areaMap.get(companyshopoffline.getStreetCode() == null ? "" : companyshopoffline.getStreetCode());
        companyshopoffline.setLongAreaName(provinceName + cityName + areaName + streetName);
    ...
    public PageInfo<Companyshopoffline> query(CompanyshopofflineQuery query) {
        ...
        lists.forEach(result -> {
            ...
            String provinceName = areaMap.get(result.getProvinceCode() == null ? "" : result.getProvinceCode());
            String cityName = areaMap.get(result.getCityCode() == null ? "" : result.getCityCode());
            String areaName = areaMap.get(result.getAreaCode() == null ? "" : result.getAreaCode());
            String streetName = areaMap.get(result.getStreetCode() == null ? "" : result.getStreetCode());
            result.setLongAreaName(provinceName + cityName + areaName + streetName);
        });
