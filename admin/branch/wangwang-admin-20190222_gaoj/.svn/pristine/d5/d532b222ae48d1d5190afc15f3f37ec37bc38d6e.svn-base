    ...
    private boolean deletedDashboardConfig(List<Integer> spuIds, String appId) {
        if (StringUtils.isNotBlank(appId)) {
            ...
            if (StringUtils.isNotBlank(dashboardConfig)) {
                ...
                baseGoodsSKUMapper.updateDashBoardConfigByAppId(appId, gson.toJson(mapConfig));
                return true;
            }
        }
        return false;
    ...
    private boolean updateDashboardConfig(GoodsSPUAdd goodsSPUAdd){
        if (StringUtils.isNotBlank(goodsSPUAdd.getAppId())) {
            ...
            if (StringUtils.isNotBlank(dashboardConfig)) {
                ...
                this.updateGoodsConfig(mapConfig.get("baokuan"), goodsSPUAdd.getSpuId(), pic.getPicPath(), name);
                this.updateGoodsConfig(mapConfig.get("newkuan"), goodsSPUAdd.getSpuId(), pic.getPicPath(), name);
