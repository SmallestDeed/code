...
public class HttpUtils {
    ...
    public String doGet(String url, List<? extends Header> headers) throws Exception {
        ...
        // 发起请求
        log.info("rest调用远程接口, url:{},header:{}",httpGet.getURI(),httpGet.getAllHeaders());
    ...
    public  HttpResult doPost(String url, Map<String, String> map, List<? extends Header> headers) throws Exception {
        // 声明httpPost请求
    ...
    public HttpResult doPost(String url, Map<String, String> map) throws Exception {
        return doPost(url, map, Collections.emptyList());
    }
