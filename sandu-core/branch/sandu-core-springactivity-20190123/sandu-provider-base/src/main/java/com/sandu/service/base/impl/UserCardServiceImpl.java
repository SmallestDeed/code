...
public class UserCardServiceImpl implements UserCardService {
    ...
    public UserCardVo getUserCardByUserId(Integer userId) throws BizException {
        if (null == userId || 0 >= userId) {
            ...
            throw new BizException(CLASS_LOG_PREFIX + "获取电子名片，登录用户为空");
        }
    ...
    public boolean checkUserHaveUserCard(LoginUser loginUser) throws BizException {
        ...
        log.info(CLASS_LOG_PREFIX + "校验用户是否有电子名片权限，loginUser={}", loginUser);
        ...
        } else if (MANUFACTURER_DEALER_USER_TYPE.equals(userType)) {
