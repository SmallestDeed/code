package com.sandu.api.designplan.common.objectconvert;


import com.sandu.api.base.common.ResponseEnvelope;
import com.sandu.api.designplan.output.DesignPlanRecommendedResult;
        ...
        if (null != recommendedResult) {
            ...
            if (null != datalist) {
                ...
                for (DesignPlanRecommendedResult designPlanRecommendedResult : datalist) {
                    ...
                    designPlanRecommendedVo.setPlanRecommendedId(designPlanRecommendedResult.getPlanRecommendedId());
