...
public interface DesignPlanRenderSceneMapper {
    ...
    List<SingleDesignPlanVo> selectDesignPlanListByMsgId(@Param("msgHistoryMessageId") String msgHistoryMessageId, @Param("userId") Integer userId);

    String getHouseName(int houseId);
}