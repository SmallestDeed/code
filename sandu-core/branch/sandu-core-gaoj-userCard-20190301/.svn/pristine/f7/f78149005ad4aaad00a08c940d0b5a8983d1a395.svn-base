package com.sandu.api.base.common.exception;
...
public class ExceptionCodes {
    ...
    public static final int CODE_10010021 = 10010021; //未找到该经销商对应企业
    ...
    public static final int CODE_10010039 = 10010039; //查询小程序首次登录赠送积分失败,字典表中不存在记录
