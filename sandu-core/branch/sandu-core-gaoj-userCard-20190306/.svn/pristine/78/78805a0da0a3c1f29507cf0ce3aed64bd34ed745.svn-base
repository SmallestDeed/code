...
public interface UserCardService {
     ...
     * 改为：    B端所有角色都可以 update by gaoj 20190218
    ...
    int addUserCardTransmitRecord(UserCardTransmitRecordAdd userCardTransmitRecordAdd);

    List<UserCardStatisticsVo> getAllUserCardOfCompany(UserCardStatisticsQuery userCardStatisticsQuery, SysUser sysUser);

    Integer getAllUserCardCount(UserCardStatisticsQuery userCardStatisticsQuery, SysUser sysUser);
}
