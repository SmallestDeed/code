...
public interface FullHouseDesignPlanMapper {
    ...
    SinglePlanRenderSceneVo selectDesignPlanRenderScene(int planId);

    Integer checkHistoryCopyHouseExits(@Param("historyMsgId")String historyMsgId, @Param("userId")Integer userId);
