...
public class WxUserCardServiceImpl implements WxUserCardService {
    ...
    @Override
    public WxUserCard selectByPrimaryKey(Long id) {
        return wxUserCardMapper.selectByPrimaryKey(id);
    }

    @Override
    public Integer updateByPrimaryKeySelective(WxUserCard record) {
        return wxUserCardMapper.updateByPrimaryKeySelective(record);
    }

    @Override
    public List<WxUserCard> getTodayCardList(Long activityId) {
        return wxUserCardMapper.getTodayCardList(activityId);
    }
}
