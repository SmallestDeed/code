...
public class DesignPlanRenderSceneServiceImpl implements DesignPlanRenderSceneService {
    ...
    @Override
    public List<SingleDesignPlanVo> getDesignPlanListByMsgId(String msgHistoryMessageId, Integer userId) {
        List<SingleDesignPlanVo> singleDesignPlanVoList = designPlanRenderSceneMapper.selectDesignPlanListByMsgId(msgHistoryMessageId, userId);
    ...
    public String getHouseName(int houseId) {
        return designPlanRenderSceneMapper.getHouseName(houseId);
    }
}
