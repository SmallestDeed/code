...
public interface RedisService {
     ...
     * @return
     */
    long mapIncrby(String mapName, String key, Long incrbyNumber);

    boolean lock(String key, String value, long ms);

    boolean lock(String key, String value, int s);

    boolean eval(String script, List<String> list, List<String> list1);

    boolean setBit(String key, long offset, boolean value);

    boolean getBit(String key, long offset);

    boolean bloom(String name, String value);

    boolean bloomWithoutPut(String name, String value);
}
