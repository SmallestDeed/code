...
public class InteractiveZoneReplyController {
    ...
    private final String CLASS_LOG_PREFIX = "【互动区回复控制层】";
    ...
    @NeedNotLogin
    @GetMapping("/list")
    public ResponseEnvelope list(InteractiveZoneReplyQuery query) {
        PageInfo<InteractiveZoneReplyVO> list = interactiveZoneReplyService.query(query);
