...
//    public static final String SESSION_USER_OBJECT_SET = UserSO.USER_OBJECT_SESSION_CONTANT;
    ...
    public static final String SIGN_IN_ACTIVITY_LIST = "signInActivityList";


    /******************************* 布隆过滤器 ******************************/
    // 前缀
    public static final String REDIS_BLOOM_FILTER_PREFIX = "bloom:";
    public static final String REDIS_BLOOM_FILTER_DEFAULT = "DEFAULT_BLOOM_FILTER";
    public static final String REDIS_BLOOM_FILTER_DECORATION_TIPS = "DECORATION_TIPS_BLOOM_FILTER";
}
