...
/**
 * @ClassName: InteractiveZoneTopicAdd
 * @Auther: gaoj
 ...
 */
@Data
public class InteractiveZoneTopicAdd implements Serializable {
    ...
    @ApiModelProperty("主题类型key：问答-askAndAnswer，话题-topic，大咖分享-share，设计改造-designReform")
