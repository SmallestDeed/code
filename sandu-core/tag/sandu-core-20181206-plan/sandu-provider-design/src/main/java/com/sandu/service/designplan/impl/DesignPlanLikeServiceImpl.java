...
import com.sandu.service.designplan.dao.DesignPlanLikeDao;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import static com.sandu.api.base.common.cache.RedisKeyConstans.*;
...
public class DesignPlanLikeServiceImpl implements DesignPlanLikeService {
    ...
    @Autowired
    private DesignPlanLikeDao designPlanLikeDao;
    @Autowired
    ...
    public int add(DesignPlanLike designPlanLike) {
        designPlanLikeDao.insertSelective(designPlanLike);
    ...
    public int update(DesignPlanLike designPlanLike) {
        return designPlanLikeDao.updateByPrimaryKeySelective(designPlanLike);
    }
    ...
    public int delete(Integer id) {
        return designPlanLikeDao.deleteByPrimaryKey(id);
    }
    ...
    public DesignPlanLike get(Integer id) {
        return designPlanLikeDao.selectByPrimaryKey(id);
    }
    ...
    public List<DesignPlanLike> getList(DesignPlanLike designPlanLike) {
        return designPlanLikeDao.selectList(designPlanLike);
    }

    @Override
    public int deleteById(DesignPlanLike designPlanLike) {
        return designPlanLikeDao.deleteById(designPlanLike);
    }
...
//            //查询用户点赞状态
//            DesignPlanLike designPlanLikeTemp = designPlanLikeDao.selectByDesignIdAndUserId(userId, designId);
...
//    }
    ...
    public int saveOrUpdate(DesignPlanLike designPlanLike) {
        ...
        return designPlanLikeDao.saveOrUpdate(designPlanLike);
    }
    ...
    public int getStatus(Integer userId, Integer designId) {
        ...
        Integer likeStatus = designPlanLikeDao.getStatus(userId, designId);
        if (null == likeStatus) {
            return 0;
        }
        return likeStatus;
