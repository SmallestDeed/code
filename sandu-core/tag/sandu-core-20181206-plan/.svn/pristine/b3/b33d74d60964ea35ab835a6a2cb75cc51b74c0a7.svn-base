...
public class FullHouseDesignPlanDetailServiceImpl implements FullHouseDesignPlanDetailService {
     ...
     */
    @Override
    public List<FullHouseDesignPlanDetail> selectListByFullHouseDesignPlanId(Integer fullHouseId) {
        return fullHouseDesignPlanDetailMapper.selectListByFullHouseDesignPlanId(fullHouseId);
    }
}
