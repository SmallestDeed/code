...
public interface WxFilmTicketService {
    WxFilmTicket getEmptyTicket(Long activityId);

    List<WxFilmTicket> getNotEmptyTicketList(Long activityId, Integer start, Integer limit);
