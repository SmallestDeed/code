...
public class WxRedPacketSummaryServiceImpl implements WxRedPacketSummaryService {
    ...
    @Override
    public int updateByRedPacketRemainNum(WxRedPacketSummary wxRedPacketSummary) {
        return wxRedPacketSummaryMapper.updateByRedPacketRemainNum(wxRedPacketSummary);
    }
}
