...
public class ProductCategoryRel extends Mapper implements Serializable {
	...
	public String toString() {
		return "ProductCategoryRel [id=" + id + ", sysCode=" + sysCode + ", creator=" + creator + ", gmtCreate="
				+ gmtCreate + ", modifier=" + modifier + ", gmtModified=" + gmtModified + ", isDeleted=" + isDeleted
				+ ", productId=" + productId + ", categoryId=" + categoryId + ", att1=" + att1 + ", att2=" + att2
				+ ", att3=" + att3 + ", att4=" + att4 + ", att5=" + att5 + ", att6=" + att6 + ", dateAtt1=" + dateAtt1
				+ ", dateAtt2=" + dateAtt2 + ", numAtt1=" + numAtt1 + ", numAtt2=" + numAtt2 + ", numAtt3=" + numAtt3
				+ ", numAtt4=" + numAtt4 + ", remark=" + remark + ", categoryCode=" + categoryCode + ", productName="
				+ productName + ", productCode=" + productCode + ", houseTypeValues=" + houseTypeValues
				+ ", categoryIdList=" + categoryIdList + ", userId=" + userId + ", designTempletId=" + designTempletId
				+ ", designProductId=" + designProductId + ", brandIds=" + brandIds + ", brandId=" + brandId
				+ ", onlyShowRecommend=" + onlyShowRecommend + ", exceptRecommend=" + exceptRecommend
				+ ", spaceCommonId=" + spaceCommonId + ", templateProductId=" + templateProductId
				+ ", productTypeValue=" + productTypeValue + ", productSmallTypeValue=" + productSmallTypeValue
				+ ", configBrandIdList=" + configBrandIdList + ", configTypeValueList=" + configTypeValueList
				+ ", configSmallTypeIdList=" + configSmallTypeIdList + ", configProductIdList=" + configProductIdList
				+ ", terminalImei=" + terminalImei + ", specialProductType=" + specialProductType
				+ ", productSmallTypeKey=" + productSmallTypeKey + ", productLength=" + productLength
				+ ", productWidth=" + productWidth + ", productHeight=" + productHeight + ", blacklistSet="
				+ blacklistSet + ", productModelNumber=" + productModelNumber + ", showBgWall=" + showBgWall
				+ ", startLength=" + startLength + ", endLength=" + endLength + ", bgWallHeight=" + bgWallHeight
				+ ", attributeConditionList=" + attributeConditionList + ", attributeConditionSize="
				+ attributeConditionSize + ", isValue=" + isValue + ", isFilterOrder=" + isFilterOrder
				+ ", propsOrderList=" + propsOrderList + ", houseTypeList=" + houseTypeList + ", baseProduct="
				+ baseProduct + ", firstStageCode=" + firstStageCode + ", secondStageCode=" + secondStageCode
				+ ", thirdStageCode=" + thirdStageCode + ", fourthStageCode=" + fourthStageCode + ", fifthStageCode="
				+ fifthStageCode + ", isStretch=" + isStretch + ", isBeijing=" + isBeijing + ", smallTypeList="
				+ smallTypeList + ", smallTypeValueList=" + smallTypeValueList + ", sortSmallTypeValueList="
				+ sortSmallTypeValueList + ", companyId=" + companyId + ", templetId=" + templetId + ", isInternalUser="
				+ isInternalUser + "]";
	}
