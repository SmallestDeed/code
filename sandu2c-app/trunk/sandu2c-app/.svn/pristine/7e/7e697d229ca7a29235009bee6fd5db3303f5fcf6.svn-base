...
public class PreciseCompute {
	...
	*/  
	...
	public static void main(String[] args) {
		Integer a = 1;
		Integer b = 29;
		//////System.out.println(PreciseCompute.div(a,b,4));
		Integer spaceNum = 10;
		Integer totalSpaceNum = 157;
		double i = PreciseCompute.div(spaceNum,totalSpaceNum,4);
		
		BigDecimal c = new   BigDecimal(i*100);
		double   f1   =   c.setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();  
		//////System.out.println(f1+"%");
		DecimalFormat   df   =new   DecimalFormat("#.00");
		String str = df.format(i*100) +"%";
