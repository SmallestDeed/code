...
/**
 * @version V1.0
 * @Title: StructureProductDetailsSearch.java
 * @Package com.sandu.product.model
 * @Description:产品模块-结构明细表查询对象
 * @createAuthor pandajun
 * @CreateDate 2016-12-02 15:42:46
 */
public class StructureProductDetailsSearch extends StructureProductDetails implements Serializable {
    ...
    public String toString() {
        return "StructureProductDetailsSearch{" +
