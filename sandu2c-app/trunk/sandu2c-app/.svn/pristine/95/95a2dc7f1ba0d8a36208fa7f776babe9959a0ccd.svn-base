...
public class CORSFilter implements Filter {
    ...
    public static final String DEFAULT_ACCESS_CONTROL_ALLOW_METHDOS_VALUE = "POST, GET, OPTIONS,PUT, DELETE";
    ...
    public static final String DEFAULT_ACCESS_CONTROL_ALLOW_HEADERS_VALUE = "Origin, X-Requested-With, Content-Type, Accept";//"x-requested-with";
