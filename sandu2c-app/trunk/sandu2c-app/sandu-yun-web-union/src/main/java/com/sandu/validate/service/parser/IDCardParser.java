...
import com.sandu.annotation.IDCard;
 ...
 *
 */
public class IDCardParser implements IAnnotationParser {

    @Override
    public ValidateResult validate(Field f, Object value) {
        ValidateResult result = new ValidateResult();
        if(f.isAnnotationPresent(IDCard.class)){
            if(value != null && !value.equals("")){
                if(!RegValidator.isIDCard(value.toString())){
