...
//        }
        ...
        ResponseEnvelope designPlanRecommendedResultObj = designPlanRecommendedService.getPlanRecommendedList2(planRecommendedListModel,companyCode,baseCompany);
    ...
    public ResponseEnvelope recommendedPlanOfProductRelated(@RequestParam Integer productId, HttpServletRequest request) {
        ...
        List<RecommendedPlanProductRelatedVo> recommendedPlanProductRelatedList = designPlanRecommendedProductService.queryRecommendedPlanOfProductRelatedByProductId2(productId, platformId, UserObject.parseUserSoToLoginUser(userSo),companyCode,baseCompany);
