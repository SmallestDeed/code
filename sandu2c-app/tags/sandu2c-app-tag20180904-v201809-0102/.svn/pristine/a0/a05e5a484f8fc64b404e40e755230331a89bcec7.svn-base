...
public interface DesignPlanRecommendFavoriteService {
     ...
     * @return
     */
    long setFavoriteOrUnfavorite(LoginUser loginUser, DesignPlanRecommendFavoriteRef favoriteRef);
     ...
     * @return
     */
    long setFullHosueFavoriteOrUnfavorite(LoginUser loginUser, DesignPlanRecommendFavoriteRef favoriteRef);
}
