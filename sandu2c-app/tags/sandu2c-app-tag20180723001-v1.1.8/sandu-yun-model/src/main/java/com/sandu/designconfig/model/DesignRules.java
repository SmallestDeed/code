package com.sandu.designconfig.model;
 ...
 */
public class DesignRules extends Mapper implements Serializable {
    ...
    public String getRulesBusiness() {
        return rulesBusiness;
    }

    public void setRulesBusiness(String rulesBusiness) {
        this.rulesBusiness = rulesBusiness;
    }

    public String getRulesSign() {
        return rulesSign;
    }

    public void setRulesSign(String rulesSign) {
        this.rulesSign = rulesSign;
    }
    ...
    public String getRulesMainObj() {
        return rulesMainObj;
    }

    public void setRulesMainObj(String rulesMainObj) {
        this.rulesMainObj = rulesMainObj;
    }

    public String getRulesMainValue() {
        return rulesMainValue;
    }

    public void setRulesMainValue(String rulesMainValue) {
        this.rulesMainValue = rulesMainValue;
    }

    public String getRulesSecondaryObjs() {
        return rulesSecondaryObjs;
    }

    public void setRulesSecondaryObjs(String rulesSecondaryObjs) {
        this.rulesSecondaryObjs = rulesSecondaryObjs;
    }

    public String getRulesSecondaryValues() {
        return rulesSecondaryValues;
    }

    public void setRulesSecondaryValues(String rulesSecondaryValues) {
        this.rulesSecondaryValues = rulesSecondaryValues;
    }
    ...
    public void setRulesPriority(String rulesPriority) {
        this.rulesPriority = rulesPriority;
    }

    public String getRulesOrdering() {
        return rulesOrdering;
    }

    public void setRulesOrdering(String rulesOrdering) {
        this.rulesOrdering = rulesOrdering;
    }
    ...
    public String toString() {
        return "DesignRules{" +
                ...
                ", rulesMainObj='" + rulesMainObj + '\'' +
                ", rulesMainValue='" + rulesMainValue + '\'' +
                ", rulesSecondaryObjs='" + rulesSecondaryObjs + '\'' +
                ", rulesSecondaryValues='" + rulesSecondaryValues + '\'' +
                ", rulesPriority='" + rulesPriority + '\'' +
                ", rulesOrdering='" + rulesOrdering + '\'' +
                ", ext1='" + ext1 + '\'' +
                ", ext2='" + ext2 + '\'' +
                ", ext3='" + ext3 + '\'' +
                ", ext4='" + ext4 + '\'' +
                ...
                ", rulesSignName='" + rulesSignName + '\'' +
                ", rulesLevelName='" + rulesLevelName + '\'' +
                ", extName='" + extName + '\'' +
                ", rulesModelName='" + rulesModelName + '\'' +
                '}';
    }
}
