...
/**
 * @version V1.0
 * @Title: ResTextureSearch.java
 * @Package com.sandu.system.model
 * @Description:系统模块-材质库查询对象
 * @createAuthor pandajun
 * @CreateDate 2016-06-30 14:10:42
 */
public class ResTextureSearch extends ResTexture implements Serializable {
     ...
     * 材质(材料)-模糊查询
     **/
    private String sch_Texture_;
    /**
     * 材质(材料)-左模糊查询
     **/
    private String sch_Texture;
    /**
     * 材质(材料)-右模糊查询
     **/
    private String schTexture_;
    /**
     * 材质(材料)-区间查询-开始字符串
     **/
    private String textureStart;
    /**
     * 材质(材料)-区间查询-结束字符串
     **/
    ...
    public String getSch_Type_() {
        return sch_Type_;
    }

    public void setSch_Type_(String sch_Type_) {
        this.sch_Type_ = sch_Type_;
    }
    ...
    public String getSchType_() {
        return schType_;
    }

    public void setSchType_(String schType_) {
        this.schType_ = schType_;
    }
    ...
    public String getSch_Style_() {
        return sch_Style_;
    }

    public void setSch_Style_(String sch_Style_) {
        this.sch_Style_ = sch_Style_;
    }
    ...
    public String getSchStyle_() {
        return schStyle_;
    }

    public void setSchStyle_(String schStyle_) {
        this.schStyle_ = schStyle_;
    }
    ...
    public void setStyleStart(String styleStart) {
    ...
    public String getSch_Texture_() {
        return sch_Texture_;
    }

    public void setSch_Texture_(String sch_Texture_) {
        this.sch_Texture_ = sch_Texture_;
    }

    public String getSch_Texture() {
        return sch_Texture;
    }

    public void setSch_Texture(String sch_Texture) {
        this.sch_Texture = sch_Texture;
    }

    public String getSchTexture_() {
        return schTexture_;
    }

    public void setSchTexture_(String schTexture_) {
        this.schTexture_ = schTexture_;
    }
    ...
    public void setTextureStart(String textureStart) {
    ...
    public void setTextureEnd(String textureEnd) {
