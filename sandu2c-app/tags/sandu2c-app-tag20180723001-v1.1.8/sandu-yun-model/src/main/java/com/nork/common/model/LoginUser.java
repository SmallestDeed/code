...
public class LoginUser  extends Mapper implements Serializable{
    ...
    private String servitizationUrls;

    public String getServitizationUrls() {
        return servitizationUrls;
    }

    public void setServitizationUrls(String servitizationUrls) {
        this.servitizationUrls = servitizationUrls;
    }
