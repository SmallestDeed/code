...
import com.sandu.supplydemand.model.SupplyDemandCategoryExample;
...
public interface SupplyDemandCategoryMapper {
    ...
    List<SupplyDemandCategory> selectListBycategoryIdList(List<Integer> categoryIdList);

    List<SupplyDemandCategoryVo> selectAllCategory(SupplyDemandCategory supplyDemandCategory);
