 ...
 */
@Controller
@RequestMapping("/v1/tocmobile/home/spacecommon")
public class SpaceCommonController {
    ...
    public ResponseEnvelope houseSpaceList(@ModelAttribute SpaceCommonSearchVo spaceCommonSearchVo,
        ...
        try {
            ...
            // 2c移动端这边加一个参数过滤  --> end
            spaceCommonTemporary.setHouseId(spaceCommonSearchVo.getHouseId());
            ...
            /* 设置分页查询条件 */
            spaceCommonTemporary.setStart(pageModel.getStart());
            spaceCommonTemporary.setLimit(pageModel.getLimit());
			/* 设置分页查询条件->end */
            if (total > 0) {
...
//					}
    ...
    public ResponseEnvelope spaceSearch(@ModelAttribute SpaceCommonSearchVo spaceCommonSearchVo, PageModel pageModel,
        ...
        try {
            ...
            spaceCommon.setLimit(pageModel.getLimit());
