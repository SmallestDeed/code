 ...
 */
@Controller
@RequestMapping("/v1/tocmobile/sysUserMessage")
public class UserMessageController {
    ...
    private final static String MOBILE_WEBSITE_PLATFORM_CODE = "mobile2c";
    ...
    public Object getList(@ModelAttribute SysUserMessage sysUserMessage, HttpServletRequest request) {
        ...
        //从缓存中获取当前平台
        String basePlatformInfo = redisService.getMap(BASE_PLATFORM_INFO, MOBILE_WEBSITE_PLATFORM_CODE);
        if (StringUtils.isNotBlank(basePlatformInfo)) {
            BasePlatform basePlatform = gson.fromJson(basePlatformInfo,
                    BasePlatform.class);
            sysUserMessage.setPlatformBussinessType(basePlatform.getPlatformBussinessType());
        }
