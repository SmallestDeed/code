...
public class AuthorizedConfig extends Mapper implements Serializable {
    ...
    public String toString() {
        return "AuthorizedConfig{" +
                ...
                ", numa2=" + numa2 +
                ", remark='" + remark + '\'' +
                ", payMethodValue=" + payMethodValue +
                ", payModelValue=" + payModelValue +
                ", payStatusValue=" + payStatusValue +
                ", unitPrice=" + unitPrice +
                ", salerId=" + salerId +
                ", validTime=" + validTime +
                ", validState=" + validState +
                ", authorizedCodeType=" + authorizedCodeType +
                ", isOpen=" + isOpen +
                ", validTimeTranscoding='" + validTimeTranscoding + '\'' +
                ", orderNo='" + orderNo + '\'' +
                ", activityId=" + activityId +
                ", validDay=" + validDay +
                ", validStrategyRadio=" + validStrategyRadio +
                ...
                ", bigTypeNames='" + bigTypeNames + '\'' +
                ", smallTypeNames='" + smallTypeNames + '\'' +
