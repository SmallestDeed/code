...
import com.sandu.product.model.ProductGroupReplaceTaskDetail;
...
public class ResRenderPic extends Mapper implements Serializable {
    ...
    public void setProductGroupReplaceList(
        List<ProductGroupReplaceTaskDetail> productGroupReplaceList) {
