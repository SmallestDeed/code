...
public class PinYin4jUtils {
    ...
    public static String getPinYinHeadChar(String str,boolean b) {
        String s = Character.toString(str.charAt(0));
        String le = hanziToPinyin(s);
        if(b){
            return Character.toString(le.charAt(0));
        }else {
            return Character.toString(le.charAt(0)).toUpperCase();
        }
    ...
    public static void main(String[] args) {
        // pin4j 简码 和 城市编码
        String s1 = "中华人民共和国";
        System.out.println(getPinYinHeadChar(s1,false));
    }
}
