...
/**
 * @version V1.0
 * @Title: ProductCategoryRelSearch.java
 * @Package com.sandu.product.model
 * @Description:产品模块-产品与产品类目关联查询对象
 * @createAuthor pandajun
 * @CreateDate 2015-06-17 14:50:47
 */
public class ProductCategoryRelSearch extends ProductCategoryRel implements Serializable {
