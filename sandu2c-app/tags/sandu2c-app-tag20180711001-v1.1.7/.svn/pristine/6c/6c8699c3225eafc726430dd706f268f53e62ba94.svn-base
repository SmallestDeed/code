package com.sandu.productprops.model.search;
...
/**
 * @version V1.0
 * @Title: ProductPropsSearch.java
 * @Package com.sandu.productprops.model
 * @Description:产品属性-产品属性表查询对象
 * @createAuthor pandajun
 * @CreateDate 2015-09-01 10:40:03
 */
public class ProductPropsSearch extends ProductProps implements Serializable {
     ...
     * 属性值-模糊查询
     **/
    private String sch_PropValue_;
    /**
     * 属性值-左模糊查询
     **/
    private String sch_PropValue;
    /**
     * 属性值-右模糊查询
     **/
    private String schPropValue_;
    /**
     * 属性值-区间查询-开始字符串
     **/
    private String propValueStart;
    /**
     * 属性值-区间查询-结束字符串
     **/
    private String propValueEnd;
    /**
     * 系统编码-模糊查询
     **/
    ...
    public String getSch_PropValue_() {
        return sch_PropValue_;
    }

    public void setSch_PropValue_(String sch_PropValue_) {
        this.sch_PropValue_ = sch_PropValue_;
    }

    public String getSch_PropValue() {
        return sch_PropValue;
    }

    public void setSch_PropValue(String sch_PropValue) {
        this.sch_PropValue = sch_PropValue;
    }

    public String getSchPropValue_() {
        return schPropValue_;
    }

    public void setSchPropValue_(String schPropValue_) {
        this.schPropValue_ = schPropValue_;
    }

    public String getPropValueStart() {
        return propValueStart;
    }

    public void setPropValueStart(String propValueStart) {
        this.propValueStart = propValueStart;
    }

    public String getPropValueEnd() {
        return propValueEnd;
    }

    public void setPropValueEnd(String propValueEnd) {
        this.propValueEnd = propValueEnd;
    }
