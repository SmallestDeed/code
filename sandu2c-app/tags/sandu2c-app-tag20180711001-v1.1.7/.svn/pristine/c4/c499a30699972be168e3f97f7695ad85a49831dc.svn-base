 ...
 */
@Controller
@RequestMapping("/v1/miniprogram/design/designtemplet")
public class DesignTempletController {
	...
	@Autowired
	private ResourceCacherService resourceCacherService;

	@Autowired
    private SpaceCommonCacheService spaceCommonCacherService;
        ...
        try {
           ...
           designTempletSearch.setPutawayState(DesignTempletPutawayState.IS_RELEASE.intValue());
            ...
            if (null != pageModel && 0 != pageModel.getPageSize()) {
            	...
            	designTempletSearch.setLimit(pageModel.getPageSize());
	            } else {
	            	designTempletSearch.setLimit(PageModel.DEFAULT_PAGE_PAGESIZE);
	            }
