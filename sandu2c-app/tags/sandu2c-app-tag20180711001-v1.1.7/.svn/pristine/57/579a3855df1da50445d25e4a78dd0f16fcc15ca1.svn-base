 ...
 */
public class SysUserRole extends Mapper implements Serializable {
    private static final long serialVersionUID = 1L;
    private Integer id;
    
    private String baseRoleGroup;
	...
	public String getBaseRoleGroup() {
		return baseRoleGroup;
	}

	public void setBaseRoleGroup(String baseRoleGroup) {
		this.baseRoleGroup = baseRoleGroup;
	}
