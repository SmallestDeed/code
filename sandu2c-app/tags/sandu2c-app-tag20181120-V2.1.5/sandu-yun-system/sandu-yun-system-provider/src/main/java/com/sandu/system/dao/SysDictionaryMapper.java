...
public interface SysDictionaryMapper {
    ...
    List<SysDictionaryBo> getTypeValueByValueKeys(@Param("valueKeys") List<String> valueKeys);

    List<SysDictionary> getByTypeAndValue(@Param("type") String type, @Param("value") Integer value);

    List<SysDictionary> getAllByTypes(@Param("types") List<String> types);

	Integer getSpaceAreaValue(@Param("spaceFunctionId") Integer spaceFunctionId, @Param("spaceArea") String spaceArea);
