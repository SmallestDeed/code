                ...
                switch (planType) {
                    case 1:
                        ...
                        if(null != singleSpaceCoverResRenderPic){
                            ...
                            supplyDemandPic.setPicPath(singleSpaceCoverResRenderPic.getPicPath());
                    ...
                    case 4:
                        ...
                        if(null != fullHouseCoverResRenderPic){
                            SupplyDemandPic supplyDemandPic = new SupplyDemandPic();
                            supplyDemandPic.setPicPath(fullHouseCoverResRenderPic.getPicPath());
                            baseSupplyDemand.setSupplyDemandCoverPic(supplyDemandPic);
                        }
                        break;
                    ...
                    case 3:
                        ...
                        if(null != myPlanCoverResRenderPic){
                            SupplyDemandPic supplyDemandPic = new SupplyDemandPic();
                            supplyDemandPic.setPicPath(myPlanCoverResRenderPic.getPicPath());
                            baseSupplyDemand.setSupplyDemandCoverPic(supplyDemandPic);
                        }
                        break;
