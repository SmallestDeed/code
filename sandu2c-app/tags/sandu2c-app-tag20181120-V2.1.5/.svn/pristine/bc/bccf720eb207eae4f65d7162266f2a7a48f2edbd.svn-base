...
/**
 * @version V1.0
 * @Title: BaseCompanySearch.java
 * @Package com.sandu.product.model
 * @Description:产品模块-企业表查询对象
 * @createAuthor pandajun
 * @CreateDate 2015-06-15 17:01:45
 */
public class BaseCompanySearch extends BaseCompany implements Serializable {
     ...
     * 企业编码-模糊查询
     **/
    private String sch_CompanyCode_;
    /**
     * 企业编码-左模糊查询
     **/
    private String sch_CompanyCode;
    /**
     * 企业编码-右模糊查询
     **/
    private String schCompanyCode_;
    /**
     * 企业编码-区间查询-开始字符串
     **/
     ...
     * 企业名称-模糊查询
     **/
    private String sch_CompanyName_;
    /**
     * 企业名称-左模糊查询
     **/
    private String sch_CompanyName;
    /**
     * 企业名称-右模糊查询
     **/
    private String schCompanyName_;
    /**
     * 企业名称-区间查询-开始字符串
     **/
     ...
     * 企业网站-模糊查询
     **/
    private String sch_CompanyUrl_;
    /**
     * 企业网站-左模糊查询
     **/
    private String sch_CompanyUrl;
    /**
     * 企业网站-右模糊查询
     **/
    private String schCompanyUrl_;
    /**
     * 企业网站-区间查询-开始字符串
     **/
    private String companyUrlStart;
    /**
     * 企业网站-区间查询-结束字符串
     **/
    private String companyUrlEnd;
    /**
     * 企业介绍-模糊查询
     **/
    private String sch_CompanyDesc_;
    /**
     * 企业介绍-左模糊查询
     **/
    private String sch_CompanyDesc;
    /**
     * 企业介绍-右模糊查询
     **/
    private String schCompanyDesc_;
    /**
     * 企业介绍-区间查询-开始字符串
     **/
    private String companyDescStart;
    /**
     * 企业介绍-区间查询-结束字符串
     **/
    private String companyDescEnd;
    /**
     * 企业地址-模糊查询
     **/
    private String sch_CompanyAddress_;
    /**
     * 企业地址-左模糊查询
     **/
    private String sch_CompanyAddress;
    /**
     * 企业地址-右模糊查询
     **/
    private String schCompanyAddress_;
    /**
     * 企业地址-区间查询-开始字符串
     **/
    private String companyAddressStart;
    /**
     * 企业地址-区间查询-结束字符串
     **/
    private String companyAddressEnd;
    /**
     * 字符备用1-模糊查询
     **/
    ...
    public String getSch_CompanyCode_() {
        return sch_CompanyCode_;
    }

    public void setSch_CompanyCode_(String sch_CompanyCode_) {
        this.sch_CompanyCode_ = sch_CompanyCode_;
    }

    public String getSch_CompanyCode() {
        return sch_CompanyCode;
    }

    public void setSch_CompanyCode(String sch_CompanyCode) {
        this.sch_CompanyCode = sch_CompanyCode;
    }

    public String getSchCompanyCode_() {
        return schCompanyCode_;
    }

    public void setSchCompanyCode_(String schCompanyCode_) {
        this.schCompanyCode_ = schCompanyCode_;
    }

    public String getCompanyCodeStart() {
        return companyCodeStart;
    }

    public void setCompanyCodeStart(String companyCodeStart) {
        this.companyCodeStart = companyCodeStart;
    }
    ...
    public void setCompanyCodeEnd(String companyCodeEnd) {
        this.companyCodeEnd = companyCodeEnd;
    }

    public String getSch_CompanyName_() {
        return sch_CompanyName_;
    }

    public void setSch_CompanyName_(String sch_CompanyName_) {
        this.sch_CompanyName_ = sch_CompanyName_;
    }

    public String getSch_CompanyName() {
        return sch_CompanyName;
    }

    public void setSch_CompanyName(String sch_CompanyName) {
        this.sch_CompanyName = sch_CompanyName;
    }

    public String getSchCompanyName_() {
        return schCompanyName_;
    }

    public void setSchCompanyName_(String schCompanyName_) {
        this.schCompanyName_ = schCompanyName_;
    }

    public String getCompanyNameStart() {
        return companyNameStart;
    }

    public void setCompanyNameStart(String companyNameStart) {
        this.companyNameStart = companyNameStart;
    }

    public String getCompanyNameEnd() {
        return companyNameEnd;
    }

    public void setCompanyNameEnd(String companyNameEnd) {
        this.companyNameEnd = companyNameEnd;
    }

    public String getSch_CompanyUrl_() {
        return sch_CompanyUrl_;
    }

    public void setSch_CompanyUrl_(String sch_CompanyUrl_) {
        this.sch_CompanyUrl_ = sch_CompanyUrl_;
    }

    public String getSch_CompanyUrl() {
        return sch_CompanyUrl;
    }

    public void setSch_CompanyUrl(String sch_CompanyUrl) {
        this.sch_CompanyUrl = sch_CompanyUrl;
    }

    public String getSchCompanyUrl_() {
        return schCompanyUrl_;
    }

    public void setSchCompanyUrl_(String schCompanyUrl_) {
        this.schCompanyUrl_ = schCompanyUrl_;
    }

    public String getCompanyUrlStart() {
        return companyUrlStart;
    }

    public void setCompanyUrlStart(String companyUrlStart) {
        this.companyUrlStart = companyUrlStart;
    }

    public String getCompanyUrlEnd() {
        return companyUrlEnd;
    }

    public void setCompanyUrlEnd(String companyUrlEnd) {
        this.companyUrlEnd = companyUrlEnd;
    }

    public String getSch_CompanyDesc_() {
        return sch_CompanyDesc_;
    }

    public void setSch_CompanyDesc_(String sch_CompanyDesc_) {
        this.sch_CompanyDesc_ = sch_CompanyDesc_;
    }

    public String getSch_CompanyDesc() {
        return sch_CompanyDesc;
    }

    public void setSch_CompanyDesc(String sch_CompanyDesc) {
        this.sch_CompanyDesc = sch_CompanyDesc;
    }

    public String getSchCompanyDesc_() {
        return schCompanyDesc_;
    }

    public void setSchCompanyDesc_(String schCompanyDesc_) {
        this.schCompanyDesc_ = schCompanyDesc_;
    }

    public String getCompanyDescStart() {
        return companyDescStart;
    }

    public void setCompanyDescStart(String companyDescStart) {
        this.companyDescStart = companyDescStart;
    }

    public String getCompanyDescEnd() {
        return companyDescEnd;
    }

    public void setCompanyDescEnd(String companyDescEnd) {
        this.companyDescEnd = companyDescEnd;
    }

    public String getSch_CompanyAddress_() {
        return sch_CompanyAddress_;
    }

    public void setSch_CompanyAddress_(String sch_CompanyAddress_) {
        this.sch_CompanyAddress_ = sch_CompanyAddress_;
    }

    public String getSch_CompanyAddress() {
        return sch_CompanyAddress;
    }

    public void setSch_CompanyAddress(String sch_CompanyAddress) {
        this.sch_CompanyAddress = sch_CompanyAddress;
    }

    public String getSchCompanyAddress_() {
        return schCompanyAddress_;
    }

    public void setSchCompanyAddress_(String schCompanyAddress_) {
        this.schCompanyAddress_ = schCompanyAddress_;
    }

    public String getCompanyAddressStart() {
        return companyAddressStart;
    }

    public void setCompanyAddressStart(String companyAddressStart) {
        this.companyAddressStart = companyAddressStart;
    }

    public String getCompanyAddressEnd() {
        return companyAddressEnd;
    }

    public void setCompanyAddressEnd(String companyAddressEnd) {
        this.companyAddressEnd = companyAddressEnd;
    }
