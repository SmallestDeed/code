...
public class NodeInfoBizServiceImpl implements NodeInfoBizService {
    ...
    private void incrementDataToDatabase(int userId, int nodeId) throws NoSuchAlgorithmException {
        ...
        for (SysDictionary sysDictionary : sysDictionaryList) {
            ...
            // 更新node_info_detail表
            this.updateNodeInfoDetail(detailType, user, nodeId);
        }
    }
    ...
    private int updateUserNodeInfoRel(Integer detailType, SysUser user, Integer nodeId) throws NoSuchAlgorithmException {
        ...
        if (statusStr != null && !"".equals(statusStr)) {
            ...
            log.info(NODE_INFO_BIZ_LOG_PREFIX + "更新失败，statusStr为空！");
            return 0;
        }
    }
     ...
     * @throws NoSuchAlgorithmException
     */
    private int updateNodeInfoDetail(Integer detailType, SysUser user, Integer nodeId) throws NoSuchAlgorithmException {
        // 从缓存中获取节点详情数据
        String nnKey = detailType + ":" + nodeId;
        ...
        if (valueStr != null && !"".equals(valueStr)) {
            ...
            if (user != null) {
                nodeInfoDetail.setModifier(user.getUserName() == null ? user.getNickName() : user.getUserName());
            ...
            if (successNum <= 0) {
                ...
                nodeInfoDetail.setCreator(nodeInfoDetail.getModifier());
            ...
            log.info(NODE_INFO_BIZ_LOG_PREFIX + "更新失败，valueStr为空！");
            return 0;
        }
    }
