...
public class DesignPlanRecommendedController {
    ...
    public ResponseEnvelope designPlanRecommendedList(@ModelAttribute DesignPlanRecommendedVo designPlanRecommendedVo,
        ...
        planRecommendedListModel.setLimit(pageModel.getLimit());
...
//        }
        ...
        logger.info(CLASS_LOG_PREFIX + "获取方案推荐列表数据,获取列表数据完成->PlanRecommendedListModel:{}, List<DesignPlanRecommendedResult>:{}.", planRecommendedListModel.toString(), GSON.toJson(designPlanRecommendedResultObj));
    ...
    public ResponseEnvelope designPlanRecommendedDetail(@RequestParam String planRecommendedId, HttpServletRequest request) {
        ...
        if (null != designPlanDetailVo) {
           /* HttpSession session = request.getSession();
            //获取用户登录信息
            Integer userId = userSessionService.getUserIdBySessionId(request.getRequestedSessionId(), session.getMaxInactiveInterval());*/
