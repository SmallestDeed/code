...
import com.sandu.cache.service.BaseProductCacheService;
...
public class BaseProductCacheServiceImpl implements BaseProductCacheService {
    ...
    private final static String CLASS_LOG_PREFIX = "[基本产品缓存服务]:";
    private static Logger logger = LoggerFactory.getLogger(BaseProductCacheServiceImpl.class);
    @Autowired
     ...
     */
    @Override
    public BaseProduct getBaseProductById(int productId) {
     ...
     */
    @Override
    public void removeBaseProductById(int productId) {
