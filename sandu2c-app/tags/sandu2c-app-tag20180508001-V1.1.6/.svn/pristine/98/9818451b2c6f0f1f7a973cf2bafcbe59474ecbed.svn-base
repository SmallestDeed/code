...
public interface DesignPlanRecommendedProductService {
     ...
     * @return
     */
    List<RecommendedPlanProductRelatedVo> queryRecommendedPlanOfProductRelatedByProductId2(Integer productId, Integer platformId, LoginUser loginUser,String companyCode,BaseCompany baseCompany);
}
