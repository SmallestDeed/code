...
/**   
 * @Title: GroupCollectDetails.java 
 * @Package com.nork.product.model
 * @Description:产品模块-组合收藏明细表
 * @createAuthor pandajun 
 * @CreateDate 2016-06-22 20:41:47
 * @version V1.0   
 */
public class GroupCollectDetails  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        GroupCollectDetails other = (GroupCollectDetails) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getGroupCollectId() == null ? other.getGroupCollectId() == null : this.getGroupCollectId().equals(other.getGroupCollectId()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGroupCollectId() == null) ? 0 : getGroupCollectId().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public GroupCollectDetails copy(){
       GroupCollectDetails obj =  new GroupCollectDetails();
       obj.setGroupCollectId(this.groupCollectId);
    ...
    public Map toMap(){
       Map map =  new HashMap();
       map.put("groupCollectId",this.groupCollectId);
