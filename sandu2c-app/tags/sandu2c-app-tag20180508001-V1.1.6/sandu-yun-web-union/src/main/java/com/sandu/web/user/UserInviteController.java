...
public class UserInviteController {
    ...
    public ResponseEnvelope getUserPrivateMessageList(@RequestParam(value = "shareType", required = true) Integer shareType, HttpServletRequest request) {
        ...
        String sceneStr = loginUser.getId()+ "," +shareSign + "," + shareType;
        //获取微信accessToken
        ...
        return new ResponseEnvelope(true, "", miniqrQrPicPath);
    }
    ...
    public ResponseEnvelope inviteCallBack(
        ...
        userInviteAdd.setFid(/*loginUser.getId()*/823);
    ...
    public ResponseEnvelope getUserInviteList(@ModelAttribute UserInviteAdd userInviteAdd,HttpServletRequest request) {
     /*   LoginUser loginUser = LoginContext.getLoginUser(LoginUser.class);
        ...
        userInviteAdd.setInviteId(/*loginUser.getId()*/6595);
