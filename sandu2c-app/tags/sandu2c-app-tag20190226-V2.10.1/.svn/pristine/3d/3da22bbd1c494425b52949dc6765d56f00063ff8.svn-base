...
public interface RedisService {
    ...
    boolean setHSet(Map<String, Map<String, String>> map);
    ...
    boolean tryLock(String lockKey, String toString, long expire);

    void releaseLock(String lockKey, String toString);

    long delMatch(String match);
}
