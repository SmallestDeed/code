...
/**   
 * @Title: GroupProductDetailsSearch.java 
 * @Package com.sandu.product.model
 * @Description:产品模块-产品组合关联表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-06-22 20:37:16
 * @version V1.0   
 */
public class GroupProductDetailsSearch extends  GroupProductDetails implements Serializable{
