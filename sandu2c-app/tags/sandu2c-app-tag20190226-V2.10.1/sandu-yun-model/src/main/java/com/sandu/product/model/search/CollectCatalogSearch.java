...
/**
 * @version V1.0
 * @Title: CollectCatalogSearch.java
 * @Package com.sandu.product.model
 * @Description:产品管理-收藏目录表查询对象
 * @createAuthor pandajun
 * @CreateDate 2016-07-01 10:46:26
 */
public class CollectCatalogSearch extends CollectCatalog implements Serializable {
    private static final long serialVersionUID = 1L;
    /**
     * 目录名称-模糊查询
     **/
    private String sch_CatalogName_;
    /**
     * 目录名称-左模糊查询
     **/
    private String sch_CatalogName;
    /**
     * 目录名称-右模糊查询
     **/
    private String schCatalogName_;
    /**
     * 目录名称-区间查询-开始字符串
     **/
    private String catalogNameStart;
    /**
     * 目录名称-区间查询-结束字符串
     **/
    private String catalogNameEnd;
    /**
     * 系统编码-模糊查询
     **/
    ...
    public String getSch_CatalogName_() {
        return sch_CatalogName_;
    }

    public void setSch_CatalogName_(String sch_CatalogName_) {
        this.sch_CatalogName_ = sch_CatalogName_;
    }

    public String getSch_CatalogName() {
        return sch_CatalogName;
    }

    public void setSch_CatalogName(String sch_CatalogName) {
        this.sch_CatalogName = sch_CatalogName;
    }

    public String getSchCatalogName_() {
        return schCatalogName_;
    }

    public void setSchCatalogName_(String schCatalogName_) {
        this.schCatalogName_ = schCatalogName_;
    }

    public String getCatalogNameStart() {
        return catalogNameStart;
    }

    public void setCatalogNameStart(String catalogNameStart) {
        this.catalogNameStart = catalogNameStart;
    }

    public String getCatalogNameEnd() {
        return catalogNameEnd;
    }

    public void setCatalogNameEnd(String catalogNameEnd) {
        this.catalogNameEnd = catalogNameEnd;
    }
