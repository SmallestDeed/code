...
public class SysUser extends Mapper implements Serializable {
    ...
    public Integer getMiniProgramCompanyId() {
        return miniProgramCompanyId;
    }

    public void setMiniProgramCompanyId(Integer miniProgramCompanyId) {
...
//	}
    ...
    public String toString() {
        return "SysUser{" +
                ...
                ", mobileOpenedDate=" + mobileOpenedDate +
                ", mobileClosedDate=" + mobileClosedDate +
                ", visitorsRenderTimes=" + visitorsRenderTimes +
                ", platformType=" + platformType +
                ", myInvitationCode='" + myInvitationCode + '\'' +
                ", uuid='" + uuid + '\'' +
                ", companyId=" + companyId +
                ", miniProgramCompanyId=" + miniProgramCompanyId +
                ", usedInvitationCode='" + usedInvitationCode + '\'' +
                ", businessAdministrationId=" + businessAdministrationId +
                ", address='" + address + '\'' +
