...
public class MainPageController {
    ...
    public ResponseEnvelope getSpecialOfferGoods(int companyId,HttpServletRequest request) {
    ...
    public ResponseEnvelope getPresellGoods(int companyId,HttpServletRequest request) {
