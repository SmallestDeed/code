...
public interface UserInviteService {
    ...
    List<UserInviteListVo> getMyUserInviteList(Integer id,UserInviteSearch userInviteSearch);

    int getMyUserInviteCount(Integer id,UserInviteSearch userInviteSearch);

    int saveUserInviteTrackInfo(UserInviteAdd userInviteAdd,String userName);

    int saveIntermediaryCommisionInfo(UserInviteAdd userInviteAdd,String userName,int userInviteTrackId);

    int saveMiniProgramShareRecord(MiniProgramShareRecordAdd miniProgramShareRecordAdd, SysUser sysUser);

    MiniProgramShareRecord getMiniProgramShareRecordByFid(Integer id);
}
