package com.sandu.demo.model.search;

import com.sandu.demo.model.Exp;
...
/**
 * @version V1.0
 * @Title: ExpSearch.java
 * @Package com.sandu.demo.model
 * @Description:演示模块-参考例子查询对象
 * @createAuthor pandajun
 * @CreateDate 2015-05-17 20:11:49
 */
public class ExpSearch extends Exp implements Serializable {
     ...
     * 字符串属性-模糊查询
     **/
    private String sch_StrAtt_;
    /**
     * 字符串属性-左模糊查询
     **/
    private String sch_StrAtt;
    /**
     * 字符串属性-右模糊查询
     **/
    private String schStrAtt_;
    /**
     * 字符串属性-区间查询-开始字符串
     **/
    private String strAttStart;
    /**
     * 字符串属性-区间查询-结束字符串
     **/
     ...
     * 大文本属性-模糊查询
     **/
    private String sch_HtmlAtt_;
    /**
     * 大文本属性-左模糊查询
     **/
    private String sch_HtmlAtt;
    /**
     * 大文本属性-右模糊查询
     **/
    private String schHtmlAtt_;
    /**
     * 大文本属性-区间查询-开始字符串
     **/
    private String htmlAttStart;
    /**
     * 大文本属性-区间查询-结束字符串
     **/
    private String htmlAttEnd;
    /**
     * 字符备用1-模糊查询
     **/
    ...
    public String getSch_StrAtt_() {
        return sch_StrAtt_;
    }

    public void setSch_StrAtt_(String sch_StrAtt_) {
        this.sch_StrAtt_ = sch_StrAtt_;
    }

    public String getSch_StrAtt() {
        return sch_StrAtt;
    }

    public void setSch_StrAtt(String sch_StrAtt) {
        this.sch_StrAtt = sch_StrAtt;
    }

    public String getSchStrAtt_() {
        return schStrAtt_;
    }

    public void setSchStrAtt_(String schStrAtt_) {
        this.schStrAtt_ = schStrAtt_;
    }

    public String getStrAttStart() {
        return strAttStart;
    }

    public void setStrAttStart(String strAttStart) {
        this.strAttStart = strAttStart;
    }
    ...
    public void setStrAttEnd(String strAttEnd) {
        this.strAttEnd = strAttEnd;
    }

    public Date getDateAttStart() {
        return dateAttStart;
    }

    public void setDateAttStart(Date dateAttStart) {
        this.dateAttStart = dateAttStart;
    }
    ...
    public void setDateAttEnd(Date dateAttEnd) {
        this.dateAttEnd = dateAttEnd;
    }

    public String getSch_HtmlAtt_() {
        return sch_HtmlAtt_;
    }

    public void setSch_HtmlAtt_(String sch_HtmlAtt_) {
        this.sch_HtmlAtt_ = sch_HtmlAtt_;
    }

    public String getSch_HtmlAtt() {
        return sch_HtmlAtt;
    }

    public void setSch_HtmlAtt(String sch_HtmlAtt) {
        this.sch_HtmlAtt = sch_HtmlAtt;
    }

    public String getSchHtmlAtt_() {
        return schHtmlAtt_;
    }

    public void setSchHtmlAtt_(String schHtmlAtt_) {
        this.schHtmlAtt_ = schHtmlAtt_;
    }

    public String getHtmlAttStart() {
        return htmlAttStart;
    }

    public void setHtmlAttStart(String htmlAttStart) {
        this.htmlAttStart = htmlAttStart;
    }

    public String getHtmlAttEnd() {
        return htmlAttEnd;
    }

    public void setHtmlAttEnd(String htmlAttEnd) {
        this.htmlAttEnd = htmlAttEnd;
    }
