...
public class SearchStructureProductDetailResult {
     ...
     * 结构产品标志
     **/
    private String structureProductSign;

    public String getStructureProductSign() {
        return structureProductSign;
    }

    public void setStructureProductSign(String structureProductSign) {
        this.structureProductSign = structureProductSign;
    }
    ...
    public Integer getTemplateProductId() {
        return templateProductId;
    }

    public void setTemplateProductId(Integer templateProductId) {
    ...
    public String toString() {
        return "SearchStructureProductDetailResult{" +
                ...
                ", structureProductSign='" + structureProductSign + '\'' +
