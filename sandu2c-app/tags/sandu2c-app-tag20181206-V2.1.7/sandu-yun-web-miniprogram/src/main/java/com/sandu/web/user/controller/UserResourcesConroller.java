...
public class UserResourcesConroller {
    ...
    public ResponseEnvelope findUserAccounts(@ModelAttribute PageModel pageModel,Integer isSort,HttpServletRequest request, HttpServletResponse response) {
		...
		//查询用户可使用户型套数
		Integer userValidHouseCount = 0;
		if(null !=userAlreadyBoughtHouseCount && null != userUsedHouseCount ){
			userValidHouseCount = (userAlreadyBoughtHouseCount-userUsedHouseCount) > 0 ? (userAlreadyBoughtHouseCount-userUsedHouseCount):0 ;
		}
