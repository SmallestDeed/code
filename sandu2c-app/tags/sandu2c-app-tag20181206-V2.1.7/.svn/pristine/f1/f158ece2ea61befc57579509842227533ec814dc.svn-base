...
/**
 * @version V1.0
 * @Title: UserProductCollect.java
 * @Package com.sandu.product.model
 * @Description:产品模块-我的产品收藏
 * @createAuthor pandajun
 * @CreateDate 2015-06-15 18:27:21
 */
public class UserProductCollect extends Mapper implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        UserProductCollect other = (UserProductCollect) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getCollectCatalogId() == null ? other.getCollectCatalogId() == null : this.getCollectCatalogId().equals(other.getCollectCatalogId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCollectCatalogId() == null) ? 0 : getCollectCatalogId().hashCode());
     ...
     * 获取对象的copy
     **/
    public UserProductCollect copy() {
        UserProductCollect obj = new UserProductCollect();
        ...
        obj.setCollectCatalogId(this.collectCatalogId);
        obj.setSpuId(this.spuId);
    ...
    public Map toMap() {
        ...
        map.put("collectCatalogId", this.collectCatalogId);
        map.put("spuId", this.spuId);
