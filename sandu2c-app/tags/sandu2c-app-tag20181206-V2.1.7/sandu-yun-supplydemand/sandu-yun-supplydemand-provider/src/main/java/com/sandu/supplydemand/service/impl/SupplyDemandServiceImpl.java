...
public class SupplyDemandServiceImpl implements SupplyDemandService {
    ...
    public SupplyDemandDetailVo getSupplyDemandDetailVo(Integer supplyDemandId, Integer userId) {
        ...
        supplyDemandDetailVo.setType(baseSupplyDemand.getType()==2?"需求":"供应");
        supplyDemandDetailVo.setAddress(baseSupplyDemand.getProvinceName()+baseSupplyDemand.getCityName()
                +baseSupplyDemand.getDistrictName()+baseSupplyDemand.getStreetName()+
                baseSupplyDemand.getAddress());
