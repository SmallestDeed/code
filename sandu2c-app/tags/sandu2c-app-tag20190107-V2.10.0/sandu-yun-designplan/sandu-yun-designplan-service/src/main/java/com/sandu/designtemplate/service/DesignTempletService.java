...
public interface DesignTempletService {
     ...
     * @return
     */
	List<DesignTemplet> getListByHouseId(Integer houseId);
	 ...
	 * @return
	 */
	boolean getIsMatch(DesignTemplet designTemplet, DesignPlanRecommended designPlanRecommended);

	/**
	 * 样板房和推挤方案list(精选方案)匹配
	 * 
	 * @author huangsongbo
	 * @param designTemplet
	 * @param designPlanRecommendedList
	 * @return 匹配到的推荐方案id
	 */
	Integer getMatchRecommendedId(DesignTemplet designTemplet, List<DesignPlanRecommended> designPlanRecommendedList);

    DesignTemplet getPlanStyleAndAreaByTempletId(Integer templateId);
}
