...
/**
 * @version V1.0
 * @Title: CollectCatalog.java
 * @Package com.sandu.product.model
 * @Description:产品管理-收藏目录表
 * @createAuthor pandajun
 * @CreateDate 2016-07-01 10:46:26
 */
public class CollectCatalog extends Mapper implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        CollectCatalog other = (CollectCatalog) that;
     ...
     * 获取对象的copy
     **/
    public CollectCatalog copy() {
        CollectCatalog obj = new CollectCatalog();
        obj.setUserId(this.userId);
        obj.setCatalogName(this.catalogName);
