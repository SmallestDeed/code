...
public class BaseProduct extends Mapper implements Serializable {
    ...
    public String toString() {
        return "BaseProduct{" +
                ...
                ", modelId=" + modelId +
                ", filePath='" + filePath + '\'' +
                ", maxModelPath='" + maxModelPath + '\'' +
                ", productDesc='" + productDesc + '\'' +
                ", picIds='" + picIds + '\'' +
                ", rootType='" + rootType + '\'' +
                ", bgWall=" + bgWall +
                ", productModelPath='" + productModelPath + '\'' +
                ", propertyMap=" + propertyMap +
                ", fullPaveLength='" + fullPaveLength + '\'' +
                ", fbxState=" + fbxState +
                ", fbxFileId=" + fbxFileId +
                ", fbxTexture='" + fbxTexture + '\'' +
                ", salePriceValue=" + salePriceValue +
                ", salePriceValueName='" + salePriceValueName + '\'' +
                ", productMaterialDesc='" + productMaterialDesc + '\'' +
                ", colorsLongCode='" + colorsLongCode + '\'' +
                ", colorsOrdering=" + colorsOrdering +
                ", basicModelMap=" + basicModelMap +
                ", productStyleIdInfo='" + productStyleIdInfo + '\'' +
                ", productStyleInfoList=" + productStyleInfoList +
                ", list=" + list +
                ", resIdList=" + resIdList +
                ", dicSmallTypeValue=" + dicSmallTypeValue +
                ", showU3dModel=" + showU3dModel +
                ", productSmallpoxIdentify=" + productSmallpoxIdentify +
                ", propInfo='" + propInfo + '\'' +
                ", productIndex=" + productIndex +
                ", designPlanProductId=" + designPlanProductId +
                ", att1='" + att1 + '\'' +
                ", smallPicPath=" + Arrays.toString(smallPicPath) +
                ", materialPicIds='" + materialPicIds + '\'' +
                ", houseTypeValues='" + houseTypeValues + '\'' +
                ", productTypeValue='" + productTypeValue + '\'' +
                ", u3dModelId='" + u3dModelId + '\'' +
                ", mergeProductIds='" + mergeProductIds + '\'' +
                ", decorationId='" + decorationId + '\'' +
                ", designerId=" + designerId +
                ", modelingId=" + modelingId +
                ", renderingId=" + renderingId +
                ", spaceComonId=" + spaceComonId +
                ...
                ", materialPicPaths=" + Arrays.toString(materialPicPaths) +
                ", materialConfigPath='" + materialConfigPath + '\'' +
                ", material3dPicIds='" + material3dPicIds + '\'' +
                ", material3dPicPaths=" + Arrays.toString(material3dPicPaths) +
                ", productTypeCode='" + productTypeCode + '\'' +
                ", configBrandIdList=" + configBrandIdList +
                ", configTypeValueList=" + configTypeValueList +
                ", configSmallTypeIdList=" + configSmallTypeIdList +
                ", configProductIdList=" + configProductIdList +
                ", terminalImei='" + terminalImei + '\'' +
                ", modelLength=" + modelLength +
                ", modelWidth=" + modelWidth +
                ", modelHeight=" + modelHeight +
                ", modelMinHeight=" + modelMinHeight +
                ", textureAttrValue=" + textureAttrValue +
                ", laymodes='" + laymodes + '\'' +
                ", configId=" + configId +
                ", productModelNumber='" + productModelNumber + '\'' +
                ", minHeight='" + minHeight + '\'' +
                ", splitTexturesChoose=" + splitTexturesChoose +
                ", productIdList=" + productIdList +
                ", putawayStateList=" + putawayStateList +
                ", styleId=" + styleId +
                ", isBeijing=" + isBeijing +
                ", isStretch=" + isStretch +
                ...
                ", attributeConditionList=" + attributeConditionList +
                ", attributeConditionSize=" + attributeConditionSize +
                ", parentProductId=" + parentProductId +
                ", designTempletId=" + designTempletId +
                ", putawayModified=" + putawayModified +
                ", dateAtt2=" + dateAtt2 +
                ", productSmallTypeValue=" + productSmallTypeValue +
                ", productSmallTypeMark='" + productSmallTypeMark + '\'' +
                ", productTypeMark='" + productTypeMark + '\'' +
                ", productSmallTypeCode='" + productSmallTypeCode + '\'' +
                ", productSmallTypeName='" + productSmallTypeName + '\'' +
                ...
                ", macBookU3dModelId=" + macBookU3dModelId +
                ", windowsU3dModelId=" + windowsU3dModelId +
                ", ipadU3dModelId=" + ipadU3dModelId +
                ", iosU3dModelPath='" + iosU3dModelPath + '\'' +
                ", androidU3dModelPath='" + androidU3dModelPath + '\'' +
                ", macBookU3dModelPath='" + macBookU3dModelPath + '\'' +
                ", windowsU3dModelPath='" + windowsU3dModelPath + '\'' +
                ", ipadU3dModelPath='" + ipadU3dModelPath + '\'' +
                ", mediaTypeModelPath='" + mediaTypeModelPath + '\'' +
                ", mediaType='" + mediaType + '\'' +
                ", userId=" + userId +
                ", brandName='" + brandName + '\'' +
                ", brandReferred='" + brandReferred + '\'' +
                ", houseType='" + houseType + '\'' +
                ...
                ", smallPiclist=" + smallPiclist +
                ", thumbnailList=" + thumbnailList +
                ", colorlist=" + colorlist +
                ", materiallist=" + materiallist +
                ", map=" + map +
                ", collectState=" + collectState +
                ", putawayStateName='" + putawayStateName + '\'' +
                ", productTypeKey='" + productTypeKey + '\'' +
                ", productColorKey='" + productColorKey + '\'' +
                ", brandIds=" + brandIds +
                ", tomorrow=" + tomorrow +
                ", splitTexturesInfo='" + splitTexturesInfo + '\'' +
                ", isSplit=" + isSplit +
                ", smallTypeValueListForShowAll=" + smallTypeValueListForShowAll +
                ", materialId='" + materialId + '\'' +
                ", mergeCount=" + mergeCount +
                ", recommendState=" + recommendState +
                ", posIndexPath='" + posIndexPath + '\'' +
                ", productSequence='" + productSequence + '\'' +
                ", planId=" + planId +
                ", isProductType='" + isProductType + '\'' +
                ", editCodeState=" + editCodeState +
                ...
                ", bigTypeValueKey='" + bigTypeValueKey + '\'' +
                ", smallTypeValueKey='" + smallTypeValueKey + '\'' +
                ", groupCount=" + groupCount +
                ", smallTypeAtt1='" + smallTypeAtt1 + '\'' +
                ", bigTypeName='" + bigTypeName + '\'' +
                ", smallTypeName='" + smallTypeName + '\'' +
                ", productBatchType='" + productBatchType + '\'' +
                '}';
    }
}
