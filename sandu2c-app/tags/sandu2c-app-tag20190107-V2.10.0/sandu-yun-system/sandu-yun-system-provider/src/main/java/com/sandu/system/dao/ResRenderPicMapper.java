...
public interface ResRenderPicMapper {
    ...
    List<ResRenderPic> selectMyPlanCoverResRenderPic(Integer planId);

    List<ResRenderPic> selectFullHouseCoverResRenderPic(Integer planId);

    List<ResRenderPic> selectSingleSpaceCoverResRenderPic(Integer planId);
}
