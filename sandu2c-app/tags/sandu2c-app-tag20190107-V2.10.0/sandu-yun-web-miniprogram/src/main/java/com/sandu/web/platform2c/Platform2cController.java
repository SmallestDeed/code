...
@Controller
@RequestMapping("/v1/miniprogram/platform2c")
public class Platform2cController {
    ...
    public ResponseEnvelope platform2cDetails(HttpServletRequest request,
        ...
        String basePlatformInfo = redisService.getMap(BASE_PLATFORM_INFO, miniprogramPlatformCode);
        ...
        if (StringUtils.isNotEmpty(basePlatformInfo)) {
            ...
            if (null != basePlatform) {
                redisService.addMap(BASE_PLATFORM_INFO, miniprogramPlatformCode, GSON.toJson(basePlatform));
                return new ResponseEnvelope<>(true, "success", basePlatform);
            }
        }
