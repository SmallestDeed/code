...
public interface BaseHouseGuidePicInfoService {
	 ...
	 * @return
	 */
	List<GuideInfoDTO> getGuideInfoDTOListByPicId(Integer picId, Integer houseId, Integer fullHousePlanId, Map<Integer, Integer> renderStatusMap, Map<Integer, DesignTemplet> designTempletMap);
