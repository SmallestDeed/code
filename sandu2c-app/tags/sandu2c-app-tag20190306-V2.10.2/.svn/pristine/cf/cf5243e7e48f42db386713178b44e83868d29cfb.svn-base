...
public interface FullHouseDesignPlanMapper {
    ...
    int selectMydecorationPlanCount(MydecorationPlanAdd mydecorationPlanAdd);
    ...
    int delAutoRenderTaskStateByMainTask(@Param("taskId") Integer taskId);

    int delAutoRenderTaskByMainTask(@Param("taskId") Integer taskId);
    ...
    DesignPlanRecommendedResult getFullHousePlanById(@Param("planId")Integer planId, @Param("userId")Integer userId);

    List<ResRenderPic> selectResRenderCoverPicById(Integer businessId);


    List<DesignPlanRecommendedResult> getSuperiorFullHousePlanList1(@Param("userId")Integer userId,  @Param("list")List<Integer> fullHouseSuperiorPlanIdList);

    int delAutoRenderTaskByHouseId(@Param("userId") Integer userId, @Param("houseId") Integer houseId);

    int delAutoRenderTaskStateByHouseId(@Param("userId") Integer userId, @Param("houseId") Integer houseId);

    int delDesignPlanRenderSceneByHouseId(@Param("userId") Integer userId, @Param("houseId") Integer houseId);

    int delFullHouseDesignPlanByHouseId(@Param("userId") Integer userId, @Param("houseId") Integer houseId);

    List<BaseHouseVo> getAllHouse(@Param("userId") Integer userId,
                                  @Param("state") Integer state);

    Integer setTaskStateAskState(@Param("userId") Integer userId,
                                 @Param("askType") String askType,
                                 @Param("taskId") Integer taskId);

    List<FullHouseDesignPlan> selectByUserIdAndPrePlanName(@Param("userId") Integer userId,
                                                           @Param("pre") String pre);
}
