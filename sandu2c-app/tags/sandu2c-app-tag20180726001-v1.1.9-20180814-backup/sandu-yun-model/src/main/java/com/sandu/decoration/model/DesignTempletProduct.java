package com.sandu.decoration.model;
 ...
 */
public class DesignTempletProduct extends Mapper implements Serializable {
     ...
     * 获取对象的copy
     **/
    public DesignTempletProduct copy() {
        DesignTempletProduct obj = new DesignTempletProduct();
    ...
    public String toString() {
        return "DesignTempletProduct{" +
                ...
                ", recommendProCount=" + recommendProCount +
                ", historyRecommendProCount=" + historyRecommendProCount +
