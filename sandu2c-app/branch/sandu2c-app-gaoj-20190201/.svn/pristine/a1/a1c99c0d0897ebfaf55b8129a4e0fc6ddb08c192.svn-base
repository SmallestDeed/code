...
public class PanoramaVo implements Serializable {
    ...
    public String toString() {
        return "PanoramaVo{" +
                ...
                ", desc='" + desc + '\'' +
                ", thumbUrl='" + thumbUrl + '\'' +
                ", windowsPercent='" + windowsPercent + '\'' +
                ", designPlanRenderSceneId=" + designPlanRenderSceneId +
                ", designPlanRecommendedId=" + designPlanRecommendedId +
                ", oneKeyDesignPlanId=" + oneKeyDesignPlanId +
                ", brandList=" + brandList +
                ", platformId=" + platformId +
                ", companyId=" + companyId +
                ", sysDictionaryBOList=" + sysDictionaryBOList +
                ", ownBrandIdList=" + ownBrandIdList +
                ", isSandu=" + isSandu +
