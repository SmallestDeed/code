...
public interface SysDictionaryService {
    ...
    /**
     * 通过valueKey和type获取所有大小分类
     * @param valueKeys
     * @return
     */
    List<SysDictionaryBo> getTypeValueByValueKeys(List<String> valueKeys);

    /**
     * 根据大类的Type和Value获取所有小类
     * @param type
     * @param value
     * @return
     */
    List<SysDictionary> getByTypeAndValue(String type, Integer value);

    /**
     * 根据大类type获取所有大类及关联的小类
     * @param type
     * @return
     */
    List<SysDictionary> getAllRelationshipData(String type);

    /**
     * 比如type = "restaurant" 面积spaceArea = 40.5,找到对应的数据字典
     * 
     * @author huangsongbo
     ...
     * @return
     */
	Integer getSpaceAreaValue(Integer spaceFunctionId, String spaceArea);

    Map<Integer,String> valueAndName2Map(String houseType);

    SysDictionary selectOneByTypeAndValue(String type, Integer value);
}
