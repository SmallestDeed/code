 ...
 * @ Author     ：weisheng.
 * @ Date       ：Created in PM 5:21 2018/9/21 0021
 ...
 * @Description:
 * @author weisheng
 * @date 2018/9/21 0021PM 5:21
 */
@Data
public class MydecorationPlanVo implements Serializable{
    private static final long serialVersionUID = 2220483662873999489L;
    ...
    private Integer supplyDemandPublisherId;//供求信息创建者ID
    /**
     * 户型名称
     */
     ...
     * 已经装修的空间数量
     */
    private Integer decoratedSpaceCount;
    /**
     * 户型总空间数量
     */
     ...
     * 是否咨询设计过
     */
    private Integer askDesign;
    /**
     * 是否免费报价过
     */
    private Integer askQuotation;
}
