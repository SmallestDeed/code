...
@RestController
@RequestMapping("/v1/tocmobile/autorender")
public class MyDesignPlanController {
    private static final Gson GSON = new Gson();
    private static final String CLASS_LOG_PREFIX = "[我的设计]:";
    private static final Logger logger = LogManager.getLogger(MyDesignPlanController.class);
    ...
    public ResponseEnvelope getThumbList(@ModelAttribute RenderingModel thumbData, @ModelAttribute PageModel pageModel, HttpServletRequest request) {
        ...
        designPlanRenderScene.setLimit(pageModel.getLimit());
