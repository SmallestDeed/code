...
public interface NodeInfoBizService {
     ...
     * @return
     */
    Integer updateNodeInfoDetailValue(Integer contentId, Integer nodeType, Integer detailType, Integer value);
     ...
     * @return
     */
    Integer updateNodeInfoDetailValue(Integer userId, Integer nodeId, Byte nodeType, Byte detailType, Byte status, boolean db);
