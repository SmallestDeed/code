...
public class ProductIndex {
    ...
    @Autowired
    public ProductIndex(ElasticSearchService elasticSearchService, BrandMetaDataStorage brandMetaDataStorage,
                        ResPicMetaDataStorage resPicMetaDataStorage, CompanyMetaDataStorage companyMetaDataStorage,
                        ProductStyleMetaDataStorage productStyleMetaDataStorage,
                        ProductIndexService productIndexService,
                        ProductTextureMetaDataStorage productTextureMetaDataStorage,
                        ProductPlatformMetaDataStorage productPlatformMetaDataStorage,
                        ProductCategoryMetaDataStorage productCategoryMetaDataStorage,
                        ProductAttributeMetaDataStorage productAttributeMetaDataStorage,
                        ProductUsageCountMetaDataStorage productUsageCountMetaDataStorage,
                        ProductCategoryRelMetaDataStorage productCategoryRelMetaDataStorage,
    ...
    public int indexProdcutData(List<ProductPo> productPoList) {
        ...
        for (ProductPo productPo : productPoList) {
            ...
            /******************* Field8:是否是组合主产品数据 ******************/
            List<Integer> groupIdList = groupProductRelMetaDataStorage.getNormalGroupIdListByMainProductId(productIndexMappingData.getId());
            if (null != groupIdList && 0 < groupIdList.size()) {
                productIndexMappingData.setIsMainProduct(1);
            } else {
                productIndexMappingData.setIsMainProduct(0);
            }
