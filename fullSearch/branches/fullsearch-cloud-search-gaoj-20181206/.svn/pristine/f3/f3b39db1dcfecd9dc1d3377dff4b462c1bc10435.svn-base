...
public interface MetaDataDao {
     ...
     * @return
     */
    List<GroupProductRelPo> queryProductGroupRelMetaData();
     ...
     * @return
     */
    List<GroupProductPo> queryProductGroupMetaData();
     ...
     * @return
     */
    List<GroupProductDetailPo> queryProductGroupDetail();

    List<GroupProductPlatformRelPo> queryToBPlatformGroupProductMetaData();

    List<GroupProductPlatformRelPo> queryToCPlatformGroupProductMetaData();
