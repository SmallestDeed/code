...
public class QueryConditionField {
    ...
    // 组合产品替换搜索逻辑需要，是否是主产品(1:是，0:不是)
    public final static String QUERY_CONDITION_FIELD_PRODUCT_IS_MAIN_DATE = "isMainProduct";
    ...
    /************************ 组合产品 **************************/
    //组合产品id
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_ID = "groupId";
    //组合产品是否删除
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_ID_DELETED = "dataIsDeleted";
    //组合产品平台集合
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_CODE_LIST = "platformCodeList";
    //移动B端平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_TOB_MOBILE = "platformGroupProductToBMobile";
    //通用版平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_TOB_PC = "platformGroupProductToBPc";
    //运营网站平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_TOC_SITE = "platformGroupProductToCSite";
    //移动C端平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_TOC_MOBILE = "platformGroupProductToCMobile";
    //户型绘制平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_HOUSE_DRAW = "platformGroupProductHouseDraw";
    //商家后台平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_MERCHANTS_MANAGER = "platformGroupProductMerchantsManager";
    //测试
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_TEST = "platformGroupProductTest";
    //小程序平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_MINIPROGRAM = "platformGroupProductMiniProgram";
    //随选网平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_SELECT_DECORATION = "platformGroupProductSelectDecoration";
    //定制企业平台
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_PC_TOB_CUSTOM = "platformGroupProductPcToBCustom";
    //平台上下架状态，1上架/0未上架
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_PUTAWAY_STATE = "platformPutawayState";
    //平台分配状态，1已分配/0未分配
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_PLATFORM_ALLOT_STATE = "platformAllotState";
    //组合产品类型，(0:普通组合;1:一件装修组合),默认为普通组合
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_GROUP_TYPE = "groupType";
