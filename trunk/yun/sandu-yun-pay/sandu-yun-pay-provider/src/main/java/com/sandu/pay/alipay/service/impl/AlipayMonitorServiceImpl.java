...
import com.sandu.pay.alipay.model.builder.AlipayHeartbeatSynRequestBuilder;
import com.sandu.pay.alipay.service.AlipayMonitorService;
    ...
    public static class ClientBuilder {
        ...
        public AlipayMonitorServiceImpl build() {
            if (StringUtils.isEmpty(gatewayUrl)) {
                gatewayUrl = AlipayConfig.getMcloud_api_domain(); // 与openapi网关地址不同
            }
