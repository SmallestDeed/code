...
import com.sandu.pay.alipay.util.httpClient.HttpRequest;
...
public interface BaseCompanyService {
     ...
     * @return int
     */
    int add(BaseCompany baseCompany);
     ...
     * @return int
     */
    int update(BaseCompany baseCompany);
     ...
     * @return int
     */
    int getCount(BaseCompanySearch baseCompanySearch);
     ...
     * @return List<BaseCompany>
     */
    List<BaseCompany> getPaginatedList(BaseCompanySearch baseCompanytSearch);
     ...
     * @return
     */
    Set<String> getTypeSetByUserId(Integer id);
     ...
     * @return
     * @throws DomainConfigurationException 域名信息超过1条-配置异常
     */
    ...
    List <Integer> getEnableBrandIdsByAppId(String appId);

    List<Integer> queryBrandIdListByCompanyIdList(List<Integer> companyIdList);

    List<Integer> queryDealerBranIdListByDealerId(int dealerId);

    List<Integer> getBrandIdListByCompanyId(Integer companyId, LoginUser currentUser, String plantformCode);

    BaseCompanyMiniProgramConfig getBaseCompanyMiniProgramConfigByAppId(String appId);
	
	BaseCompany getCompanyByDomainUrl(String referer, String customReferer);
