...
public interface UserReviewsService {
    ...
    int delReviewMsg(Integer reviewsId, LoginUser loginUser, Integer businessId);

    int updateReviewsIsTop(Integer reviewsId, Integer businessId, Integer isTop);

    BaseSupplyDemand getPaivateDemandInfo();

    UserReviewsVo getPaivateuserReviewsInfo();

    Integer getTopReviewIdByBusinessId(Integer businessId);
}
