package com.sandu.common.file.util.file;

import com.sandu.common.file.context.SystemContextHolder;
...
public class FilePathUtil {
    ...
    public static String filename(LocalDateTime now) {
        return randomPath() + UNDERLINE + now.format(FormatterUtil.nameFormatter);
    }
    ...
    public static String datePath(LocalDateTime now) {
        return now.format(FormatterUtil.pathFormatter);
    }
    ...
    public static String serverPath() {
        ...
        String serverUrl = environment.getProperty("file.storage.path");
        return serverUrl;
//        return SystemContextHolder.getSystemContext().getServerPath();
    ...
    public static void main(String[] args) {
        String path = "/_platform_/_module_/_type_/[yyyy/MM/dd/HH]";
        String proPath = path.substring(path.indexOf(LEFT_SQUARE_BRACKETS) + 1, path.indexOf(RIGHT_SQUARE_BRACKETS));
