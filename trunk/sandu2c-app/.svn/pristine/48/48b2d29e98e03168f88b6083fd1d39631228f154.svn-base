            ...
            if (null != datalist) {
                ...
                for (DesignPlanRecommendedResult designPlanRecommendedResult : datalist) {
                    ...
                    if (designPlanRecommendedResult.getViewNum() == null){
                        designPlanRecommendedVo.setUseCount(0 + "");
                    }else {
                        if (designPlanRecommendedResult.getViewNum() >= 10000){
                            ...
                            designPlanRecommendedVo.setUseCount(num.divide(w, 1, BigDecimal.ROUND_HALF_UP).toString() + "w");
                        }else {
                            designPlanRecommendedVo.setUseCount(designPlanRecommendedResult.getViewNum().toString());
                        }
                    }
