...
/**
 * @version V1.0
 * @Title: UserProductCollectSearch.java
 * @Package com.sandu.product.model
 * @Description:产品模块-我的产品收藏查询对象
 * @createAuthor pandajun
 * @CreateDate 2015-06-15 18:27:21
 */
public class UserProductCollectSearch extends UserProductCollect implements Serializable {
