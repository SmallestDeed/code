...
public class ProductMessageHandler {
    ...
    @Autowired
    public ProductMessageHandler(ProductIndex productIndex, ElasticSearchService elasticSearchService, ProductIndexService productIndexService) {
     ...
     * @return
     */
    public boolean delete(List<ProductIndexMappingData> productIndexMappingDataList) {
