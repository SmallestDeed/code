        ...
        switch (productTypeValue) {
            ...
            case ProductTypeValue.PRODUCT_TYPE_VALUE_WALL:
                ...
                if (productTypeSmallValue == ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_BACKGROUND_WALL
                    ...
                    //若高度0-30(含)则搜索0-30(含)范围,若高度30-50(含)则搜索30-50(含)范围,若高度大于50,则搜索50-260(含)的范围高度
                    if (0 < productWhiteMembraneHeight && productWhiteMembraneHeight <= 30) {
                        valueRange = new ValueRange(
                                ValueRange.RANGE_TYPE_ONLY_END_EQUAL,
                                0,
                                30
                        );
                    } else if (30 < productWhiteMembraneHeight && productWhiteMembraneHeight <= 50) {
                        valueRange = new ValueRange(
                                ValueRange.RANGE_TYPE_ONLY_END_EQUAL,
                                30,
                                50
                        );
                    } else if (50 < productWhiteMembraneHeight && productWhiteMembraneHeight < 260) {
                        valueRange = new ValueRange(
                                ValueRange.RANGE_TYPE_ONLY_END_EQUAL,
                                50,
                                260
