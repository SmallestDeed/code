...
public class ProductNameSearchServiceImpl implements ProductNameSearchService {
    ...
    public SearchObjectResponse queryProductListByProductName(String productName, int dataSize) throws ProductNameSearchException {
        ...
        try {
            searchObjectResponse = elasticSearchService.search(Collections.singletonList(matchQueryBuilder), null, null, null, null, IndexInfoQueryConfig.DEFAULT_SEARCH_DATA_START, dataSize, IndexConstant.INDEX_PRODUCT_INFO);
