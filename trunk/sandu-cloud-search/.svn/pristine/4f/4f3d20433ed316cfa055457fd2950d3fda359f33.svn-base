...
public class RecommendationPlanOriginController {
    ...
    OriginResponse queryRecommendationPlanListByCondition(@RequestParam Integer curPage,
        ...
        if (!StringUtils.isEmpty(spaceArea)) {
            recommendationPlanSearchVo.setSpaceAreas(spaceArea);
        }
        ...
        for (RecommendationPlanVo recommendationPlanVo : recommendationPlanVoList) {
            ...
            recommendationBean.setCollectNum(recommendationPlanVo.getCollectCount());
            recommendationBean.setDesignPlanCoverPath(recommendationPlanVo.getCoverPicPath());
            recommendationBean.setDesignPlanDesc(recommendationPlanVo.getRemark());
            recommendationBean.setDesignPlanId(recommendationPlanVo.getDesignPlanId());
            recommendationBean.setDesignPlanRecommendId(recommendationPlanVo.getId());
            ...
            recommendationBean.setDesignPlanName(recommendationPlanVo.getName());
            recommendationBean.setDisplayType(recommendationPlanVo.getType());
            recommendationBean.setGroupPrimaryId(0);
            recommendationBean.setIsFavorite(recommendationPlanVo.getCollect());
            recommendationBean.setIsLike(recommendationPlanVo.getLike());
            recommendationBean.setIsSortByReleaseTime(0);
            recommendationBean.setIsSortByRenderCount(0);
            recommendationBean.setLikeNum(recommendationPlanVo.getLikeCount());
            recommendationBean.setReleaseTime(DateTool.getDateStrByDate(recommendationPlanVo.getPublishTime()));
            recommendationBean.setRenderCount(0);
            recommendationBean.setSpaceArea(recommendationPlanVo.getSpaceAreas());
            recommendationBean.setSpaceShape(Integer.parseInt(recommendationPlanVo.getSpaceShape()));
