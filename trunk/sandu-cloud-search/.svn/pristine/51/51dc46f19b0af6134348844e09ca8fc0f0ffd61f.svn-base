...
public class ProductSearchServiceImpl implements ProductSearchService {
    ...
    public SearchObjectResponse searchProduct(ProductSearchMatchVo productSearchMatchVo, List<ProductSearchAggregationVo> productSearchAggregationVoList, PageVo pageVo) throws ProductSearchException {
        ...
        //排序字段
        SortOrderObject sortOrderObject = productSearchMatchVo.getSortOrderObject();
        ...
        try {
            searchObjectResponse = elasticSearchService.search(matchQueryList, noMatchQueryList, shouldMatchSearchList, aggregationBuilderList, sortOrderObject, pageVo.getStart(), pageVo.getPageSize(), IndexConstant.INDEX_PRODUCT_INFO);
    ...
    public ProductIndexMappingData searchProductById(Integer productId) throws ProductSearchException {
        ...
        SearchObjectResponse searchObjectResponse;
        try {
            searchObjectResponse = elasticSearchService.search(Collections.singletonList(matchQueryBuilder), null, null, null, null, IndexInfoQueryConfig.DEFAULT_SEARCH_DATA_START, 1, IndexConstant.INDEX_PRODUCT_INFO);
        } catch (ElasticSearchException e) {
