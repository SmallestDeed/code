package com.sandu.search.entity.elasticsearch.po.product;
 ...
 */
@Data
public class ProductPlatformData implements Serializable{

    private static final long serialVersionUID = -7730871994002217068L;
