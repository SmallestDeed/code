...
public class AutoRenderTaskState extends AutoRenderTask implements Serializable {
	...
	/**装进我家后新的全屋方案的uuid**/
	/**This is the full house plan vr resource uuid, not full house plan uuid. TODO Please renamed this field.*/
	...
	public String getRenderProgramVersion() {
		return renderProgramVersion;
	}

	public void setRenderProgramVersion(String renderProgramVersion) {
		this.renderProgramVersion = renderProgramVersion;
	}
	...
	public String getRenderMachineIp() {
		return renderMachineIp;
	}

	public void setRenderMachineIp(String renderMachineIp) {
		this.renderMachineIp = renderMachineIp;
	}
	...
	public String toString() {
		return "AutoRenderTaskState{" +
				...
				", newDesignCode='" + newDesignCode + '\'' +
				", designName='" + designName + '\'' +
				", taskSource=" + taskSource +
				", hostIp='" + hostIp + '\'' +
				", renderTimeConsuming='" + renderTimeConsuming + '\'' +
				", isValid=" + isValid +
				", renderMachineIp='" + renderMachineIp + '\'' +
				", renderLevel=" + renderLevel +
				", renderProgramVersion='" + renderProgramVersion + '\'' +
				", platformId=" + platformId +
				", newFullHousePlanId=" + newFullHousePlanId +
				", fullHousePlanUUID='" + fullHousePlanUUID + '\'' +
				'}';
	}
}
