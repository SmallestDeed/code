 ...
 * @version V1.0   
 */
public class StructureProduct  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
	 ...
	 * 结构布局标识
	 */
	private String structureGroundIdentify;
	...
	private List<ProductSimpleModel>productList = new ArrayList<ProductSimpleModel>();
	
	
	public List<ProductSimpleModel> getProductList() {
		return productList;
	}

	public void setProductList(List<ProductSimpleModel> productList) {
		this.productList = productList;
	}

	public String getStructureGroundIdentify() {
		return structureGroundIdentify;
	}

	public void setStructureGroundIdentify(String structureGroundIdentify) {
		this.structureGroundIdentify = structureGroundIdentify;
	}
	...
	//结构小类型
    private Integer structureSmallType;

	public Integer getStructureSmallType() {
		return structureSmallType;
	}

	public void setStructureSmallType(Integer structureSmallType) {
		this.structureSmallType = structureSmallType;
	}
	...
	public Integer getDescPicId() {
		return descPicId;
	}

	public void setDescPicId(Integer descPicId) {
		this.descPicId = descPicId;
	}
