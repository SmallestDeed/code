...
public class ProductAttributeServiceImpl implements ProductAttributeService {
	...
	public Map<String, String> getPropertyMapV2(Integer productId) {
		...
		/*String cacheEnable = Utils.getValue("redisCacheEnable", "0");
		List<ProductProps> productPropList = null;
		if("1".equals(cacheEnable)){
			productPropList =ProductPropsCacher.getProductPropsMap(productId);
		}else{
		    productPropList = productPropsService.getAttributeKeyAndValueByProductId(productId);
		}*/
