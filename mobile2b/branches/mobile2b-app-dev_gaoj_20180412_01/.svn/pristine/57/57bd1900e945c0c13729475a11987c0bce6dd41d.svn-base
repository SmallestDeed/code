...
import com.nork.system.dao.BasePlatformMapper;
...
public class BasePlatformServiceImpl implements BasePlatformService {
	...
	@Override
	public List<Integer> getIdsbyBussinessType(String platformBussinessType) {
		if (StringUtils.isEmpty(platformBussinessType)) {
			return null;
		}
		return basePlatformMapper.getIdsbyBussinessType(platformBussinessType);
	}
    /**
	 * 其他
	 * 
