...
public class SpaceCommonServiceImpl implements SpaceCommonService {
	...
	@Autowired
	private BaseHouseServiceImpl baseHouseService;
  ...
  /*      float valNum = Float.valueOf(val);
	...
	@Override
	public HouseSpaceResult getFullHouseSpace(String houseIdStr) {

		HouseSpaceResult fullHouseSpace = new HouseSpaceResult();
		//获取全屋空间类型id，并赋值
		Integer fullHouseSpaceFunctionId = spaceCommonMapper.getFullHouseSpaceFunctionId();
		...
		baseHouseService.getHousePic(baseHouse);
