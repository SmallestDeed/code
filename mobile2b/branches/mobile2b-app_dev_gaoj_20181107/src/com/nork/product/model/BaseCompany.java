...
private static final long serialVersionUID = 1L;
	...
	//是否接收平台选定派单(0:不接收;1:接收)
	private Integer isReceivePlatformDispatch;

	//是否接收内部推荐(0:不接收;1:接收)
	private Integer isReceiveInteriorDispatch;

	public Integer getIsReceivePlatformDispatch() {
		return isReceivePlatformDispatch;
	}

	public void setIsReceivePlatformDispatch(Integer isReceivePlatformDispatch) {
		this.isReceivePlatformDispatch = isReceivePlatformDispatch;
	}

	public Integer getIsReceiveInteriorDispatch() {
		return isReceiveInteriorDispatch;
	}

	public void setIsReceiveInteriorDispatch(Integer isReceiveInteriorDispatch) {
		this.isReceiveInteriorDispatch = isReceiveInteriorDispatch;
	}
   ...
   @Override
    public boolean equals(Object that) {
        ...
        BaseCompany other = (BaseCompany) that;
...
;
    ...
    /**获取对象的copy**/
    public BaseCompany copy(){
       BaseCompany obj =  new BaseCompany();
       ...
       obj.setCompanyCode(this.companyCode);
       obj.setCompanyName(this.companyName);
       obj.setCompanyUrl(this.companyUrl);
       obj.setCompanyDesc(this.companyDesc);
       obj.setCompanyAddress(this.companyAddress);
       ...
       obj.setCompanyLogo(this.companyLogo);
    ...
    public Map toMap(){
       ...
       map.put("companyUrl",this.companyUrl);
       map.put("companyDesc",this.companyDesc);
       map.put("companyAddress",this.companyAddress);
       ...
       map.put("numAtt1",this.companyLogo);
