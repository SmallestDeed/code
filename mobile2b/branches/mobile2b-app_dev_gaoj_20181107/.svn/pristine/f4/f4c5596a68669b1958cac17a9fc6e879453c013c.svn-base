...
public class DesignPlanBrand extends Mapper implements Serializable {
	...
	// 推荐方案风格
	Integer designRecommendedStyleId;
	// 小区名称
	String livingName;
	// 空间面积
	String areaValue;
	...
	/*getPlanRecommendedList  用到的查询参数 Begin >>*/
