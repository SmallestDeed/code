...
public interface SysUserMessageService {
	 ...
	 * @return
	 */
	SysUserMessage getSysUserMessage(String title, String content, SysUser sysUser);
	 ...
	 * @param sysUserMessage
	 */
	void saveSomeInfo(SysUserMessage sysUserMessage);

	/**
	 * insert sys_user_message
	 * 
	 * @param title
	 * @param content
	 * @param creator
	 * @return 
	 */
	Long add(String title, String content, SysUser sysUser);
}
