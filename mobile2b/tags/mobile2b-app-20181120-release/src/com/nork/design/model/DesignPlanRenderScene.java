...
//	private Integer nightFileId;
	...
	/**是否是全屋子方案效果图（0:否,1:是）**/
	private Integer isFullHousePlan;

	public Integer getIsFullHousePlan() {
		return isFullHousePlan;
	}

	public void setIsFullHousePlan(Integer isFullHousePlan) {
		this.isFullHousePlan = isFullHousePlan;
	}
