...
public class BaseHouseServiceImpl implements BaseHouseService {
	 ...
	 * @param provinceCode
	 * @param cityCode
	 * @param baseAreaCode 区编码 add by WangHaiLin
	 * @param livingName
	 * @param msgId
	 * @param limit
	 * @param start
	 ...
	 */
	@Override
	public Object newHouseSearchWeb(String provinceCode, String cityCode,String baseAreaCode, String livingName, String msgId, String limit,
		...
		//add By WangHaiLin start
		baseHouseResult.setAreaCode(baseAreaCode);
		//add By WangHaiLin end
		...
		//areaCode_a add By WangHaiLIn
		String areaCode_a=baseAreaCode;
		...
		/**add By WangHaiLIn start**/
		if (StringUtils.isNotBlank(areaCode_a)) {
			areaLongCode.append("." + areaCode_a);
		}
		/**add By WangHaiLIn end**/
	...
	public void getHousePic(BaseHouse baseHouse) {
		// 取户型的缩略图和大图
