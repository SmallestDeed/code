...
public class DesignPlanRecommended extends Mapper implements Serializable {
     ...
     * 经销商(主账号)收藏夹
     */
    private List<Favorite> franchiserFavoriteList;
    /**
     * 厂商id
     */
    private Integer pidOfBaseCompany;
    ...
    private Integer dealerOneKeyRecommended;//判断经销商试用账号是否能查看三度云享家一键方案,1为拥有
    //装修报价类型
    ...
    public Integer getDealerOneKeyRecommended() {
        return dealerOneKeyRecommended;
    }

    public void setDealerOneKeyRecommended(Integer dealerOneKeyRecommended) {
        this.dealerOneKeyRecommended = dealerOneKeyRecommended;
    }
    ...
    public Integer getPidOfBaseCompany() {
        return pidOfBaseCompany;
    }

    public void setPidOfBaseCompany(Integer pidOfBaseCompany) {
        this.pidOfBaseCompany = pidOfBaseCompany;
    }

    public List<Favorite> getFranchiserFavoriteList() {
        return franchiserFavoriteList;
    }

    public void setFranchiserFavoriteList(List<Favorite> franchiserFavoriteList) {
        this.franchiserFavoriteList = franchiserFavoriteList;
    }
