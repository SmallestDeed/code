...
<head>
    ...
    <link href="${pageContext.request.contextPath}/pages/vr720/custom/css/720style.css" type="text/css" rel="stylesheet">
    ...
    <script src="${pageContext.request.contextPath}/pages/vr720/custom/js/roam.js"></script>
...
<body>
    ...
    <div id="pano" style="width:100%;height:100%;">
        ...
        <div>
            <ul class="nameInfo">
                <li style="position:absolute; right:10px"><img id="companyLogoUrl" src="${vo.panoramaVo.companyLogoPath}" alt=""></li>
                <%-- <br>
                <li>
                                                ...
                                                <c:forEach items="${cost.detailList}" var="productCost">
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <span class="fa_content">
                                                                <c:choose>
                                                                    <c:when test="${productCost.totalPrice*1 == 0}">
                                                                        ￥0.00${salePriceValueName}
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <fmt:formatNumber type="number" value="${productCost.totalPrice}" pattern="0.00" maxFractionDigits="2"/>${salePriceValueName}
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </span>
                                                            <i class="fa_icon "></i>
        ...
        <script>
            ...
            var config = {xml:"${pageContext.request.contextPath}/pages/vr720/tourOfMobile.xml", target:"pano", html5:"only", mobilescale:1.0, passQueryParameters:true, onready:krpanoReady};
            embedpano(config);
        </script>
    </div>
</body>
