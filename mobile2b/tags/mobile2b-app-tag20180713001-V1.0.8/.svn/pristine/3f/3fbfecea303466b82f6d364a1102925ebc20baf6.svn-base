...
/**   
 * @Title: SysRoleFunc.java 
 * @Package com.nork.system.model
 * @Description:系统-角色菜单管理
 * @createAuthor pandajun 
 * @CreateDate 2015-05-29 16:46:10
 * @version V1.0   
 */
public class SysRoleFunc  extends Mapper implements Serializable{
...
;
    ...
    /**获取对象的copy**/
    public SysRoleFunc copy(){
       SysRoleFunc obj =  new SysRoleFunc();
