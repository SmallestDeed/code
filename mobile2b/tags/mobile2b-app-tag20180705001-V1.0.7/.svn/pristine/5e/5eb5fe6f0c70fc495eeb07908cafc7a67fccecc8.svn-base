 ...
 * 
 */
public class DesignPlanRecommendedModel extends Mapper implements Serializable {
	...
	public String getIsMainList() {
		return isMainList;
	}

	public void setIsMainList(String isMainList) {
