...
public class ProductReplaceTaskDetail implements Serializable{
	...
	public String getSourceTexturesChooseInfo() {
		return sourceTexturesChooseInfo;
	}

	public void setSourceTexturesChooseInfo(String sourceTexturesChooseInfo) {
		this.sourceTexturesChooseInfo = sourceTexturesChooseInfo;
	}

	public String getDestTexturesChooseInfo() {
		return destTexturesChooseInfo;
	}

	public void setDestTexturesChooseInfo(String destTexturesChooseInfo) {
		this.destTexturesChooseInfo = destTexturesChooseInfo;
	}

	public String getReplaceTexturesParam() {
		return replaceTexturesParam;
	}

	public void setReplaceTexturesParam(String replaceTexturesParam) {
		this.replaceTexturesParam = replaceTexturesParam;
	}
	...
	public Integer getSourcePlanProductId() {
		return sourcePlanProductId;
	}

	public void setSourcePlanProductId(Integer sourcePlanProductId) {
		this.sourcePlanProductId = sourcePlanProductId;
	}
	...
	public String getReplaceSplitTexturesChooseInfo() {
		return replaceSplitTexturesChooseInfo;
	}

	public void setReplaceSplitTexturesChooseInfo(String replaceSplitTexturesChooseInfo) {
		this.replaceSplitTexturesChooseInfo = replaceSplitTexturesChooseInfo;
	}

	public String getReplaceSplitTexturesParam() {
		return replaceSplitTexturesParam;
	}

	public void setReplaceSplitTexturesParam(String replaceSplitTexturesParam) {
		this.replaceSplitTexturesParam = replaceSplitTexturesParam;
	}
	...
	public String toString() {
		return "ProductReplaceTaskDetail [id=" + id + ", taskId=" + taskId + ", sourceProductCode=" + sourceProductCode
				+ ", destProductId=" + destProductId + ", destProductCode=" + destProductCode + ", posIndexPath="
				+ posIndexPath + ", sourceProductId=" + sourceProductId + ", sourcePlanProductId=" + sourcePlanProductId
				+ ", sourceSplitTexturesChooseInfo=" + sourceSplitTexturesChooseInfo
				+ ", replaceSplitTexturesChooseInfo=" + replaceSplitTexturesChooseInfo + ", replaceSplitTexturesParam="
				+ replaceSplitTexturesParam + ", sourceTexturesChooseInfo=" + sourceTexturesChooseInfo
				+ ", destTexturesChooseInfo=" + destTexturesChooseInfo + ", replaceTexturesParam="
				+ replaceTexturesParam + ", creator=" + creator + ", gmtCreate=" + gmtCreate + ", modifier=" + modifier
