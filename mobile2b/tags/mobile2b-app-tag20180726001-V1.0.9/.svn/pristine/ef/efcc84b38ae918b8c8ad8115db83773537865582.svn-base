...
//            }
    ...
    public ResponseEnvelope<DesignPlanRecommendedResult> getPlanRecommendedList(PlanRecommendedListModel model) {
        ...
        if ("decorate".equals(displayType)) {
            ...
            if(baseCompany.getBusinessType() != null && baseCompany.getBusinessType() ==1 && ( sysUser.getUseType()==1
                    || (sysUser.getUseType()==0 && sysUser.getShowSanduPlan()==0))){
            ...
            if(baseCompany.getBusinessType() != null && baseCompany.getBusinessType() ==1 && sysUser.getUseType()==0 &&sysUser.getShowSanduPlan()==1){
                companyIds.add(baseCompany.getId());
                designPlanRecommended.setCompanyId(baseCompany.getId());
            ...
            if(baseCompany.getBusinessType() != null && baseCompany.getBusinessType() ==2 && ( sysUser.getUseType()==1
                    || (sysUser.getUseType()==0 && sysUser.getShowSanduPlan()==0))){
            ...
            if(baseCompany.getBusinessType() != null && baseCompany.getBusinessType() ==2 && sysUser.getUseType()==0
                    && sysUser.getShowSanduPlan()==1 ){
                List<Integer> brandIds = new ArrayList<>();
                if(sanduCompany != null ){
                    companyIds.add(sanduCompany.getId());
                }
