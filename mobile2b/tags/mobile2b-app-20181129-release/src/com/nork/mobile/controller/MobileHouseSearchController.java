...
public class MobileHouseSearchController {
	...
	public Object searchProvinceCodeAndCityCode(@RequestBody HouseSearchModel houseSearchModel) {
		...
		String areaPid=houseSearchModel.getCityCode();
		
		return mobileHouseSearchService.searchProvinceCodeAndCityCode(pid,areaPid);
	}
	...
	public Object newHouseSearch(
		...
		/**areaCode add By WangHaiLin**/
		String areaCode=houseSearchModel.getAreaCode();
		...
		return mobileHouseSearchService.newHouseSearchWeb(provinceCode,
				cityCode,areaCode, livingName, msgId, limit, start, loginUser);
	}
