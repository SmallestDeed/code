...
/**   
 * @Title: SysConsumingRecordsSearch.java 
 * @Package com.nork.system.model
 * @Description:系统模块-消费记录查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-07-18 16:49:19
 * @version V1.0   
 */
public class SysConsumingRecordsSearch extends  SysConsumingRecords implements Serializable{
private static final long serialVersionUID = 1L;
	/**  流水号-模糊查询  **/
	private String sch_SerialNum_;
	/**  流水号-左模糊查询  **/
	private String sch_SerialNum;
	/**  流水号-右模糊查询  **/
	private String schSerialNum_;
	/**  流水号-区间查询-开始字符串  **/
	...
	public  String getSch_SerialNum_() {
		return sch_SerialNum_;
	}
	public void setSch_SerialNum_(String sch_SerialNum_){
		this.sch_SerialNum_ = sch_SerialNum_;
	}
	public  String getSch_SerialNum() {
		return sch_SerialNum;
	}
	public void setSch_SerialNum(String sch_SerialNum){
		this.sch_SerialNum = sch_SerialNum;
	}
	public  String getSchSerialNum_() {
		return schSerialNum_;
	}
	public void setSchSerialNum_(String schSerialNum_){
		this.schSerialNum_ = schSerialNum_;
	}
	public  String getSerialNumStart() {
		return serialNumStart;
	}
	public void setSerialNumStart(String serialNumStart){
		this.serialNumStart = serialNumStart;
	}
	public  String getSerialNumEnd() {
		return serialNumEnd;
	}
	public void setSerialNumEnd(String serialNumEnd){
		this.serialNumEnd = serialNumEnd;
	}
