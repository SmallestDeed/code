...
//		resRenderPic.setFileKey(ResProperties.DESIGNPLAN_RENDER_PIC_FILEKEY);
	...
	public Integer saveRenderPicOf720(DesignPlan designPlan,Map<String, MultipartFile> fileMap, Integer viewPoint,
			...
			Integer panoLevel,String roamJson, Integer sourcePlanId, Integer templateId, Integer needShear,String cameraLocation) {
		/* 在app配置里看当前系统是否为 widows */
		String osType = FileUploadUtils.SYSTEM_FORMAT;
		/* 3dmax文件在渲染机上的目录 */
...
//					flag = FileUploadUtils.saveFile(map);
					...
					if( RenderTypeCode.ROAM_720_LEVEL == renderingType ){
						resPicId = saveRoam720(resRenderPic,storeRealPath,mf,bigFileName,viewPoint,scene,renderingType,loginUser,designPlan,
								panoLevel,resScreenPicId,date, needShear,cameraLocation);
...
//				flag = FileUploadUtils.saveFile(map);
	...
	public int saveRoam720(ResRenderPic resRenderPic, String storeRealPath, MultipartFile mf,
						   String bigFileName, Integer viewPoint, Integer scene, Integer renderingType,
						   LoginUser loginUser,DesignPlan designPlan, Integer panoLevel, Integer resScreenPicId,
						   Date date, Integer needShear,String cameraLocation){
		int resPicId = 0;
		/* 保存渲染文件 */
