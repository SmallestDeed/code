...
//            }
    ...
    public ResponseEnvelope<DesignPlanRecommendedResult> getPlanRecommendedList(PlanRecommendedListModel model) {
        ...
        if(baseCompany.getBusinessType() != null && baseCompany.getBusinessType() != 0
            ...
            BaseCompany company = baseCompanyService.getCompanyByCompanyCode("C0000071");
            if(company != null ){
        ...
        if (total != null && total.intValue() > 0) {
            ...
            if (list != null && list.size() > 0) {
                for (DesignPlanRecommendedResult result : list) {
                    ...
                    ResRenderPic renderPic = resRenderPicService.getResRenderPicByPlanRecommended(result.getPlanRecommendedId(), 1);// 得到最新一张720渲染原图地址
                    if (renderPic != null) {
