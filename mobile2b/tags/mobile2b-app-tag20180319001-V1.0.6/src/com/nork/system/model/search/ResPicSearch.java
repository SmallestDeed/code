...
/**   
 * @Title: ResPicSearch.java 
 * @Package com.nork.system.model
 * @Description:系统-图片资源库查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-05-19 16:06:59
 * @version V1.0   
 */
public class ResPicSearch extends  ResPic implements Serializable{
private static final long serialVersionUID = 1L;
	...
	/**  图片高-模糊查询  **/
	private String sch_PicHigh_;
	/**  图片高-左模糊查询  **/
	private String sch_PicHigh;
	/**  图片高-右模糊查询  **/
	private String schPicHigh_;
	/**  图片高-区间查询-开始字符串  **/
	private String picHighStart;
	/**  图片高-区间查询-结束字符串  **/
	private String picHighEnd;
	/**  图片后缀-模糊查询  **/
	...
	public  String getSch_PicHigh_() {
		return sch_PicHigh_;
	}
	public void setSch_PicHigh_(String sch_PicHigh_){
		this.sch_PicHigh_ = sch_PicHigh_;
	}
	public  String getSch_PicHigh() {
		return sch_PicHigh;
	}
	public void setSch_PicHigh(String sch_PicHigh){
		this.sch_PicHigh = sch_PicHigh;
	}
	public  String getSchPicHigh_() {
		return schPicHigh_;
	}
	public void setSchPicHigh_(String schPicHigh_){
		this.schPicHigh_ = schPicHigh_;
	}
	public  String getPicHighStart() {
		return picHighStart;
	}
	public void setPicHighStart(String picHighStart){
		this.picHighStart = picHighStart;
	}
	public  String getPicHighEnd() {
		return picHighEnd;
	}
	public void setPicHighEnd(String picHighEnd){
		this.picHighEnd = picHighEnd;
	}
