...
//	public static final String KEY_PREFIX = ConfigUtil.getConfig("/dataSource/dataSource", "redis.keyPrefix");
...
//			shardedJedisPool = SpringContextHolder.getBean(ShardedJedisPool.class);
            shardedJedisPool = SpringContextHolder.getBean("shardedJedisPool");
            if (shardedJedisPool == null) {
            } else {
            }
        } else {
     ...
     * @return
     */
    public static String set(String key, String value, String nx, String ex, int cacheSeconds) {
        String result = null;
...
/*	public List<Channel> findAllChannels(){
    ...
    public static String getMap(String key, String field) {
        ...
        try {
            ...
            if (jedis.exists(key)) {
                ...
                logger.info("getMap {} = {}", key, field, value);
            }
        } catch (Exception e) {
            logger.error("getMap {} = {}", key, field, value, e);
        } finally {
            returnResource(jedis);
        }
        return value;
     ...
     * @return 值
     */
    public static long setMap(String key, String field, String value) {
        long result;
        ShardedJedis jedis = null;
        try {
            jedis = getResource();
