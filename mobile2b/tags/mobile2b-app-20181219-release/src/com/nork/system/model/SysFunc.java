 ...
 * @version V1.0   
 */
public class SysFunc  extends Mapper implements Serializable{
...
;
    ...
    public SysFunc copy(){
       ...
       obj.setUrl(this.url);
       obj.setKeyword(this.keyword);
       obj.setIsLeaf(this.isLeaf);
       obj.setIsMenu(this.isMenu);
