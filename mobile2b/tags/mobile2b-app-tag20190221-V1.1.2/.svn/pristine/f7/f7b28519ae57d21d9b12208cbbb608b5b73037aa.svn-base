...
/**   
 * @Title: ProductColors.java 
 * @Package com.nork.product.model
 * @Description:产品色系-产品色系
 * @createAuthor pandajun 
 * @CreateDate 2016-12-14 18:25:53
 * @version V1.0   
 */
public class ProductColors  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        ProductColors other = (ProductColors) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getColorsCode() == null ? other.getColorsCode() == null : this.getColorsCode().equals(other.getColorsCode()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getColorsCode() == null) ? 0 : getColorsCode().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public ProductColors copy(){
       ProductColors obj =  new ProductColors();
       obj.setColorsCode(this.colorsCode);
    ...
    public Map toMap(){
       Map map =  new HashMap();
       map.put("colorsCode",this.colorsCode);
