...
public interface DesignPlanAutoRenderService {
	 ...
	 * “我的设计”查询用户渲染的方案和任务
	 * @author: chenm
	 * @date: 2019/1/23 11:19
	 * @param search
	 * @return: java.util.List<com.nork.design.model.ThumbData>
	 */
	List<ThumbData> getUserRenderPlanAndTaskList(MobileRenderingSearch search);

	Object deleteTaskAndTaskStateByTaskId(Integer taskId,LoginUser loginUser);
