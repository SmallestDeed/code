...
/**   
 * @Title: DesignPlanComment.java 
 * @Package com.nork.design.model
 * @Description:设计方案-评论表
 * @createAuthor pandajun 
 * @CreateDate 2015-07-23 16:35:30
 * @version V1.0   
 */
public class DesignPlanComment  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        DesignPlanComment other = (DesignPlanComment) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getContent() == null ? other.getContent() == null : this.getContent().equals(other.getContent()))
            && (this.getDiscussionprogram() == null ? other.getDiscussionprogram() == null : this.getDiscussionprogram().equals(other.getDiscussionprogram()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDiscussionprogram() == null) ? 0 : getDiscussionprogram().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public DesignPlanComment copy(){
       DesignPlanComment obj =  new DesignPlanComment();
       obj.setUserId(this.userId);
       obj.setContent(this.content);
       obj.setDiscussionprogram(this.discussionprogram);
    ...
    public Map toMap(){
       ...
       map.put("discussionprogram",this.discussionprogram);
