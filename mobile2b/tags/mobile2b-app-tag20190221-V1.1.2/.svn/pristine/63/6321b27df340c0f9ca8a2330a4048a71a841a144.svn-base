...
public class AutoRenderTask implements Serializable {
	...
	private Integer taskType; // 任务类型，默认0= 自动渲染；1=产品替换,2

	private Integer livingId; // 推荐方案信息

	private Integer operationSource;// 操作来源，0，我的设计，1,为推荐方案，2
	...
	public String toString() {
		return "AutoRenderTask{" +
				...
				", overlapResolve=" + overlapResolve +
				", fullHousePlanId=" + fullHousePlanId +
				", planHouseType=" + planHouseType +
				", mainTaskId=" + mainTaskId +
				", houseId=" + houseId +
				", subtaskCount=" + subtaskCount +
				", spaceFunctionId=" + spaceFunctionId +
				", groupPrimaryId=" + groupPrimaryId +
				", limit=" + limit +
				", start=" + start +
				", taskId=" + taskId +
				'}';
