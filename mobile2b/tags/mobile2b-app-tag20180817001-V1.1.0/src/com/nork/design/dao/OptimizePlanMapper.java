...
public interface OptimizePlanMapper {
	...
	List<ProductCostDetail> costDetailPartOne(DesignPlanProduct designPlanProduct);
	List<ProductCostDetail> costDetailPartTwo(List<ProductCostDetail> list);
	List<ProductsCost> newCostList(List<ProductCostDetail> list);
	List<ProductsCostType> newCostTypeList(List<ProductsCost> list);

	Integer getPlatformIdBytaskId(@Param("taskId")Integer taskId);
