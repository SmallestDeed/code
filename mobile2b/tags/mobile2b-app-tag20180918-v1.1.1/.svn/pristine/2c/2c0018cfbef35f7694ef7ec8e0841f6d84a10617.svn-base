...
/**   
 * @Title: SysAuditorUserSearch.java 
 * @Package com.nork.system.model
 * @Description:系统-审核人员和被审核人员绑定表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-12-25 17:34:30
 * @version V1.0   
 */
public class SysAuditorUserSearch extends  SysAuditorUser implements Serializable{
private static final long serialVersionUID = 1L;
	/**  审核类型-模糊查询  **/
	private String sch_AuditType_;
	/**  审核类型-左模糊查询  **/
	private String sch_AuditType;
	/**  审核类型-右模糊查询  **/
	private String schAuditType_;
	/**  审核类型-区间查询-开始字符串  **/
	private String auditTypeStart;
	/**  审核类型-区间查询-结束字符串  **/
	private String auditTypeEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_AuditType_() {
		return sch_AuditType_;
	}
	public void setSch_AuditType_(String sch_AuditType_){
		this.sch_AuditType_ = sch_AuditType_;
	}
	public  String getSch_AuditType() {
		return sch_AuditType;
	}
	public void setSch_AuditType(String sch_AuditType){
		this.sch_AuditType = sch_AuditType;
	}
	public  String getSchAuditType_() {
		return schAuditType_;
	}
	public void setSchAuditType_(String schAuditType_){
		this.schAuditType_ = schAuditType_;
	}
	public  String getAuditTypeStart() {
		return auditTypeStart;
	}
	public void setAuditTypeStart(String auditTypeStart){
		this.auditTypeStart = auditTypeStart;
	}
	public  String getAuditTypeEnd() {
		return auditTypeEnd;
	}
	public void setAuditTypeEnd(String auditTypeEnd){
		this.auditTypeEnd = auditTypeEnd;
	}
