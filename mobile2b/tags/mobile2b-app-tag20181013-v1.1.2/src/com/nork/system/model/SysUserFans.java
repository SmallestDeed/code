...
/**   
 * @Title: SysUserFans.java 
 * @Package com.nork.system.model
 * @Description:系统模块-用户粉丝表
 * @createAuthor pandajun 
 * @CreateDate 2015-08-13 17:34:55
 * @version V1.0   
 */
public class SysUserFans  extends Mapper implements Serializable{
...
@Override
    public boolean equals(Object that) {
        ...
        SysUserFans other = (SysUserFans) that;
...
;
    ...
    /**获取对象的copy**/
    public SysUserFans copy(){
       SysUserFans obj =  new SysUserFans();
       obj.setUserId(this.userId);
       obj.setFansUserId(this.fansUserId);
    ...
    public Map toMap(){
       ...
       map.put("fansUserId",this.fansUserId);
