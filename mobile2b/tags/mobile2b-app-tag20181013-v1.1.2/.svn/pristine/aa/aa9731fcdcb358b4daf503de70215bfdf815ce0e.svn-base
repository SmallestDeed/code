 ...
 * @Package com.nork.design.model
 * @Description:720漫游-渲染漫游
 * @createAuthor pandajun 
 * @CreateDate 2017-07-14 10:45:53
 * @version V1.0   
 */
public class DesignRenderRoam  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
	...
	public  Integer getRoamConfig() {
		return roamConfig;
	}
	public void setRoamConfig(Integer roamConfig){
		this.roamConfig = roamConfig;
	}
   ...
   @Override
    public boolean equals(Object that) {
        ...
        DesignRenderRoam other = (DesignRenderRoam) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRoamConfig() == null ? other.getRoamConfig() == null : this.getRoamConfig().equals(other.getRoamConfig()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRoamConfig() == null) ? 0 : getRoamConfig().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public DesignRenderRoam copy(){
       DesignRenderRoam obj =  new DesignRenderRoam();
       obj.setScreenShotId(this.screenShotId);
       obj.setUuid(this.uuid);
       obj.setRoamConfig(this.roamConfig);
    ...
    public Map toMap(){
       Map map =  new HashMap();
       map.put("screenShotId",this.screenShotId);
       map.put("uuid",this.uuid);
       map.put("roamConfig",this.roamConfig);
