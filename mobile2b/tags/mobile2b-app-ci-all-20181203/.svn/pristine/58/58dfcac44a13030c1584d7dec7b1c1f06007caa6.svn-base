...
;
	...
	public String toString() {
		return "DesignPlanProduct{" +
				...
				", productSmallPicPath='" + productSmallPicPath + '\'' +
				", productU3dModelPath='" + productU3dModelPath + '\'' +
				", productType=" + productType +
				", locationFileId=" + locationFileId +
				", productSequence='" + productSequence + '\'' +
				", materialPicId='" + materialPicId + '\'' +
				", att2='" + att2 + '\'' +
				", att3='" + att3 + '\'' +
				", att4='" + att4 + '\'' +
				", att5='" + att5 + '\'' +
				...
				", templatePlanProductId=" + templatePlanProductId +
				...
				", splitTexturesChooseInfo='" + splitTexturesChooseInfo + '\'' +
				", isSplit=" + isSplit +
				...
				", sameProductTypeIndex=" + sameProductTypeIndex +
				", bgWall=" + bgWall +
				", resIdList=" + resIdList +
				", productPutawayState=" + productPutawayState +
				...
				", isMainStructureProduct=" + isMainStructureProduct +
				", isGroupReplaceWay=" + isGroupReplaceWay +
				", designPlanProductIds=" + designPlanProductIds +
				", wallOrientation='" + wallOrientation + '\'' +
				", wallType='" + wallType + '\'' +
				", groupProductUniqueId='" + groupProductUniqueId + '\'' +
				", platformId=" + platformId +
				", brands='" + brands + '\'' +
				", bigType='" + bigType + '\'' +
				", smallType='" + smallType + '\'' +
				", authorizedConfigList=" + authorizedConfigList +
				'}';
	}
}
