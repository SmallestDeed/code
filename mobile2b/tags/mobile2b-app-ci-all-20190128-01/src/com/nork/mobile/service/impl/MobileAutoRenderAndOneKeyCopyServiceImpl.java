...
public class MobileAutoRenderAndOneKeyCopyServiceImpl implements MobileAutoRenderAndOneKeyCopyService {
	 ...
	 */
	@Override
	public Integer transformAndCopyPlan(Integer planId, LoginUser loginUser, Integer platformId, RenderPicVO renderPicVO) {
		//获取登录用户信息
		DesignPlanRes autoandonekey = optimizePlanService.getAutoRenderDesignPlanRes(planId);
		Integer designPlanSceneId = optimizePlanService.saveAsRenderBakScene(autoandonekey, loginUser,platformId,renderPicVO);//复制到效果图的方案ID
