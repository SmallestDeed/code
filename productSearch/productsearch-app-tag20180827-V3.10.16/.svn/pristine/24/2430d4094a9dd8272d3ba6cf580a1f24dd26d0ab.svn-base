...
public class DesignTemplet extends Mapper implements Serializable {
	...
	public Integer getSmallpoxIdentify() {
		return smallpoxIdentify;
	}

	public void setSmallpoxIdentify(Integer smallpoxIdentify) {
		this.smallpoxIdentify = smallpoxIdentify;
	}

	public Integer getGroundIdentify() {
		return groundIdentify;
	}

	public void setGroundIdentify(Integer groundIdentify) {
