...
public interface StructureProductService {
	...
	public Object createStructureProduct(Integer styleId,Integer isCommon,String regionMark ,String measureCode,String structureCode, String structureName, String templetCode,
			String groupFlag, String config,String msgId,Integer structureSmallType,LoginUser loginUser);
	 ...
	 * @param structureProductSmallpoxIdentify 结构布局标识
	 * @return
	 */
	public Integer easySearch(String measureCode, Integer styleId, Integer structureNumber, Integer structureProductSmallpoxIdentify);
