...
/**   
 * @Title: UserProductConfig.java 
 * @Package com.nork.product.model
 * @Description:用户产品配置-用户产品配置
 * @createAuthor pandajun 
 * @CreateDate 2016-03-28 16:23:01
 * @version V1.0   
 */
public class UserProductConfig  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        UserProductConfig other = (UserProductConfig) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getBrandIds() == null ? other.getBrandIds() == null : this.getBrandIds().equals(other.getBrandIds()))
            && (this.getProductBigType() == null ? other.getProductBigType() == null : this.getProductBigType().equals(other.getProductBigType()))
            && (this.getProductSmallType() == null ? other.getProductSmallType() == null : this.getProductSmallType().equals(other.getProductSmallType()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProductBigType() == null) ? 0 : getProductBigType().hashCode());
        result = prime * result + ((getProductSmallType() == null) ? 0 : getProductSmallType().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public UserProductConfig copy(){
       UserProductConfig obj =  new UserProductConfig();
       obj.setUserId(this.userId);
       obj.setBrandIds(this.brandIds);
       obj.setProductBigType(this.productBigType);
       obj.setProductSmallType(this.productSmallType);
    ...
    public Map toMap(){
       ...
       map.put("productBigType",this.productBigType);
       map.put("productSmallType",this.productSmallType);
    ...
    public String branNames;
    public String productBigTypeNames;
    public String productSmallTypeNames;
	...
	public String getBranNames() {
		return branNames;
	}

	public void setBranNames(String branNames) {
		this.branNames = branNames;
	}

	public String getProductBigTypeNames() {
		return productBigTypeNames;
	}

	public void setProductBigTypeNames(String productBigTypeNames) {
		this.productBigTypeNames = productBigTypeNames;
	}

	public String getProductSmallTypeNames() {
		return productSmallTypeNames;
	}

	public void setProductSmallTypeNames(String productSmallTypeNames) {
		this.productSmallTypeNames = productSmallTypeNames;
	}
