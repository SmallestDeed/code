...
/**   
 * @Title: SysGroupUser.java 
 * @Package com.nork.system.model
 * @Description:系统模块-用户组用户表
 * @createAuthor pandajun 
 * @CreateDate 2015-06-18 18:35:04
 * @version V1.0   
 */
public class SysGroupUser  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
   ...
   @Override
    public boolean equals(Object that) {
        ...
        SysGroupUser other = (SysGroupUser) that;
...
;
    ...
    /**获取对象的copy**/
    public SysGroupUser copy(){
       SysGroupUser obj =  new SysGroupUser();
