...
public class ProductListByTypeInfo implements Serializable{
	...
	public static class PlanProductInfo implements Cloneable{
		/**
		 * 产品id
		 */
		 ...
		 * 结构布局标识
		 */
		private Integer structureProductSmallpoxIdentify;
		...
		public Integer getStructureProductSmallpoxIdentify() {
			return structureProductSmallpoxIdentify;
		}

		public void setStructureProductSmallpoxIdentify(Integer structureProductSmallpoxIdentify) {
	...
	public class PlanStructureInfo{
