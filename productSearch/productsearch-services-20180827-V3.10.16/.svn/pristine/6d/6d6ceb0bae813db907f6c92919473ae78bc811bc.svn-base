...
import com.nork.product.service.impl.BaseProductServiceImpl.SeriesConfig;
import com.nork.product.service.impl.BaseProductServiceImpl.SeriesConfigItem;
...
//		productResult.setProductOrdering(100);
	...
	public Map<String, Object> dealWithSplitTextureInfo(Integer baseProductId, String splitTexturesInfo, String type) {
		...
		try {
			...
			List<SplitTextureInfoDTO> splitTextureList = gson.fromJson(splitTexturesInfo, new TypeToken<List<SplitTextureInfoDTO>>() {}.getType());
...
//				}
	...
	public Integer getPracticableProductInfo(Integer productId, Integer fullPaveLength) throws BizException {
		...
		List<BaseProduct> baseProductList = this.getBaseProductListByProductBatchId(baseProduct.getProductBatchId());
		...
		// 排序,取长度最接近的产品 ->start
		Collections.sort(baseProductList, new Comparator<BaseProduct>() {

			@Override
			public int compare(BaseProduct b1, BaseProduct b2) {
				return Math.abs(Integer.valueOf(b1.getProductLength()) - fullPaveLength) - Math.abs(Integer.valueOf(b2.getProductLength()) - fullPaveLength);
			}
	...
	@Override
	public List<BaseProduct> getBaseProductListByProductBatchId(Integer productBatchId) throws BizException {
		...
		return baseProductMapper.getBaseProductListByProductBatchId(productBatchId);
	}
