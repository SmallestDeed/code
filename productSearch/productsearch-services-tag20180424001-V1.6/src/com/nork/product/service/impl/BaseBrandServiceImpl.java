...
public class BaseBrandServiceImpl implements BaseBrandService {
	...
	@Override
	public List<Integer> getBrandIdsByProductId(Integer productId) {
		// TODO Auto-generated method stub
		return baseBrandMapper.getBrandIdsByProductId(productId);
	}
	 ...
	 */
	@Override
	public List<Integer> getProductOwnBrandIds(Integer productId) {
		return baseBrandMapper.getProductOwnBrandIds(productId);
	}
