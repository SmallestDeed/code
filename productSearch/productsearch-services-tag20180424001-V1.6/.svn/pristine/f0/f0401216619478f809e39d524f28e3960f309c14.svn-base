...
//    private final static ResourceBundle pay = ResourceBundle.getBundle("pay");

//    public static final String appId = pay.getString("wxpay.appid");
//    public static final String appSecret = pay.getString("wxpay.app_secret");

    public static final String appId = "wx9bbed019f8b2f4fb";
    public static final String appSecret = "50100a3b723c00dca2eeb2a3131853bc";
