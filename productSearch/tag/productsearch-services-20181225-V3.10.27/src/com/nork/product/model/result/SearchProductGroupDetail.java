 ...
 *
 */
public class SearchProductGroupDetail implements Serializable,Cloneable{
    ...
    /** 是否是多维材质 0:非多维、1:多维**/
    private Integer isMultidimensional = 0;
    /** 床沿尺寸(存储单位：mm,返回单位 cm) **/
	...
	public Integer getTextureProductModelId() {
		return textureProductModelId;
	}

	public void setTextureProductModelId(Integer textureProductModelId) {
		this.textureProductModelId = textureProductModelId;
	}
    ...
    public Integer getU3dModelId() {
        return u3dModelId;
    }

    public void setU3dModelId(Integer u3dModelId) {
        this.u3dModelId = u3dModelId;
    }

    public int getIsMainProduct() {
        return isMainProduct;
    }

    public void setIsMainProduct(int isMainProduct) {
    ...
    @Override
    public SearchProductGroupDetail clone(){
        try {
            return (SearchProductGroupDetail) super.clone();
