 ...
 * @version V1.0   
 */
public class PrepProductPropsInfo  extends Mapper implements Serializable{
	...
	public PrepProductPropsInfo() {
		super();
	}

	public PrepProductPropsInfo(Integer productId, Integer matchProductId, Integer matchValue, String categoryCode) {
		super();
   ...
   @Override
    public boolean equals(Object that) {
        ...
        PrepProductPropsInfo other = (PrepProductPropsInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getProductId() == null ? other.getProductId() == null : this.getProductId().equals(other.getProductId()))
            && (this.getMatchProductId() == null ? other.getMatchProductId() == null : this.getMatchProductId().equals(other.getMatchProductId()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMatchProductId() == null) ? 0 : getMatchProductId().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public PrepProductPropsInfo copy(){
       PrepProductPropsInfo obj =  new PrepProductPropsInfo();
       obj.setProductId(this.productId);
       obj.setMatchProductId(this.matchProductId);
       obj.setMatchValue(this.matchValue);
    ...
    public Map toMap(){
       ...
       map.put("matchProductId",this.matchProductId);
       map.put("matchValue",this.matchValue);
