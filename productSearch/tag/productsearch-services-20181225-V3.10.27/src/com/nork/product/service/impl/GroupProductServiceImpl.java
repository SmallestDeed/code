...
//  }
    ...
    public ResponseEnvelope<SearchProductGroupResult> getPlanGroupList(Integer designPlanId, Integer start, Integer limit, LoginUser loginUser, String mediaType, String msgId, Integer spaceCommonId, Integer groupId) {
        ...
        if (count > 0) {
            ...
            for (ProductGroupBaseInfoModel groupMode : groupList) {
                ...
                groupProduct.setGroupPrice(groupMode.getGroupPrice());
                //TOD:验证是否无影响
              /*  groupProduct.setSalePrice(groupMode.getGroupPrice());*/
                //组合详情info
                groupProduct = getGroupProductDetails(groupProduct,groupMode.getGroupID(),mediaType,spaceCommonId);
     ...
     * @return
     */
    public SearchProductGroupResult getGroupProductDetails(SearchProductGroupResult groupProduct,
                                                           Integer groupId, String mediaType ,Integer spaceCommonId){
        List<SearchProductGroupDetail> details = null;
        SearchProductGroupDetail groupDetail = null;
        //通过组合id 获取 组合产品,产品基础属性，并且获取相关资源
