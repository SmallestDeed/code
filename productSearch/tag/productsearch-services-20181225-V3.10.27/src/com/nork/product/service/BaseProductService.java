...
public interface BaseProductService {
	...
	/**
	 * 产品组A(代表产品productId = ${productId}),根据全铺长度(fullPaveLength)选取最接近的模型
	 * 
	 * @param productId
	 ...
	 * @throws BizException 
	 */
	List<BaseProduct> getBaseProductListByProductBatchId(Integer productBatchId, Integer fullPaveLength, Integer productHeight) throws BizException;
}
