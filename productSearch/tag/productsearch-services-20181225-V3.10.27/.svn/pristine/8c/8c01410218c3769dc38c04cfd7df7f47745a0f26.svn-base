...
public class BaseSeriesServiceImpl implements BaseSeriesService {
	 ...
	 */
	@Override
	public List<BaseSeries> getbrandSeriesIdListByBrandIdList(List<Integer> brandIdsList) {
		// TODO Auto-generated method stub
		return baseSeriesMapper.getbrandSeriesIdListByBrandIdList(brandIdsList);
	}
