...
public class SplitTextureDTO implements Serializable{
	...
	/*材质list*/
	private List<SplitTextureDTO.ResTextureDTO> list;
	...
	public List<SplitTextureDTO.ResTextureDTO> getList() {
		return list;
	}
	public void setList(List<SplitTextureDTO.ResTextureDTO> list) {
		this.list = list;
	}
	...
	public class ResTextureDTO implements Serializable{
		...
		public ResTextureDTO(Integer id, String path ,String smallPath, Integer textureAttrValue, Integer textureWidth,
				 Integer textureHeight, String laymodes, String materialPath, String normalParam,String normalPath,
