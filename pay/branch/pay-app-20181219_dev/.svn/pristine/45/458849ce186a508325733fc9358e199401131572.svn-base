...
import com.sandu.pay.alipay.service.impl.hb.HbListener;
import com.sandu.pay.alipay.service.impl.hb.TradeListener;
    ...
    public static class ClientBuilder {
        ...
        public AlipayTradeWithHBServiceImpl build() {
            if (StringUtils.isEmpty(gatewayUrl)) {
                gatewayUrl = AlipayConfig.getOpen_api_domain(); // 与mcloudmonitor网关地址不同
            }
            if (StringUtils.isEmpty(appid)) {
                appid = AlipayConfig.getApp_id();
            }
            if (StringUtils.isEmpty(privateKey)) {
                privateKey = AlipayConfig.getPrivate_key();
            }
            ...
            if (StringUtils.isEmpty(alipayPublicKey)) {
                alipayPublicKey = AlipayConfig.getPublic_key();
            }
            if (listener == null) {
