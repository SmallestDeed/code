...
public class TimeInteceptor implements HandlerInterceptor {
	private static Logger logger = LogManager.getLogger(TimeInteceptor.class);
	...
	public void postHandle(HttpServletRequest request,
		...
		if(executeTime>1000){
			logger.error("!!!!!!WARNING!!!!!!...  url executeTime > 1S   [" + handler + "][" + newcurrentURL
	...
	public void afterCompletion(HttpServletRequest request,
		...
		long executeTime = disendTime - endTime;
