...
/**   
 * @Title: GroupCollectDetailsSearch.java 
 * @Package com.nork.product.model
 * @Description:产品模块-组合收藏明细表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2016-06-22 20:41:47
 * @version V1.0   
 */
public class GroupCollectDetailsSearch extends  GroupCollectDetails implements Serializable{
