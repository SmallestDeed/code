package com.nork.pay.wexin.protocol;

import java.lang.reflect.Field;
import java.util.HashMap;
import java.util.Map;

import com.nork.pay.wexin.common.RandomStringGenerator;
import com.nork.pay.wexin.common.Signature;
...
public class UnifiedOrderReqData {
     ...
     */
    public UnifiedOrderReqData(String body,String outTradeNo,int totalFee){
        ...
        setNotify_url(WxConfigure.getNotify_Url());
    ...
    public UnifiedOrderReqData(String body,String outTradeNo,int totalFee,String tradeType, String timeExpire){
