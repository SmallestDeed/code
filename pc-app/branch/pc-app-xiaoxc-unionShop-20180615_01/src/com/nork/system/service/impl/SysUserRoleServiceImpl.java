...
public class SysUserRoleServiceImpl implements SysUserRoleService {
	...
	@Override
	public int getCountByRoleGroup(SysUserRole sysUserRole) {
	    return sysUserRoleMapper.selectCountByRoleGroup(sysUserRole);
	}
    ...
    @Override
    public boolean selectCountByUserIdAndRoleId(Integer userId, Integer roleId) {
        return sysUserRoleMapper.selectCountByUserIdAndRoleId(userId, roleId) > 0 ? true:false;
    }
