...
public class SysFuncServiceImpl implements SysFuncService {
    ...
    public SysFunc getSysFuncByCode(String code) {
      ...
      func.setCode(code);
      func.setIsDeleted(0);
      BasePlatform basePlatform = basePlatformService.findOneByPlatformCode(PlatformConstants.PC_2B);
      if(basePlatform != null) {
        func.setPlatformId(basePlatform.getId());
      }
      List<SysFunc> funcList = this.getList(func);
