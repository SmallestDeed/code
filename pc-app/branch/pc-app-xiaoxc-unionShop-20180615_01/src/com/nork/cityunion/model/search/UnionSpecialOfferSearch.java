...
/**   
 * @Title: UnionSpecialOfferSearch.java 
 * @Package com.nork.cityunion.model
 * @Description:同城联盟-联盟优惠活动表查询对象
 * @createAuthor pandajun 
 * @CreateDate 2018-01-16 18:24:34
 * @version V1.0   
 */
public class UnionSpecialOfferSearch extends  UnionSpecialOffer implements Serializable{
private static final long serialVersionUID = 1L;
	/**  优惠活动名称-模糊查询  **/
	private String sch_SpecialOfferName_;
	/**  优惠活动名称-左模糊查询  **/
	private String sch_SpecialOfferName;
	/**  优惠活动名称-右模糊查询  **/
	private String schSpecialOfferName_;
	/**  优惠活动名称-区间查询-开始字符串  **/
	private String specialOfferNameStart;
	/**  优惠活动名称-区间查询-结束字符串  **/
	private String specialOfferNameEnd;
	/**  优惠活动内容-模糊查询  **/
	private String sch_SpecialOfferContent_;
	/**  优惠活动内容-左模糊查询  **/
	private String sch_SpecialOfferContent;
	/**  优惠活动内容-右模糊查询  **/
	private String schSpecialOfferContent_;
	/**  优惠活动内容-区间查询-开始字符串  **/
	private String specialOfferContentStart;
	/**  优惠活动内容-区间查询-结束字符串  **/
	private String specialOfferContentEnd;
	/**  系统编码-模糊查询  **/
	...
	public  String getSch_SpecialOfferName_() {
		return sch_SpecialOfferName_;
	}
	public void setSch_SpecialOfferName_(String sch_SpecialOfferName_){
		this.sch_SpecialOfferName_ = sch_SpecialOfferName_;
	}
	public  String getSch_SpecialOfferName() {
		return sch_SpecialOfferName;
	}
	public void setSch_SpecialOfferName(String sch_SpecialOfferName){
		this.sch_SpecialOfferName = sch_SpecialOfferName;
	}
	public  String getSchSpecialOfferName_() {
		return schSpecialOfferName_;
	}
	public void setSchSpecialOfferName_(String schSpecialOfferName_){
		this.schSpecialOfferName_ = schSpecialOfferName_;
	}
	public  String getSpecialOfferNameStart() {
		return specialOfferNameStart;
	}
	public void setSpecialOfferNameStart(String specialOfferNameStart){
		this.specialOfferNameStart = specialOfferNameStart;
	}
	public  String getSpecialOfferNameEnd() {
		return specialOfferNameEnd;
	}
	public void setSpecialOfferNameEnd(String specialOfferNameEnd){
		this.specialOfferNameEnd = specialOfferNameEnd;
	}
	public  String getSch_SpecialOfferContent_() {
		return sch_SpecialOfferContent_;
	}
	public void setSch_SpecialOfferContent_(String sch_SpecialOfferContent_){
		this.sch_SpecialOfferContent_ = sch_SpecialOfferContent_;
	}
	public  String getSch_SpecialOfferContent() {
		return sch_SpecialOfferContent;
	}
	public void setSch_SpecialOfferContent(String sch_SpecialOfferContent){
		this.sch_SpecialOfferContent = sch_SpecialOfferContent;
	}
	public  String getSchSpecialOfferContent_() {
		return schSpecialOfferContent_;
	}
	public void setSchSpecialOfferContent_(String schSpecialOfferContent_){
		this.schSpecialOfferContent_ = schSpecialOfferContent_;
	}
	public  String getSpecialOfferContentStart() {
		return specialOfferContentStart;
	}
	public void setSpecialOfferContentStart(String specialOfferContentStart){
		this.specialOfferContentStart = specialOfferContentStart;
	}
	public  String getSpecialOfferContentEnd() {
		return specialOfferContentEnd;
	}
	public void setSpecialOfferContentEnd(String specialOfferContentEnd){
		this.specialOfferContentEnd = specialOfferContentEnd;
	}
