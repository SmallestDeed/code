...
public interface UnionDesignPlanStoreCatoryMapper {
	 ...
	 * 
	 */
    int findStoreCatoryCount(@Param("userId") Integer userId,@Param("catoryName") String catoryName);

    List<UnionDesignPlanStoreCatory> findStoreCatoryList(@Param("userId") Integer userId);
}
