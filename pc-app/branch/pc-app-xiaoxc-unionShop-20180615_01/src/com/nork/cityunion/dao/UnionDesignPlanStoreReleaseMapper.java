...
public interface UnionDesignPlanStoreReleaseMapper {
	 ...
	 * 
	 */
    int updateByStoreRelease(UnionDesignPlanStoreRelease record);

    int findStoreReleaseCount(@Param("catoryId") Integer catoryId, @Param("releaseName") String releaseName
            , @Param("userId") Integer userId, @Param("start") Integer start, @Param("limit") Integer limit);

    List<UnionDesignPlanStoreReleaseVO> findStoreReleaseList(@Param("catoryId") Integer catoryId, @Param("releaseName") String releaseName
            , @Param("userId") Integer userId, @Param("start") Integer start, @Param("limit") Integer limit);

    List<UnionDesignPlanStoreRelease> findStoreReleaseListByDesignSceneId(@Param("designSceneId") Integer designSceneId);
}
