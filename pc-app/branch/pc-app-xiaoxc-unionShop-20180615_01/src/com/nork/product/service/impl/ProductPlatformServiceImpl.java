...
public class ProductPlatformServiceImpl implements ProductPlatformService{
     ...
     * @return
     */
    public Double getGroupSalePrice(Integer groupId){
        ...
        //判断是否存在该组合的售价
        if(StringUtils.isNotEmpty(productPlatform.getSalePrice())){
            salePrice = new Double(productPlatform.getSalePrice());
        }else{
            //不存在获取组合产品售价之和
...
//    private String  picIds;//产品所有图片ID
    ...
    public void getDesignPlanProductResultInfo(int productId,String platformType,DesignPlanProductResult planProduct){
        ...
        planProduct.setSalePrice(productPlatform.getSalePrice());
        planProduct.setProStyleValue(productPlatform.getStyleId());
        planProduct.setSalePriceValue(StringUtils.isNotEmpty(productPlatform.getAdvicePrice())?new Integer(productPlatform.getAdvicePrice()):null);
        planProduct.setSalePriceValueName(this.getSalePriceValueName(productPlatform.getAdvicePrice()));
    }
    ...
    public void getBaseProductInfo(int productId,String platformType,BaseProduct baseProduct){
        ...
        baseProduct.setSalePrice(StringUtils.isNotEmpty(productPlatform.getSalePrice())?new Double(productPlatform.getSalePrice()):null);
        baseProduct.setSalePriceValue(StringUtils.isNotEmpty(productPlatform.getAdvicePrice())?new Integer(productPlatform.getAdvicePrice()):null);
        baseProduct.setSalePriceValueName(this.getSalePriceValueName(productPlatform.getAdvicePrice()));
    ...
    public void getGroupProductResultInfo(int groupId,String platformType,SearchProductGroupResult groupProductResult){
        ...
        //组合总价
        Double totalPrice = this.getGroupSalePrice(groupId);
        groupProductResult.setGroupPrice(totalPrice);
        groupProductResult.setSalePrice(totalPrice);
    ...
    public void getUseCategoryProductResultInfo(int productId,String platformType,CategoryProductResult categoryProductResult){
        ...
        categoryProductResult.setSalePrice(productPlatform.getSalePrice());
        categoryProductResult.setSalePriceValueName(this.getSalePriceValueName(productPlatform.getAdvicePrice()));
    }
    ...
    public void getUseSearchProductGroupResultInfo(int groupId,String platformType,SearchProductGroupResult searchProductGroupResult){
        ...
        //赋值个性数据信息
        searchProductGroupResult.setPicPath(productPlatform.getPicPath());

        //组合总价
        Double totalPrice = this.getGroupSalePrice(groupId);
        searchProductGroupResult.setGroupPrice(totalPrice);
        searchProductGroupResult.setSalePrice(totalPrice);
    }
    ...
    public void getUserProductsConllectInfo(int productId,String platformType,UserProductsConllect userProductsConllect){
        ...
        userProductsConllect.setSalePrice(StringUtils.isNotEmpty(productPlatform.getSalePrice()) ? new Double(productPlatform.getSalePrice()) : 0);
        userProductsConllect.setSalePriceValueName(this.getSalePriceValueName(productPlatform.getAdvicePrice()));
    }
    ...
    public void getGroupProductCollectInfo(int groupId,String platformType,GroupProductCollect groupProductCollect){
        ...
        //组合总价
        Double salePrice = this.getGroupSalePrice(groupProductCollect.getGroupId());
    ...
    public void getProductCostDetailInfo(int productId,String platformType,ProductCostDetail productCostDetail){
        ...
        productCostDetail.setUnitPrice(StringUtils.isNotEmpty(productPlatform.getSalePrice()) ? new BigDecimal(productPlatform.getSalePrice()) : new BigDecimal(0));
        productCostDetail.setTotalPrice(null != productCostDetail.getCount() ? productCostDetail.getUnitPrice().multiply(new BigDecimal(productCostDetail.getCount())) : productCostDetail.getUnitPrice());
