...
public class GroupProductDetailsServiceImpl implements GroupProductDetailsService {
	 ...
	 */
	@Override
	public String getGroupProductTexturesInfo(Integer groupId, Integer productId, String posIndexPath) {
		return groupProductDetailsMapper.getGroupProductTexturesInfo(groupId,productId,posIndexPath);
	}

	@Override
	public List<GroupProductDetails> findMainProductInfoByIdList(List<Integer> groupIdList) {
		// 参数验证 ->start
		...
		return groupProductDetailsMapper.findMainProductInfoByIdList(groupIdList);
	}
