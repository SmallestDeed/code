...
/**   
 * @Title: SysFuncSearch.java 
 * @Package com.nork.system.model
 * @Description:系统-功能菜单查询对象
 * @createAuthor pandajun 
 * @CreateDate 2015-05-28 10:10:35
 * @version V1.0   
 */
public class SysFuncSearch extends  SysFunc implements Serializable{
private static final long serialVersionUID = 1L;
	...
	/**  菜单路径-模糊查询  **/
	private String sch_Url_;
	/**  菜单路径-左模糊查询  **/
	private String sch_Url;
	/**  菜单路径-右模糊查询  **/
	private String schUrl_;
	/**  菜单路径-区间查询-开始字符串  **/
	private String urlStart;
	/**  菜单路径-区间查询-结束字符串  **/
	private String urlEnd;
	/**  关键字-模糊查询  **/
	private String sch_Keyword_;
	/**  关键字-左模糊查询  **/
	private String sch_Keyword;
	/**  关键字-右模糊查询  **/
	private String schKeyword_;
	/**  关键字-区间查询-开始字符串  **/
	...
	public  String getSch_Url_() {
		return sch_Url_;
	}
	public void setSch_Url_(String sch_Url_){
		this.sch_Url_ = sch_Url_;
	}
	public  String getSch_Url() {
		return sch_Url;
	}
	public void setSch_Url(String sch_Url){
		this.sch_Url = sch_Url;
	}
	public  String getSchUrl_() {
		return schUrl_;
	}
	public void setSchUrl_(String schUrl_){
		this.schUrl_ = schUrl_;
	}
	...
	public  String getSch_Keyword_() {
		return sch_Keyword_;
	}
	public void setSch_Keyword_(String sch_Keyword_){
		this.sch_Keyword_ = sch_Keyword_;
	}
	...
	public  String getSchKeyword_() {
		return schKeyword_;
	}
	public void setSchKeyword_(String schKeyword_){
		this.schKeyword_ = schKeyword_;
	}
