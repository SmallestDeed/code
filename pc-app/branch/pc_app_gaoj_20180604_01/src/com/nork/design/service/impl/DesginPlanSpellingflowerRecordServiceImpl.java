...
//		filePath = FileUploadUtils.UPLOAD_ROOT+filePath;
	 ...
	 */
	@Override
	public ResponseEnvelope<DesginPlanSpellingflowerRecord> getPaginatedList(DesginPlanSpellingflowerRecordSearch recordSearch,LoginUser loginUser) {
		...
		if(null!=recordList&&recordList.size()>0){
			try {
				...
				for(int i = 0;i<recordList.size();i++){
					...
					//4.获取当期拼花所对应的产品map集合
					Map<String,Object> spellingFlowerProductMap = this.spellingFlowerData(productIds,loginUser);
					//5.设值到当前对象
