 ...
 * @version V1.0   
 */
public class UnionDesignPlanStore  extends Mapper implements Serializable{
private static final long serialVersionUID = 1L;
    ...
    public boolean equals(Object that) {
        ...
        UnionDesignPlanStore other = (UnionDesignPlanStore) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getDesignPlanId() == null ? other.getDesignPlanId() == null : this.getDesignPlanId().equals(other.getDesignPlanId()))
            && (this.getDesignPlanName() == null ? other.getDesignPlanName() == null : this.getDesignPlanName().equals(other.getDesignPlanName()))
            && (this.getDesignPlanType() == null ? other.getDesignPlanType() == null : this.getDesignPlanType().equals(other.getDesignPlanType()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getBrandId() == null ? other.getBrandId() == null : this.getBrandId().equals(other.getBrandId()))
            && (this.getRenderPicId() == null ? other.getRenderPicId() == null : this.getRenderPicId().equals(other.getRenderPicId()))
            && (this.getRenderPicSmallId() == null ? other.getRenderPicSmallId() == null : this.getRenderPicSmallId().equals(other.getRenderPicSmallId()))
...
;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDesignPlanName() == null) ? 0 : getDesignPlanName().hashCode());
        result = prime * result + ((getDesignPlanType() == null) ? 0 : getDesignPlanType().hashCode());
        result = prime * result + ((getUserId() == null) ? 0 : getUserId().hashCode());
        result = prime * result + ((getBrandId() == null) ? 0 : getBrandId().hashCode());
        result = prime * result + ((getRenderPicId() == null) ? 0 : getRenderPicId().hashCode());
        result = prime * result + ((getRenderPicSmallId() == null) ? 0 : getRenderPicSmallId().hashCode());
...
;
    ...
    /**获取对象的copy**/
    public UnionDesignPlanStore copy(){
       UnionDesignPlanStore obj =  new UnionDesignPlanStore();
       obj.setDesignPlanId(this.designPlanId);
       obj.setDesignPlanName(this.designPlanName);
       obj.setDesignPlanType(this.designPlanType);
       obj.setUserId(this.userId);
       obj.setBrandId(this.brandId);
       obj.setRenderPicId(this.renderPicId);
       obj.setRenderPicSmallId(this.renderPicSmallId);
    ...
    public Map toMap(){
       ...
       map.put("designPlanName",this.designPlanName);
       map.put("designPlanType",this.designPlanType);
       map.put("userId",this.userId);
       map.put("brandId",this.brandId);
       map.put("renderPicId",this.renderPicId);
       map.put("renderPicSmallId",this.renderPicSmallId);
