...
public class BaseHouseServiceImpl implements BaseHouseService {
	...
	@Override
	public List<BaseHouseResult> getHouseList(BaseHouseResult baseHouseResultSearch) {
	    
		List<BaseHouseResult> baseHouseResults = baseHouseMapper.findHouseSearchList(baseHouseResultSearch);
