...
public interface BaseWaterjetTemplateMapper {
    ...
    BaseWaterjetTemplate getMoreInfoById(@Param("id") Integer id);

    List<BrandNameVO> selectBrandNameList(@Param("userId") int userId, @Param("userType")Integer userType);

    List<BrandNameVO> selectBrandNameListByUser(@Param("userId") int userId, @Param("userType")Integer userType);

    List<SysDictionaryVo> selectSysDictionaryList();
