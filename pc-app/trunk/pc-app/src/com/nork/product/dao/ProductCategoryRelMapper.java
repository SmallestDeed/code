...
public interface ProductCategoryRelMapper {
	 ...
	 * @return
	 */
	List<ProductCategoryInfo> selectXingxCategoryProductInfo(@Param("productId") Integer productId, @Param("start") Integer start, @Param("limit") Integer limit);
	 ...
	 * @return
	 */
	CategoryProductRel getCategoryProductInfo(@Param("longCode") String longCode, @Param("name") String name, @Param("productId") Integer productId);
	 ...
	 * @return
	 */
	int batchAdd(@Param("list") List<ProductCategoryRel> list);
}
