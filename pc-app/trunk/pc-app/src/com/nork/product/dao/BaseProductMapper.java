...
public interface BaseProductMapper {
    ...
    BaseProduct findDataByCode(@Param("productCode") String productCode);
	 ...
	 //批量查询
	List<BaseProduct> getBatchData(@Param("list")List<Integer> list,@Param("putawayStateList")List<Integer> putawayStateList);
	...
	List<CategoryProductResult> selectProductEasyV2(BaseProductSearch baseProductSearch);

	List<CategoryProductResult> getHandleProductData(@Param("putawayStateList")List<Integer> putawayStateList,
								 					 @Param("seriesId")Integer seriesId,
													 @Param("attributeType")String attributeType,
													 @Param("attributeValueKey")String attributeValueKey);

	List<CategoryProductResult> getSimpleInfoByProductCode(@Param("productCodeList") List<String> productCodeList);

	List<SearchProductGroupDetail> getBgWallByFullPaveLengthAndStyleV2(BaseProduct searchProduct);
	...
	CategoryProductResult getDetailById(@Param("id") Integer id,@Param("userId") Integer userId);
	...
	ProductCeilingVO getCeilingInfoByProductId(@Param("id") Integer id);
	 ...
	 * @return
	 */
	List<ProductCeilingVO> getCeilingCrossSectionDataByStyleId(@Param("putawayStateList")List<Integer> putawayStateList, @Param("styleId")Integer styleId);
	 ...
	 * @return
	 */
	List<ProductCeilingVO> getCeilingInfoByProductCode(@Param("productCode") String productCode);

	ProductPlatform selectProductPlatformInfo(@Param("productId") int productId,@Param("platformType") String platformType);

	ProductPlatform selectGroupProductPlatformInfo(@Param("groupid") int groupid,@Param("platformType") String platformType);

    List<CeilingCrossDataResult> selectCeilingCrossData(@Param("styleList") List<String> styleList);

	List<SearchProductGroupDetail> getSearchProductGroupDetailListByProductIdList(@Param("productIdList") List<Integer> productIdList);

	List<UnityPlanProductresTexture> selectCountertopsTextureList(@Param("productId") Integer productId);

	ProductInfo selectProdutctInfoById(@Param("id") Integer id);
}
