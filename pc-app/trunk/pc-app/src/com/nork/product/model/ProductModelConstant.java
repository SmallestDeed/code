...
public class ProductModelConstant {
	 ...
	 * 默认天花截面天花数据Id
	 */
	public static final String DEFAULT_JIEM_TIANH_PRODUCT_CODE = Utils.getValueByFileKey(AppProperties.APP, AppProperties.DEFAULT_JIEM_TIANH_PRODUCT_CODE,"wu_jiem_0001");
