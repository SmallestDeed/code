...
//	private CategoryProductResult basicBedding;
    ...
    /**产品描述  相当于base_product表的product_desc*/
    private String productDesc;
    /**产品价格      相当于base_product表的sale_price*/
    private Double totalPrice;

    //放置点类型code(柜门把手)
    private String placePointCode;

    /**
     * 没有意义,通过前端获取的数据,再返给前端
     */
	 ...
	 * 橱柜信息数据
	 */
	private List<BaseProductCountertops> baseProductCountertops;

	private Integer windowsModelId;
	...
	public Double getBedsideDimensions() {
		return bedsideDimensions;
	}

	public void setBedsideDimensions(Double bedsideDimensions) {
		this.bedsideDimensions = bedsideDimensions;
	}

	public Integer getWindowsModelId() {
		return windowsModelId;
	}

	public void setWindowsModelId(Integer windowsModelId) {
		this.windowsModelId = windowsModelId;
	}

	public List<BaseProductCountertops> getBaseProductCountertops() {
		return baseProductCountertops;
	}

	public void setBaseProductCountertops(List<BaseProductCountertops> baseProductCountertops) {
		this.baseProductCountertops = baseProductCountertops;
	}
	...
	public String getPlacePointCode() {
		return placePointCode;
	}

	public void setPlacePointCode(String placePointCode) {
		this.placePointCode = placePointCode;
	}
