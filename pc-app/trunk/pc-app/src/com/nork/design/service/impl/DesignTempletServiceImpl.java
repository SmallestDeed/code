...
//			}
	 ...
	 */
	@Override
	public List<Integer> findIdListBySpaceCommonId(Integer spaceFunctionId){
		return designTempletMapper.findIdListBySpaceCommonId(spaceFunctionId);
	}
	 ...
	 */
	@Override
	public List<String> findListByDesignTempletId(Integer designTempletId){
		return designTempletMapper.findListByDesignTempletId(designTempletId);
	}

	public List<DesignPlanTem> getDesignPlnaTem(String startDate, String endDate){
		return designTempletMapper.selectDesignPlnaTem(startDate,endDate);
	}
}
