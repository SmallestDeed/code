...
public interface DesignPlanProductRenderSceneMapper {
	...
	List<DesignPlanProductRenderScene> getListByPlanIdAndIsDeleted(@Param("planId") Integer planId, @Param("isDeleted") Integer isDeleted);

	List<DesignPlanProductRenderScene> getMianGroupProductInfo(@Param("id") Integer id);
	 ...
	 */
	List<DesignRenderGroup> selectDesignPlanRenderGroupList(@Param("sceneId") Integer sceneId);
}
