...
public interface DesignTempletMapper {
	...
	List<Integer> findIdListBySpaceCommonId(@Param("spaceFunctionId") Integer spaceFunctionId);

	List<String> findListByDesignTempletId(@Param("designTempletId") Integer designTempletId);

	List<DesignPlanTem> selectDesignPlnaTem(@Param("startDate")String startDate,@Param("endDate") String endDate);
}
