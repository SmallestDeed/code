...
public class DesignPlan extends Mapper implements Serializable {
	 ...
	 * 合同号  pactNo
	 * 客户名称  clientName
	 * 搜索合同号和客户名称关键字  searchKeyword
	 * 归类排序（按合同号归类：1，按客户归类：2）
	 */
	private String pactNo;
	private String clientName;
	private String searchKeyword;
	private Integer classifiedSort;
	...
	public Integer getClassifiedSort() {
		return classifiedSort;
	}

	public void setClassifiedSort(Integer classifiedSort) {
		this.classifiedSort = classifiedSort;
	}
