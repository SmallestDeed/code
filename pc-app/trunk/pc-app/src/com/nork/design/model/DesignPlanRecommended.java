...
//	/**  模型文件id  **/
   ...
   /**设计方案封面*/
	...
	private Integer userType;//判断用户类型
	...
	/**
	 * 是否有查看测试方案的权限
	 * add by chenm 20180516
	 */
	private String planrecommendedConner;
	
	/**
	 * 是否有查看审核方案的权限
	 *  add by chenm 20180516
	 */
	private String planrecommendedChecker;
	/**end<<*/
	...
	/**
	 * 空间布局类型
	 * A、方案中只有浴缸（嵌入式浴缸、独立式浴缸）
	 * B、方案中只有淋浴房（一字型淋浴房、淋浴房）
	 * AB、方案中既有浴缸也有淋浴房
	 * N、方案既没有浴缸也没有淋浴房
	 */
	...
	/**推荐方案该公司Id, 作为条件查询(查询包含为空的数据)**/
	private Integer search_CompanyId;
	 ...
	 * 三度企业id
	 */
	private Integer sanduCompanyId;
	...
	public List <Integer> getRecommendedTypes() {
		return recommendedTypes;
	}

	public void setRecommendedTypes(List <Integer> recommendedTypes) {
		this.recommendedTypes = recommendedTypes;
	}
	
	public Integer getSearch_CompanyId() {
		return search_CompanyId;
	}
	
	public void setSearch_CompanyId(Integer search_CompanyId) {
		this.search_CompanyId = search_CompanyId;
	}
	...
	public Integer getSanduCompanyId() {
		return sanduCompanyId;
	}

	public void setSanduCompanyId(Integer sanduCompanyId) {
		this.sanduCompanyId = sanduCompanyId;
	}
    ...
    public String getPlanrecommendedConner() {
      return planrecommendedConner;
    }
    public void setPlanrecommendedConner(String planrecommendedConner) {
      this.planrecommendedConner = planrecommendedConner;
    }
    public String getPlanrecommendedChecker() {
      return planrecommendedChecker;
    }
    public void setPlanrecommendedChecker(String planrecommendedChecker) {
      this.planrecommendedChecker = planrecommendedChecker;
    }
