...
public class ThreadPoolConfig implements ILifeCycle {
	...
	protected final static int COREPOOL_SIZE = 6; //核心线程数
	
	protected final static int MAXPOOL_SIZE = 30; // 最大线程数
	
	protected final static long KEEPALIVETIME = 15L;//线程成活时间
	
	protected final static int WORKQUEUE_SIZE= 100000;//工作队列大小
