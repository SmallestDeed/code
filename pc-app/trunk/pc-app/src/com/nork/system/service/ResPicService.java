...
public interface ResPicService {
	 ...
	 * @param renderingType
	 */
	Integer savePlanRenderPicOfPhot(Integer planId, List<Map> list, String level, Integer renderingType,Integer sourcePlanId, Integer templateId);
