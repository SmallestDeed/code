...
public class ThumbnailUtil {
    ...
    public static boolean createThumbnail(String fileUrl, String outputFolder,Integer toWidth,Integer toHight) throws IOException {
        ...
        if (!originalFile.exists()) {
            logger.error("原路径不存在fileUrl:{}", fileUrl);
            return false;
        }
