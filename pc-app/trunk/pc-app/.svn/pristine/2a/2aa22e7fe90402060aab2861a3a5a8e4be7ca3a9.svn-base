...
public interface DesignPlanProductService {
	...
	List<ProductsCost> costListShare(ProductsCostType productsCostType);
	...
	List<ProductCostDetail> costDetailShare(ProductsCost cost);
	/**
	 * 通过挂接点，更新产品列表
	 */
	...
	int costTypeListCountShare(DesignPlanProduct designPlanProduct);
	...
	List<ProductsCostType> costTypeListShare(DesignPlanProduct designPlanProduct);
	 ...
	 * @return
	 */
	boolean updatePlanProducts(String planProductJson, Integer planId, String needDelPlanProductIds, LoginUser loginUser);

	/**
	 * 对多材质信息容错(应对产品编辑了多材质这种情况)
	 * 
	 * @author huangsongbo
	 ...
	 * @return
	 */
	/*public String getCorrectSplitTexturesInfo(String splitTexturesInfo, Integer productId);*/
	 /*
     * 根据当前用户获取产品可见范围
     * */
    List<String> scopeProductByuserId(Integer userId);
