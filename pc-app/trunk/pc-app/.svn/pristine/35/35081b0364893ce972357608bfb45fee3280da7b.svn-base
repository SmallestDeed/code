...
public interface DesignTempletService {
	 ...
	 * @return
	 */
	List<Integer> findIdListBySpaceCommonId(Integer spaceFunctionId);
	 ...
	 * @return
	 */
	List<String> findListByDesignTempletId(Integer designTempletId);


	List<DesignPlanTem> getDesignPlnaTem(String startDate,String endDate);
}
