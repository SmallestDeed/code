 ...
 * @version V1.0   
 */
public class ResModel  extends Mapper implements Serializable{
...
;
	...
	/** 转换状态 ING 转换中,SUCCESS 转换成功，FAIL 转换失败 **/
	...
	public String getModelModelNum() {
		return modelModelNum;
	}

	public void setModelModelNum(String modelModelNum) {
		this.modelModelNum = modelModelNum;
	}
	...
	public String getFile3duPath() {
		return file3duPath;
	}

	public void setFile3duPath(String file3duPath) {
		this.file3duPath = file3duPath;
	}
	...
	public String getSmallTypeMark() {
		return smallTypeMark;
	}

	public void setSmallTypeMark(String smallTypeMark) {
		this.smallTypeMark = smallTypeMark;
	}
	...
	public void setMainModelFlag(String mainModelFlag) {
		this.mainModelFlag = mainModelFlag;
	}
}
