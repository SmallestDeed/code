...
private static final long serialVersionUID = 1L;
	...
	private String newOrginalPicPath;

	public String getNewOrginalPicPath() {
		return newOrginalPicPath;
	}

	public void setNewOrginalPicPath(String newOrginalPicPath) {
		this.newOrginalPicPath = newOrginalPicPath;
	}
	...
	public void setNoIdList(List<Integer> noIdList) {
