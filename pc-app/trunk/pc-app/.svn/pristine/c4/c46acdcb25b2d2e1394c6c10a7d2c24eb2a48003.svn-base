...
public interface ResTextureService {
	...
	/**
	 * 通过材质id,查询材质信息,组装成bean(SplitTextureDTO)
	 *
	 * @author huangsongbo
	 * @param id 材质id
	...
	List<UnityPlanProductresTexture> getProductResTextureList(List<Integer> resTextureIdList);
	 ...
	 * @return
	 */
	ResTexturePo getTextureInfoById(Integer id);
}
