...
//	public List<GroupProduct> getGroupListByStructureId(GroupProductSearch groupSearch);
	 ...
	 * @return
	 */
	List<GroupProductDetails> getBuildingHomeGroupList(BaseBrandSearch ResBrand);
	 ...
	 * @return
	 */
	int getBuildingHomeGroupCount(BaseBrandSearch ResBrand);
	 ...
	 * @return
	 */
	String getGroupConfigByGroupId(Integer groupId);
	 ...
	 * @return
	 */
	int getCountByGroupIdList(List<Integer> groupIdList);
	
	/**
	 * 自动生成组合编码
	 * @return
	 */
	String  createNewGroupProductCode();
