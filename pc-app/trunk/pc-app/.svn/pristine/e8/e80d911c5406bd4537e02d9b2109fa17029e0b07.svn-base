...
public interface DesignPlanProductRenderSceneService {
	 ...
	 * @param designPlanProductRenderScene
	 */
	List<ProductsCostType> costList(LoginUser loginUser, DesignPlanProduct designPlanProduct);
	 ...
	 * @return
	 */
	DesignPlanProductRenderScene get(Integer id);
	 ...
	 * @return
	 */
	List<String> findListBySceneId(Integer designPlanRenderSceneId);
	 ...
	 * @throws BizException 
	 */
	public List<DesignPlanProductRenderScene> getMianGroupProductInfo(Integer sceneId) throws BizException;


	/**
	 * 根据效果图组合方案id 查询组合方案列表
	 * @author chenqiang
	 * @param sceneId 主方案id
	 * @return
	 * @date 2018/8/13 0013 14:01
	 */
	List<DesignRenderGroup> getDesignPlanRenderGroupList(Integer sceneId);
}
