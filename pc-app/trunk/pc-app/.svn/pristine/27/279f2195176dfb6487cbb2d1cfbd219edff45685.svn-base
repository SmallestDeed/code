...
public class DesignPlanRenderScene  extends Mapper implements Serializable{
	...
	/** 组合方案列表 */
	private List<DesignRenderGroup> groupList;
...
//	private Integer nightFileId;
    ...
    /**
     * 该效果图对应的普通方案(测试中/已发布/审核中)的id
     * add by huangsongbo
     */
	private Integer dprCommonId;
	
	/**
	 * 该效果图对应的智能方案(测试中/已发布/审核中)的id
	 * add by huangsongbo
	 */
	private Integer dprCapacityId;

	/**
     * add by huangsongbo 2018.6.8
     * 水刀配置
     */
    private String waterjetInfo;
	
    /**
     * 该效果图对应推荐方案的所属公司（用于过滤推荐方案）
     * add by chenm 20180626
     */
    private Integer dprCompanyId;


	/** 普通方案对应效果图方案状态 */
    private Integer dprIsReleaseO;


	/** 推荐方案对应效果图方案状态 */
    private Integer dprIsReleaseT;


	public Integer getDprIsReleaseO() {
		return dprIsReleaseO;
	}

	public void setDprIsReleaseO(Integer dprIsReleaseO) {
		this.dprIsReleaseO = dprIsReleaseO;
	}

	public Integer getDprIsReleaseT() {
		return dprIsReleaseT;
	}

	public void setDprIsReleaseT(Integer dprIsReleaseT) {
		this.dprIsReleaseT = dprIsReleaseT;
	}

	public String getIsReleaseR() {
		return isReleaseR;
	}

	public void setIsReleaseR(String isReleaseR) {
		this.isReleaseR = isReleaseR;
	}

	public List<DesignRenderGroup> getGroupList() {
		return groupList;
	}

	public void setGroupList(List<DesignRenderGroup> groupList) {
	...
	public Integer getDprCompanyId() {
      return dprCompanyId;
    }

    public void setDprCompanyId(Integer dprCompanyId) {
      this.dprCompanyId = dprCompanyId;
    }
	...
	public Integer getDprCommonId() {
		return dprCommonId;
	}

	public void setDprCommonId(Integer dprCommonId) {
		this.dprCommonId = dprCommonId;
	}

	public Integer getDprCapacityId() {
		return dprCapacityId;
	}

	public void setDprCapacityId(Integer dprCapacityId) {
		this.dprCapacityId = dprCapacityId;
	}
...
//         obj.setDesignPlanRenderPicIds(this.designPlanRenderPicIds);
        ...
        /*obj.setCoverPicId(this.coverPicId);*/
         ...
         obj.setWaterjetInfo(this.waterjetInfo);
         return obj;
    }
