...
public interface BaseProductService {
	 ...
	 * @return
	 */
	CategoryProductResult decorationProductInfo(CategoryProductResult productResult,BaseProduct baseProduct,DesignPlan designPlan
			,DesignPlanProduct designPlanProduct,Map<String,AutoCarryBaimoProducts> autoCarryMap, LoginUser loginUser);
	
	CategoryProductResult assemblyUnityPanProduct(Integer productId,Integer spaceCommonId,DesignPlan designPlan,Integer userId,String mediaType);
...
//			Map<String, AutoCarryBaimoProducts> autoCarryMap, Map<String, String> map, DesignPlan designPlan, DesignPlanProduct designPlanProduct, HttpServletRequest request);
	...
	/**
	 * 定制搜索接口
	 * 专为替换浴缸/面盆,要把水龙头带上的功能定制的搜索(水龙头)接口
	 * 
	 * @author huangsongbo
	 ...
	 * @return
	 */
	public List<CategoryProductResult> searchProductForReplaceTub(String smallType, LoginUser loginUser);
	 ...
	 * @return
	 */
	List<CategoryProductResult> getHandleProductData(List<Integer> putawayStateList, Integer seriesId, String attributeType, String attributeValueKey);
	 ...
	 * @return
	 */
	List<CategoryProductResult> getSimpleInfoByProductCode(List<String> productCodeList);
	 ...
	 * @param putawayStateList
	 */
	void getProductCeilingVO(BaseProduct baseProduct, List<Integer> putawayStateList);
     ...
     *  add by chenm 20180605
	 * @return
	 * @throws BaseProductException 
	 */
	Object updateProductGroup(String groupCode, Integer designPlanId,Integer spaceCommonType, String config, Integer isBmGroup, String msgId,
	      HttpServletRequest request, String structureCode, String spaceCommonTypeCode, String designTempletCode, Integer groupType,
	      Integer isMainProductId,Integer compositeTypeValue, MultipartFile  coverPicFile,String authorization) throws Exception ;
	 ...
	 * @throws IOException
	 */
	Integer locationTxt(String config,LoginUser loginUser,GroupProduct groupProduct) throws IOException;

    List<CeilingCrossDataResult> getCeilingCrossDataByStyleId(List<String> styles);
     ...
     * @throws ElasticSearchException 
     */
	List<SearchProductGroupDetail> selectFromEs(BaseProduct searchProduct) throws BizException, ElasticSearchException;
	 ...
	 * @return
	 */
	List<SearchProductGroupDetail> getSearchProductGroupDetailListByProductIdList(List<Integer> productIdList);

	List<UnityPlanProductresTexture> getCountertopsTextureList(Integer productId);

	ProductInfo getProdutctInfoById(Integer id);
	 ...
	 * @return
	 */
	List<ProductCeilingVO> getCeilingInfoByProductIds(List<Integer> productIdsList);
	ProductCeilingVO getCeilingInfoByProductId(Integer id);
}
