...
//			costList = designPlanProductService.costList(designPlanProduct);
	...
	public Object costListWeb(DesignPlanProduct designPlanProduct,
        ...
        }else if (14==loginUser.getUserType()){
			baseBrand = baseBrandService.findBrandIdByUserIdDuli(loginUser);
		}
		...
		//只过滤2 和3 和 14 的用户
		if(loginUser.getUserType() != 2 && loginUser.getUserType() != 3 && loginUser.getUserType() != 14){
			flag = true;
		}
