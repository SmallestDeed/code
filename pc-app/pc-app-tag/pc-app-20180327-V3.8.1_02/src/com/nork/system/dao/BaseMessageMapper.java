...
public interface BaseMessageMapper {
    ...
    int selectCountAllMessage(BaseMessageSearch baseMessageSearch);
    
    int selectCountUnreaded(BaseMessageSearch baseMessageSearch);
    
	List<BaseMessage> selectPaginatedList(
			BaseMessageSearch baseMessageSearch);
	
	List<BaseMessage> selectAllMessage(
			BaseMessageSearch baseMessageSearch);
