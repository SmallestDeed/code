...
//            order.setOrderAmount(BigDecimal.ONE);
    ...
    public ResponseEnvelope initMiniCode(MiniParam param, HttpServletResponse response) throws Exception {
        ...
        ResponseEntity<byte[]> responseEntity = restTemplate.postForEntity("https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=" + accessToken, paramJson, byte[].class);
