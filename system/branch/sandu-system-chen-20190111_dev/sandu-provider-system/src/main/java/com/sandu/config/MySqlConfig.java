...
//        sqlSessionFactoryBean.setTypeAliasesPackage("com.sandu.*.mapper");
 //       sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath*:com/sandu/*/*/mapper/*.xml"));
        ...
        Resource[] r1 = resolver.getResources("classpath*:com/sandu/*/*/mapper/*.xml");
        Resource[] r2 = resolver.getResources("classpath*:com/sandu/*/*/*/mapper/*.xml");
        Resource[] r = new Resource[r1.length + r2.length];
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.sandu.*.*.dao,com.sandu.*.*.*.dao");
