...
public interface BaseBannerAdService {
    ...
    Object saveBannerAd(BaseBannerAdAdd baseBannerAdAdd, LoginUser loginUser, String platfromCode);

    PageInfo<BaseBannerAd> getSXWIndexBannerList(String positionCode,Integer page,Integer limit);

    int updateSXWBanner(BaseBannerAdUpdate baseBannerAdUpdate);

    int changeBannerIsEnable(Integer bannerId, LoginUser loginUser);
}
