...
public class CompanyShopAdd implements Serializable {
    ...
    public CompanyShop getCompanyShop() {
        ...
        if (serviceArea != null){
            companyShop.setServiceArea(this.serviceArea);
        }
        if (businessShopDecorationType != null){
            companyShop.setBusinessShopDecorationType(this.businessShopDecorationType);
        }
        return companyShop;
    }
