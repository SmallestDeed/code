...
public interface ServicesAccountRelService {
	...
	int batchInsertServiceAccount(List<ServicesAccountRel> accountList);
	...
	List<ServicesAccountRel> selectByServicesRecordId(Integer id);

	PageInfo<ServicesAccountRel> queryByOptionForPage(ServiceInnerUserQuery query);
}