...
//		ops.set(redisKey, listJson, 3000, TimeUnit.MILLISECONDS);
	...
	@Override
	public Integer getCount(ServicesPurchaseRecordQuery servicesPurchaseRecordQuery) {
		return servicesPurchaseRecordMapper.getCount(servicesPurchaseRecordQuery);
	}
