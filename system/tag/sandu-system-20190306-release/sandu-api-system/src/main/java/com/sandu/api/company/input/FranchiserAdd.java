...
/**
 * @Author chenqiang
 * @Description 经销商企业 新增 入参
 * @Date 2018/6/4 0004 10:10
 * @Modified By
 */
@Data
public class FranchiserAdd implements Serializable{

    @ApiModelProperty(value = "企业id",required = true)
    @NotNull(message = "企业id不能为空")
    private Integer companyId;

    @ApiModelProperty(value = "经销商经销商企业名称",required = true)
