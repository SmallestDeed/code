...
public interface ServicesPurchaseBizService {
    ...
    List<ServicesRoleRel> handlerCompanyUserPackageInfo(Long servicesId, SysUser sysUser,Integer priceId);
     ...
     * @param renew
     */
    ServicesAccountRel renewServiceForInner(InnerServiceRenew renew);
}
