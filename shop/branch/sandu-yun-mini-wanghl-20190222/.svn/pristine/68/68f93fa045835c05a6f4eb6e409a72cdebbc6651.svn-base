...
CrudDao<CompanyShop,CompanyShopQuery,CompanyShopVo>{
    ...
    long countShopOffline(CompanyShopQuery query);

	List<CompanyShopVo> listShopOffline(CompanyShopQuery query);

	CompanyShopDetailVo getOfflineDetail(Long shopId);

    Integer getShopProjectCaseCount(ProjectCaseQuery query);

    ProjectCaseVo getProjectCaseDetail(@Param("caseId") Integer caseId);

    List<Integer> getNearestContactShopId(@Param("userId") Integer userId,
