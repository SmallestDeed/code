...
public class CompanyShopQuery extends BaseQuery<CompanyShopQuery> {
	...
	@ApiModelProperty("1：企业店铺  2,：个人店铺")
	private Integer shopType;
	@ApiModelProperty("要查询的店铺ID集合")
	private List<Integer> shopIdList;
	@ApiModelProperty("要排除的店铺ID集合")
	private List<Integer> exceptShopIdList;
	@ApiModelProperty("要查询的店铺业务类型集合")
	private List<Integer> businessTypeList;
	@ApiModelProperty("要查询的店铺ID集合")
	private String shopIds;
	@ApiModelProperty("要排除的店铺ID集合")
	private String exceptShopIds;
	@ApiModelProperty("要查询的店铺业务类型集合")
	...
	public String getOrderBySql() {
		if(getOrderBy()!=null && getOrderBy().length()>0) {
			...
			if(orderByKey.equalsIgnoreCase("hottest")) {
				...
				orderBySql = "(a.visit_count + if(nid.value is null, 0, nid.value))";
			}
