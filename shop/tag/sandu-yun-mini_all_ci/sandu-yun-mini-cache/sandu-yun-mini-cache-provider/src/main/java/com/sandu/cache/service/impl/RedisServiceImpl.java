...
import com.sandu.common.utils.SpringContextHolder;
...
public class RedisServiceImpl implements RedisService {
	...
	public boolean addString(String key,String value) {
		...
		try {
			...
			logger.error("add String error.", ex);
			returnBrokenResource(shardedJedis);
		} finally {
			returnResource(shardedJedis);
		}
	...
	public boolean addString(String key,int seconds,String value) {
		boolean result = addString(key, value);
		if (result) {
			long i = expire(key, seconds);
			return i == 1;
		}
	...
	public boolean addMap(String mapName, String key, String value) {
		...
		Map<String, String> objectMap = new HashMap<String, String>(1);
	...
	@Override
	public boolean set(String arg0, String arg1, int arg2) {
		// TODO Auto-generated method stub
		return false;
	}
